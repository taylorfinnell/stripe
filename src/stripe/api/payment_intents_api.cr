...
require "../models/transfer_data_capture_params" 
...
module Stripe
  class PaymentIntentsApi
    ...
    # @optional @param payment_method_configuration [String?] The ID of the [payment method configuration](https://stripe.com/docs/api/payment_method_configurations) to use with this PaymentIntent.
    ...
    def build_api_request_for_post_payment_intents(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_error_on_requires_action = error_on_requires_action).nil?
        end
        unless (_expand = expand).nil?
        end
    ...
    # @optional @param payment_method_data [Stripe::PaymentMethodDataParams?]
    # @optional @param payment_method_options [Stripe::PaymentMethodOptionsParam?]
    # @optional @param payment_method_types [Array(String)?] The list of payment method types (for example, card) that this PaymentIntent can use. Use `automatic_payment_methods` to manage payment methods from the [Stripe Dashboard](https://dashboard.stripe.com/settings/payment_methods). A list of valid payment method types can be found [here](https://docs.stripe.com/api/payment_methods/object#payment_method_object-type).
    ...
    # @required @param intent [String?]
    # @optional @param amount [Int32?] Amount that you intend to apply to this PaymentIntent from the customer’s cash balance. If the PaymentIntent was created by an Invoice, the full amount of the PaymentIntent is applied regardless of this parameter.  A positive integer representing how much to charge in the [smallest currency unit](https://stripe.com/docs/currencies#zero-decimal) (for example, 100 cents to charge 1 USD or 100 to charge 100 JPY, a zero-decimal currency). The maximum amount is the amount of the PaymentIntent.  When you omit the amount, it defaults to the remaining amount requested on the PaymentIntent.
    # @optional @param currency [String?] Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
    # @optional @param expand [Array(String)?] Specifies which fields in the response should be expanded.
    # @return [Stripe::PaymentIntent]
    ...
    # @required @param intent [String?]
    # @optional @param amount_to_capture [Int32?] The amount to capture from the PaymentIntent, which must be less than or equal to the original amount. Defaults to the full `amount_capturable` if it's not provided.
    # @optional @param application_fee_amount [Int32?] The amount of the application fee (if any) that will be requested to be applied to the payment and transferred to the application owner's Stripe account. The amount of the application fee collected will be capped at the total amount captured. For more information, see the PaymentIntents [use case for connected accounts](https://stripe.com/docs/payments/connected-accounts).
    # @optional @param expand [Array(String)?] Specifies which fields in the response should be expanded.
    ...
    # @optional @param statement_descriptor [String?] Text that appears on the customer's statement as the statement descriptor for a non-card charge. This value overrides the account's default statement descriptor. For information about requirements, including the 22-character limit, see [the Statement Descriptor docs](https://docs.stripe.com/get-started/account/statement-descriptors).  Setting this value for a card charge returns an error. For card charges, set the [statement_descriptor_suffix](https://docs.stripe.com/get-started/account/statement-descriptors#dynamic) instead.
    # @optional @param statement_descriptor_suffix [String?] Provides information about a card charge. Concatenated to the account's [statement descriptor prefix](https://docs.stripe.com/get-started/account/statement-descriptors#static) to form the complete statement descriptor that appears on the customer's statement.
    # @optional @param transfer_data [Stripe::TransferDataCaptureParams?]
    # @return [Stripe::PaymentIntent]
    def post_payment_intents_intent_capture(
      *, 
      intent : String? = nil, 
      amount_to_capture : Int32? = nil, 
      application_fee_amount : Int32? = nil, 
      expand : Array(String)? = nil, 
      ...
      statement_descriptor : String? = nil, 
      statement_descriptor_suffix : String? = nil, 
      transfer_data : Stripe::TransferDataCaptureParams? = nil
    ) : Stripe::PaymentIntent
    ...
    def build_api_request_for_post_payment_intents_intent_capture(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_amount_to_capture = amount_to_capture).nil?
        end
        unless (_application_fee_amount = application_fee_amount).nil?
        end
        unless (_expand = expand).nil?
        end
        unless (_final_capture = final_capture).nil?
        end
        unless (_metadata = metadata).nil?
          _metadata.validate if _metadata.is_a?(OpenApi::Validatable)
        end
    ...
    # @optional @param payment_method_data [Stripe::PaymentMethodDataParams?]
    # @optional @param payment_method_options [Stripe::PaymentMethodOptionsParam?]
    # @optional @param payment_method_types [Array(String)?] The list of payment method types (for example, a card) that this PaymentIntent can use. Use `automatic_payment_methods` to manage payment methods from the [Stripe Dashboard](https://dashboard.stripe.com/settings/payment_methods). A list of valid payment method types can be found [here](https://docs.stripe.com/api/payment_methods/object#payment_method_object-type).
    # @optional @param radar_options [Stripe::RadarOptionsWithHiddenOptions?]
    # @optional @param receipt_email [String?]
    ...
    def post_payment_intents_intent_confirm(
      *, 
      ...
      data, _status_code, _headers = post_payment_intents_intent_confirm_with_http_info(intent: intent, capture_method: capture_method, client_secret: client_secret, confirmation_token: confirmation_token, error_on_requires_action: error_on_requires_action, expand: expand, mandate: mandate, mandate_data: mandate_data, off_session: off_session, payment_method: payment_method, payment_method_data: payment_method_data, payment_method_options: payment_method_options, payment_method_types: payment_method_types, radar_options: radar_options, receipt_email: receipt_email, return_url: return_url, setup_future_usage: setup_future_usage, shipping: shipping, use_stripe_sdk: use_stripe_sdk)
      data
    end
    ...
    def post_payment_intents_intent_confirm_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_payment_intents_intent_confirm(intent: intent, capture_method: capture_method, client_secret: client_secret, confirmation_token: confirmation_token, error_on_requires_action: error_on_requires_action, expand: expand, mandate: mandate, mandate_data: mandate_data, off_session: off_session, payment_method: payment_method, payment_method_data: payment_method_data, payment_method_options: payment_method_options, payment_method_types: payment_method_types, radar_options: radar_options, receipt_email: receipt_email, return_url: return_url, setup_future_usage: setup_future_usage, shipping: shipping, use_stripe_sdk: use_stripe_sdk)
    ...
    def post_payment_intents_intent_confirm(
      *,
      ...
      build_api_request_for_post_payment_intents_intent_confirm(intent: intent, capture_method: capture_method, client_secret: client_secret, confirmation_token: confirmation_token, error_on_requires_action: error_on_requires_action, expand: expand, mandate: mandate, mandate_data: mandate_data, off_session: off_session, payment_method: payment_method, payment_method_data: payment_method_data, payment_method_options: payment_method_options, payment_method_types: payment_method_types, radar_options: radar_options, receipt_email: receipt_email, return_url: return_url, setup_future_usage: setup_future_usage, shipping: shipping, use_stripe_sdk: use_stripe_sdk).execute(&block)
    end
    ...
    def build_api_request_for_post_payment_intents_intent_confirm(
      *, 
      ...
      form_params : Array(Tuple(String, Crest::ParamsValue)) | Nil = Array(Tuple(String, Crest::ParamsValue)).new
      form_params << Tuple(String, Crest::ParamsValue).new("capture_method", capture_method.to_s) if !capture_method.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("client_secret", client_secret.to_s) if !client_secret.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("confirmation_token", confirmation_token.to_s) if !confirmation_token.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("error_on_requires_action", error_on_requires_action.to_s) if !error_on_requires_action.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(expand.to_json), "expand")) if !expand.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("mandate", mandate.to_s) if !mandate.nil?
