...
require "../models/optional_item_params" 
...
require "../models/permissions_param" 
require "../models/phone_number_collection_params" 
require "../models/post_accounts_request_metadata" 
require "../models/post_checkout_sessions_session_request_shipping_options" 
...
require "../models/wallet_options_param" 
...
module Stripe
  class CheckoutApi
    ...
    # @optional @param adaptive_pricing [Stripe::AdaptivePricingParams?]
    ...
    # @optional @param cancel_url [String?] If set, Checkout displays a back button and customers will be directed to this URL if they decide to cancel payment and return to your website. This parameter is not allowed if ui_mode is `embedded` or `custom`.
    ...
    # @optional @param permissions [Stripe::PermissionsParam?]
    ...
    # @optional @param return_url [String?] The URL to redirect your customer back to after they authenticate or cancel their payment on the payment method's app or site. This parameter is required if `ui_mode` is `embedded` or `custom` and redirect-based payment methods are enabled on the session.
    ...
    # @optional @param submit_type [String?] Describes the type of transaction being performed by Checkout in order to customize relevant text on the page, such as the submit button.  `submit_type` can only be specified on Checkout Sessions in `payment` or `subscription` mode. If blank or `auto`, `pay` is used.
    # @optional @param subscription_data [Stripe::SubscriptionDataParams?]
    # @optional @param success_url [String?] The URL to which Stripe should send customers when payment or setup is complete. This parameter is not allowed if ui_mode is `embedded` or `custom`. If you'd like to use information from the successful Checkout Session on your page, read the guide on [customizing your success page](https://stripe.com/docs/payments/checkout/custom-success-page).
    ...
    # @optional @param wallet_options [Stripe::WalletOptionsParam?]
    # @return [Stripe::CheckoutSession]
    def post_checkout_sessions(
      *, 
      adaptive_pricing : Stripe::AdaptivePricingParams? = nil, 
      ...
      mode : String? = nil, 
      optional_items : Array(Stripe::OptionalItemParams)? = nil, 
      ...
      permissions : Stripe::PermissionsParam? = nil, 
    ...
    def post_checkout_sessions(
      *,
      ...
      build_api_request_for_post_checkout_sessions(adaptive_pricing: adaptive_pricing, after_expiration: after_expiration, allow_promotion_codes: allow_promotion_codes, automatic_tax: automatic_tax, billing_address_collection: billing_address_collection, cancel_url: cancel_url, client_reference_id: client_reference_id, consent_collection: consent_collection, currency: currency, custom_fields: custom_fields, custom_text: custom_text, customer: customer, customer_creation: customer_creation, customer_email: customer_email, customer_update: customer_update, discounts: discounts, expand: expand, expires_at: expires_at, invoice_creation: invoice_creation, line_items: line_items, locale: locale, metadata: metadata, mode: mode, optional_items: optional_items, payment_intent_data: payment_intent_data, payment_method_collection: payment_method_collection, payment_method_configuration: payment_method_configuration, payment_method_data: payment_method_data, payment_method_options: payment_method_options, payment_method_types: payment_method_types, permissions: permissions, phone_number_collection: phone_number_collection, redirect_on_completion: redirect_on_completion, return_url: return_url, saved_payment_method_options: saved_payment_method_options, setup_intent_data: setup_intent_data, shipping_address_collection: shipping_address_collection, shipping_options: shipping_options, submit_type: submit_type, subscription_data: subscription_data, success_url: success_url, tax_id_collection: tax_id_collection, ui_mode: ui_mode, wallet_options: wallet_options).execute(&block)
    end
    ...
    POST_CHECKOUT_SESSIONS_VALID_VALUES_FOR_SUBMIT_TYPE = String.static_array("auto", "book", "donate", "pay", "subscribe")
    POST_CHECKOUT_SESSIONS_VALID_VALUES_FOR_UI_MODE = String.static_array("custom", "embedded", "hosted")
    # @return Crest::Request
      ...
      *, 
      ...
      if client_side_validation?
        unless (_adaptive_pricing = adaptive_pricing).nil?
          _adaptive_pricing.validate if _adaptive_pricing.is_a?(OpenApi::Validatable)
        end
        ...
        unless (_optional_items = optional_items).nil?
          OpenApi::ContainerValidator.validate(container: _optional_items) if _optional_items.is_a?(Array)
        end
        ...
        unless (_permissions = permissions).nil?
          _permissions.validate if _permissions.is_a?(OpenApi::Validatable)
        end
        ...
        unless (_wallet_options = wallet_options).nil?
          _wallet_options.validate if _wallet_options.is_a?(OpenApi::Validatable)
        end
      end
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(adaptive_pricing.to_json), "adaptive_pricing")) if !adaptive_pricing.nil?
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(optional_items.to_json), "optional_items")) if !optional_items.nil?
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(wallet_options.to_json), "wallet_options")) if !wallet_options.nil?
    ...
    # @required @param session [String?]
    # @optional @param collected_information [Stripe::CollectedInformationParams?]
    # @optional @param expand [Array(String)?] Specifies which fields in the response should be expanded.
    # @optional @param metadata [Stripe::PostAccountsRequestMetadata?]
    # @optional @param shipping_options [Stripe::PostCheckoutSessionsSessionRequestShippingOptions?]
    # @return [Stripe::CheckoutSession]
    def post_checkout_sessions_session(
      *, 
      ...
      data, _status_code, _headers = post_checkout_sessions_session_with_http_info(session: session, collected_information: collected_information, expand: expand, metadata: metadata, shipping_options: shipping_options)
      data
    end
    ...
    def post_checkout_sessions_session_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_checkout_sessions_session(session: session, collected_information: collected_information, expand: expand, metadata: metadata, shipping_options: shipping_options)
    ...
    def post_checkout_sessions_session(
      *,
      ...
      build_api_request_for_post_checkout_sessions_session(session: session, collected_information: collected_information, expand: expand, metadata: metadata, shipping_options: shipping_options).execute(&block)
    end
      ...
      *, 
      ...
      if client_side_validation?
        ...
        unless (_collected_information = collected_information).nil?
          _collected_information.validate if _collected_information.is_a?(OpenApi::Validatable)
        end
        unless (_expand = expand).nil?
        end
        unless (_metadata = metadata).nil?
        ...
        unless (_shipping_options = shipping_options).nil?
          _shipping_options.validate if _shipping_options.is_a?(OpenApi::Validatable)
        end
      end
      ...
      # form parameters
      form_params : Array(Tuple(String, Crest::ParamsValue)) | Nil = Array(Tuple(String, Crest::ParamsValue)).new
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(collected_information.to_json), "collected_information")) if !collected_information.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(expand.to_json), "expand")) if !expand.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(metadata.to_json), "metadata")) if !metadata.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(shipping_options.to_json), "shipping_options")) if !shipping_options.nil?
