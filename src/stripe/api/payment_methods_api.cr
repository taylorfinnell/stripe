...
require "../models/param10" 
require "../models/param11" 
...
module Stripe
  class PaymentMethodsApi
    ...
    GET_PAYMENT_METHODS_MAX_LENGTH_FOR_ENDING_BEFORE = 5000
    GET_PAYMENT_METHODS_MAX_LENGTH_FOR_STARTING_AFTER = 5000
      ...
      *, 
      ...
      if client_side_validation?
        unless (_ending_before = ending_before).nil?
          OpenApi::PrimitiveValidator.validate_max_length("ending_before", ending_before.to_s.size, GET_PAYMENT_METHODS_MAX_LENGTH_FOR_ENDING_BEFORE)
        end
        unless (_starting_after = starting_after).nil?
          OpenApi::PrimitiveValidator.validate_max_length("starting_after", starting_after.to_s.size, GET_PAYMENT_METHODS_MAX_LENGTH_FOR_STARTING_AFTER)
        end
    ...
    # @optional @param alma [JSON::Any?] If this is a Alma PaymentMethod, this hash contains details about the Alma payment method.
    ...
    # @optional @param billie [JSON::Any?] If this is a `billie` PaymentMethod, this hash contains details about the Billie payment method.
    ...
    # @optional @param crypto [JSON::Any?] If this is a Crypto PaymentMethod, this hash contains details about the Crypto payment method.
    ...
    # @optional @param fpx [Stripe::Param4?]
    ...
    # @optional @param ideal [Stripe::Param5?]
    ...
    # @optional @param kakao_pay [JSON::Any?] If this is a `kakao_pay` PaymentMethod, this hash contains details about the Kakao Pay payment method.
    # @optional @param klarna [Stripe::Param6?]
    ...
    # @optional @param kr_card [JSON::Any?] If this is a `kr_card` PaymentMethod, this hash contains details about the Korean Card payment method.
    ...
    # @optional @param naver_pay [Stripe::Param7?]
    # @optional @param nz_bank_account [Stripe::Param8?]
    # @optional @param oxxo [JSON::Any?] If this is an `oxxo` PaymentMethod, this hash contains details about the OXXO payment method.
    # @optional @param p24 [Stripe::Param9?]
    # @optional @param pay_by_bank [JSON::Any?] If this is a `pay_by_bank` PaymentMethod, this hash contains details about the PayByBank payment method.
    # @optional @param payco [JSON::Any?] If this is a `payco` PaymentMethod, this hash contains details about the PAYCO payment method.
    ...
    # @optional @param revolut_pay [JSON::Any?] If this is a `revolut_pay` PaymentMethod, this hash contains details about the Revolut Pay payment method.
    # @optional @param samsung_pay [JSON::Any?] If this is a `samsung_pay` PaymentMethod, this hash contains details about the SamsungPay payment method.
    # @optional @param satispay [JSON::Any?] If this is a `satispay` PaymentMethod, this hash contains details about the Satispay payment method.
    # @optional @param sepa_debit [Stripe::Param10?]
    # @optional @param sofort [Stripe::Param11?]
    ...
    def post_payment_methods(
      *, 
      ...
      data, _status_code, _headers = post_payment_methods_with_http_info(acss_debit: acss_debit, affirm: affirm, afterpay_clearpay: afterpay_clearpay, alipay: alipay, allow_redisplay: allow_redisplay, alma: alma, amazon_pay: amazon_pay, au_becs_debit: au_becs_debit, bacs_debit: bacs_debit, bancontact: bancontact, billie: billie, billing_details: billing_details, blik: blik, boleto: boleto, card: card, cashapp: cashapp, crypto: crypto, customer: customer, customer_balance: customer_balance, eps: eps, expand: expand, fpx: fpx, giropay: giropay, grabpay: grabpay, ideal: ideal, interac_present: interac_present, kakao_pay: kakao_pay, klarna: klarna, konbini: konbini, kr_card: kr_card, link: link, metadata: metadata, mobilepay: mobilepay, multibanco: multibanco, naver_pay: naver_pay, nz_bank_account: nz_bank_account, oxxo: oxxo, p24: p24, pay_by_bank: pay_by_bank, payco: payco, payment_method: payment_method, paynow: paynow, paypal: paypal, pix: pix, promptpay: promptpay, radar_options: radar_options, revolut_pay: revolut_pay, samsung_pay: samsung_pay, satispay: satispay, sepa_debit: sepa_debit, sofort: sofort, swish: swish, twint: twint, _type: _type, us_bank_account: us_bank_account, wechat_pay: wechat_pay, zip: zip)
      data
    end
      ...
      *, 
      ...
      if client_side_validation?
        ...
        unless (_naver_pay = naver_pay).nil?
          _naver_pay.validate if _naver_pay.is_a?(OpenApi::Validatable)
        end
        unless (_nz_bank_account = nz_bank_account).nil?
          _nz_bank_account.validate if _nz_bank_account.is_a?(OpenApi::Validatable)
        end
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(alma, "alma")) if !alma.nil?
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(billie, "billie")) if !billie.nil?
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(crypto, "crypto")) if !crypto.nil?
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(kakao_pay, "kakao_pay")) if !kakao_pay.nil?
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(kr_card, "kr_card")) if !kr_card.nil?
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(naver_pay.to_json), "naver_pay")) if !naver_pay.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(nz_bank_account.to_json), "nz_bank_account")) if !nz_bank_account.nil?
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(pay_by_bank, "pay_by_bank")) if !pay_by_bank.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(payco, "payco")) if !payco.nil?
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(samsung_pay, "samsung_pay")) if !samsung_pay.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(satispay, "satispay")) if !satispay.nil?
    ...
    def post_payment_methods_payment_method(
      *, 
      ...
      data, _status_code, _headers = post_payment_methods_payment_method_with_http_info(payment_method: payment_method, allow_redisplay: allow_redisplay, billing_details: billing_details, card: card, expand: expand, link: link, metadata: metadata, pay_by_bank: pay_by_bank, us_bank_account: us_bank_account)
      data
    end
    ...
    def post_payment_methods_payment_method_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_payment_methods_payment_method(payment_method: payment_method, allow_redisplay: allow_redisplay, billing_details: billing_details, card: card, expand: expand, link: link, metadata: metadata, pay_by_bank: pay_by_bank, us_bank_account: us_bank_account)
    ...
    def post_payment_methods_payment_method(
      *,
      ...
      build_api_request_for_post_payment_methods_payment_method(payment_method: payment_method, allow_redisplay: allow_redisplay, billing_details: billing_details, card: card, expand: expand, link: link, metadata: metadata, pay_by_bank: pay_by_bank, us_bank_account: us_bank_account).execute(&block)
    end
