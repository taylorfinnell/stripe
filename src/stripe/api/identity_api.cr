...
require "../models/related_person_param" 
...
module Stripe
  class IdentityApi
    ...
    # @optional @param related_customer [String?] Customer ID
    # @optional @param related_person [Stripe::RelatedPersonParam?]
    ...
    def post_identity_verification_sessions(
      *, 
      ...
      related_customer : String? = nil, 
      related_person : Stripe::RelatedPersonParam? = nil, 
      return_url : String? = nil, 
      _type : String? = nil, 
      verification_flow : String? = nil
    ) : Stripe::IdentityVerificationSession
      data, _status_code, _headers = post_identity_verification_sessions_with_http_info(client_reference_id: client_reference_id, expand: expand, metadata: metadata, options: options, provided_details: provided_details, related_customer: related_customer, related_person: related_person, return_url: return_url, _type: _type, verification_flow: verification_flow)
      data
    end
    ...
    def post_identity_verification_sessions_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_identity_verification_sessions(client_reference_id: client_reference_id, expand: expand, metadata: metadata, options: options, provided_details: provided_details, related_customer: related_customer, related_person: related_person, return_url: return_url, _type: _type, verification_flow: verification_flow)
    ...
    def post_identity_verification_sessions(
      *,
      ...
      build_api_request_for_post_identity_verification_sessions(client_reference_id: client_reference_id, expand: expand, metadata: metadata, options: options, provided_details: provided_details, related_customer: related_customer, related_person: related_person, return_url: return_url, _type: _type, verification_flow: verification_flow).execute(&block)
    end
      ...
      *, 
      ...
      if client_side_validation?
        ...
        unless (_related_person = related_person).nil?
          _related_person.validate if _related_person.is_a?(OpenApi::Validatable)
        end
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(related_person.to_json), "related_person")) if !related_person.nil?
