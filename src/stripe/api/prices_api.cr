...
module Stripe
  class PricesApi
    ...
    def build_api_request_for_get_prices(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_lookup_keys = lookup_keys).nil?
        end
    ...
    # @optional @param product [String?] The ID of the [Product](https://docs.stripe.com/api/products) that this [Price](https://docs.stripe.com/api/prices) will belong to.
    ...
    def build_api_request_for_post_prices(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_transfer_lookup_key = transfer_lookup_key).nil?
        end
