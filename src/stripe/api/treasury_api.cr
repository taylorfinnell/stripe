...
require "../models/forwarding_settings" 
...
module Stripe
  class TreasuryApi
    ...
    # @optional @param status [String?] Only return FinancialAccounts that have the given status: `open` or `closed`
    ...
    def get_treasury_financial_accounts(
      *, 
      ...
      data, _status_code, _headers = get_treasury_financial_accounts_with_http_info(limit: limit, ending_before: ending_before, starting_after: starting_after, status: status, created: created, expand: expand)
      data
    end
    ...
    def get_treasury_financial_accounts_with_http_info(
      *, 
      ...
      request = build_api_request_for_get_treasury_financial_accounts(limit: limit, ending_before: ending_before, starting_after: starting_after, status: status, created: created, expand: expand)
    ...
    def get_treasury_financial_accounts(
      *,
      ...
      build_api_request_for_get_treasury_financial_accounts(limit: limit, ending_before: ending_before, starting_after: starting_after, status: status, created: created, expand: expand).execute(&block)
    end
    ...
    GET_TREASURY_FINANCIAL_ACCOUNTS_VALID_VALUES_FOR_STATUS = String.static_array("closed", "open")
    # @return Crest::Request
    def build_api_request_for_get_treasury_financial_accounts(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_status = status).nil?
          OpenApi::EnumValidator.validate("status", _status, GET_TREASURY_FINANCIAL_ACCOUNTS_VALID_VALUES_FOR_STATUS)
        end
    ...
    # @optional @param metadata [Hash(String, String)?]
    # @optional @param nickname [String?]
    ...
    def post_treasury_financial_accounts(
      *, 
      ...
      data, _status_code, _headers = post_treasury_financial_accounts_with_http_info(supported_currencies: supported_currencies, expand: expand, features: features, metadata: metadata, nickname: nickname, platform_restrictions: platform_restrictions)
      data
    end
    ...
    def post_treasury_financial_accounts_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_treasury_financial_accounts(supported_currencies: supported_currencies, expand: expand, features: features, metadata: metadata, nickname: nickname, platform_restrictions: platform_restrictions)
    ...
    def post_treasury_financial_accounts(
      *,
      ...
      build_api_request_for_post_treasury_financial_accounts(supported_currencies: supported_currencies, expand: expand, features: features, metadata: metadata, nickname: nickname, platform_restrictions: platform_restrictions).execute(&block)
    end

    POST_TREASURY_FINANCIAL_ACCOUNTS_VALID_VALUES_FOR_NICKNAME = String.static_array("")
    # @return Crest::Request
    def build_api_request_for_post_treasury_financial_accounts(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_supported_currencies = supported_currencies).nil?
        end
        unless (_expand = expand).nil?
        end
        ...
        unless (_nickname = nickname).nil?
          OpenApi::EnumValidator.validate("nickname", _nickname, POST_TREASURY_FINANCIAL_ACCOUNTS_VALID_VALUES_FOR_NICKNAME)
        end
    ...
    # @optional @param expand [Array(String)?] Specifies which fields in the response should be expanded.
    # @optional @param features [Stripe::FeatureAccess?]
    # @optional @param forwarding_settings [Stripe::ForwardingSettings?]
    # @optional @param metadata [Hash(String, String)?]
    # @optional @param nickname [String?]
    # @optional @param platform_restrictions [Stripe::PlatformRestrictions?]
    # @return [Stripe::TreasuryFinancialAccount]
    def post_treasury_financial_accounts_financial_account(
      *, 
      ...
      data, _status_code, _headers = post_treasury_financial_accounts_financial_account_with_http_info(financial_account: financial_account, expand: expand, features: features, forwarding_settings: forwarding_settings, metadata: metadata, nickname: nickname, platform_restrictions: platform_restrictions)
      data
    end
    ...
    def post_treasury_financial_accounts_financial_account_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_treasury_financial_accounts_financial_account(financial_account: financial_account, expand: expand, features: features, forwarding_settings: forwarding_settings, metadata: metadata, nickname: nickname, platform_restrictions: platform_restrictions)
    ...
    def post_treasury_financial_accounts_financial_account(
      *,
      ...
      build_api_request_for_post_treasury_financial_accounts_financial_account(financial_account: financial_account, expand: expand, features: features, forwarding_settings: forwarding_settings, metadata: metadata, nickname: nickname, platform_restrictions: platform_restrictions).execute(&block)
    end

    POST_TREASURY_FINANCIAL_ACCOUNTS_FINANCIAL_ACCOUNT_MAX_LENGTH_FOR_FINANCIAL_ACCOUNT = 5000
    POST_TREASURY_FINANCIAL_ACCOUNTS_FINANCIAL_ACCOUNT_VALID_VALUES_FOR_NICKNAME = String.static_array("")
    # @return Crest::Request
      ...
      *, 
      ...
      if client_side_validation?
        ...
        unless (_forwarding_settings = forwarding_settings).nil?
          _forwarding_settings.validate if _forwarding_settings.is_a?(OpenApi::Validatable)
        end
        unless (_metadata = metadata).nil?
        end
        unless (_nickname = nickname).nil?
          OpenApi::EnumValidator.validate("nickname", _nickname, POST_TREASURY_FINANCIAL_ACCOUNTS_FINANCIAL_ACCOUNT_VALID_VALUES_FOR_NICKNAME)
        end
        unless (_platform_restrictions = platform_restrictions).nil?
          _platform_restrictions.validate if _platform_restrictions.is_a?(OpenApi::Validatable)
        end
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(expand.to_json), "expand")) if !expand.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(features.to_json), "features")) if !features.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(forwarding_settings.to_json), "forwarding_settings")) if !forwarding_settings.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(metadata.to_json), "metadata")) if !metadata.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("nickname", nickname.to_s) if !nickname.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(platform_restrictions.to_json), "platform_restrictions")) if !platform_restrictions.nil?
    ...
    def post_treasury_outbound_transfers(
      *, 
      ...
      data, _status_code, _headers = post_treasury_outbound_transfers_with_http_info(amount: amount, currency: currency, financial_account: financial_account, description: description, destination_payment_method: destination_payment_method, destination_payment_method_data: destination_payment_method_data, destination_payment_method_options: destination_payment_method_options, expand: expand, metadata: metadata, statement_descriptor: statement_descriptor)
      data
    end
    ...
    def post_treasury_outbound_transfers_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_treasury_outbound_transfers(amount: amount, currency: currency, financial_account: financial_account, description: description, destination_payment_method: destination_payment_method, destination_payment_method_data: destination_payment_method_data, destination_payment_method_options: destination_payment_method_options, expand: expand, metadata: metadata, statement_descriptor: statement_descriptor)
    ...
    def post_treasury_outbound_transfers(
      *,
      ...
      build_api_request_for_post_treasury_outbound_transfers(amount: amount, currency: currency, financial_account: financial_account, description: description, destination_payment_method: destination_payment_method, destination_payment_method_data: destination_payment_method_data, destination_payment_method_options: destination_payment_method_options, expand: expand, metadata: metadata, statement_descriptor: statement_descriptor).execute(&block)
    end
