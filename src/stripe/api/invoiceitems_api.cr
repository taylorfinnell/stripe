...
module Stripe
  class InvoiceitemsApi
    ...
    # @optional @param pricing [Stripe::PricingParam?]
    ...
    # @optional @param unit_amount_decimal [BigDecimal?] The decimal unit amount in cents (or local equivalent) of the charge to be applied to the upcoming invoice. This `unit_amount_decimal` will be multiplied by the quantity to get the full amount. Passing in a negative `unit_amount_decimal` will reduce the `amount_due` on the invoice. Accepts at most 12 decimal places.
    # @return [Stripe::Invoiceitem]
    def post_invoiceitems(
      *, 
      ...
      pricing : Stripe::PricingParam? = nil, 
      quantity : Int32? = nil, 
      ...
      data, _status_code, _headers = post_invoiceitems_with_http_info(customer: customer, amount: amount, currency: currency, description: description, discountable: discountable, discounts: discounts, expand: expand, invoice: invoice, metadata: metadata, period: period, price_data: price_data, pricing: pricing, quantity: quantity, subscription: subscription, tax_behavior: tax_behavior, tax_code: tax_code, tax_rates: tax_rates, unit_amount_decimal: unit_amount_decimal)
      data
    end
    ...
    def post_invoiceitems_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_invoiceitems(customer: customer, amount: amount, currency: currency, description: description, discountable: discountable, discounts: discounts, expand: expand, invoice: invoice, metadata: metadata, period: period, price_data: price_data, pricing: pricing, quantity: quantity, subscription: subscription, tax_behavior: tax_behavior, tax_code: tax_code, tax_rates: tax_rates, unit_amount_decimal: unit_amount_decimal)
    ...
    def post_invoiceitems(
      *,
      ...
      build_api_request_for_post_invoiceitems(customer: customer, amount: amount, currency: currency, description: description, discountable: discountable, discounts: discounts, expand: expand, invoice: invoice, metadata: metadata, period: period, price_data: price_data, pricing: pricing, quantity: quantity, subscription: subscription, tax_behavior: tax_behavior, tax_code: tax_code, tax_rates: tax_rates, unit_amount_decimal: unit_amount_decimal).execute(&block)
    end
      ...
      *, 
      ...
      if client_side_validation?
        ...
        unless (_pricing = pricing).nil?
          _pricing.validate if _pricing.is_a?(OpenApi::Validatable)
        end
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(pricing.to_json), "pricing")) if !pricing.nil?
    ...
    def post_invoiceitems_invoiceitem(
      *, 
      ...
      data, _status_code, _headers = post_invoiceitems_invoiceitem_with_http_info(invoiceitem: invoiceitem, amount: amount, description: description, discountable: discountable, discounts: discounts, expand: expand, metadata: metadata, period: period, price_data: price_data, pricing: pricing, quantity: quantity, tax_behavior: tax_behavior, tax_code: tax_code, tax_rates: tax_rates, unit_amount_decimal: unit_amount_decimal)
      data
    end
    ...
    def post_invoiceitems_invoiceitem_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_invoiceitems_invoiceitem(invoiceitem: invoiceitem, amount: amount, description: description, discountable: discountable, discounts: discounts, expand: expand, metadata: metadata, period: period, price_data: price_data, pricing: pricing, quantity: quantity, tax_behavior: tax_behavior, tax_code: tax_code, tax_rates: tax_rates, unit_amount_decimal: unit_amount_decimal)
    ...
    def post_invoiceitems_invoiceitem(
      *,
      ...
      build_api_request_for_post_invoiceitems_invoiceitem(invoiceitem: invoiceitem, amount: amount, description: description, discountable: discountable, discounts: discounts, expand: expand, metadata: metadata, period: period, price_data: price_data, pricing: pricing, quantity: quantity, tax_behavior: tax_behavior, tax_code: tax_code, tax_rates: tax_rates, unit_amount_decimal: unit_amount_decimal).execute(&block)
    end
