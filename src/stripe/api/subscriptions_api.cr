...
module Stripe
  class SubscriptionsApi
    ...
    # @optional @param invoice_now [Bool?] Will generate a final invoice that invoices for any un-invoiced metered usage and new/pending proration invoice items. Defaults to `false`.
    ...
    def build_api_request_for_delete_subscriptions_subscription_exposed_id(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_invoice_now = invoice_now).nil?
        end
        unless (_prorate = prorate).nil?
        end
      end
    ...
    def get_subscriptions(
      *,
      ...
      build_api_request_for_get_subscriptions(ending_before: ending_before, starting_after: starting_after, limit: limit, test_clock: test_clock, price: price, automatic_tax: automatic_tax, created: created, current_period_end: current_period_end, current_period_start: current_period_start, expand: expand, customer: customer, collection_method: collection_method, status: status).execute(&block)
    end
    ...
    # @optional @param backdate_start_date [Int32?] A past timestamp to backdate the subscription's start date to. If set, the first invoice will contain line items for the timespan between the start date and the current time. Can be combined with trials and the billing cycle anchor.
    ...
    # @optional @param billing_mode [Stripe::BillingMode?]
    ...
    def post_subscriptions(
      *, 
      ...
      data, _status_code, _headers = post_subscriptions_with_http_info(customer: customer, add_invoice_items: add_invoice_items, application_fee_percent: application_fee_percent, automatic_tax: automatic_tax, backdate_start_date: backdate_start_date, billing_cycle_anchor: billing_cycle_anchor, billing_cycle_anchor_config: billing_cycle_anchor_config, billing_mode: billing_mode, billing_thresholds: billing_thresholds, cancel_at: cancel_at, cancel_at_period_end: cancel_at_period_end, collection_method: collection_method, currency: currency, days_until_due: days_until_due, default_payment_method: default_payment_method, default_source: default_source, default_tax_rates: default_tax_rates, description: description, discounts: discounts, expand: expand, invoice_settings: invoice_settings, items: items, metadata: metadata, off_session: off_session, on_behalf_of: on_behalf_of, payment_behavior: payment_behavior, payment_settings: payment_settings, pending_invoice_item_interval: pending_invoice_item_interval, proration_behavior: proration_behavior, transfer_data: transfer_data, trial_end: trial_end, trial_from_plan: trial_from_plan, trial_period_days: trial_period_days, trial_settings: trial_settings)
      data
    end
    ...
    def post_subscriptions_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_subscriptions(customer: customer, add_invoice_items: add_invoice_items, application_fee_percent: application_fee_percent, automatic_tax: automatic_tax, backdate_start_date: backdate_start_date, billing_cycle_anchor: billing_cycle_anchor, billing_cycle_anchor_config: billing_cycle_anchor_config, billing_mode: billing_mode, billing_thresholds: billing_thresholds, cancel_at: cancel_at, cancel_at_period_end: cancel_at_period_end, collection_method: collection_method, currency: currency, days_until_due: days_until_due, default_payment_method: default_payment_method, default_source: default_source, default_tax_rates: default_tax_rates, description: description, discounts: discounts, expand: expand, invoice_settings: invoice_settings, items: items, metadata: metadata, off_session: off_session, on_behalf_of: on_behalf_of, payment_behavior: payment_behavior, payment_settings: payment_settings, pending_invoice_item_interval: pending_invoice_item_interval, proration_behavior: proration_behavior, transfer_data: transfer_data, trial_end: trial_end, trial_from_plan: trial_from_plan, trial_period_days: trial_period_days, trial_settings: trial_settings)
    ...
    def post_subscriptions(
      *,
      ...
      build_api_request_for_post_subscriptions(customer: customer, add_invoice_items: add_invoice_items, application_fee_percent: application_fee_percent, automatic_tax: automatic_tax, backdate_start_date: backdate_start_date, billing_cycle_anchor: billing_cycle_anchor, billing_cycle_anchor_config: billing_cycle_anchor_config, billing_mode: billing_mode, billing_thresholds: billing_thresholds, cancel_at: cancel_at, cancel_at_period_end: cancel_at_period_end, collection_method: collection_method, currency: currency, days_until_due: days_until_due, default_payment_method: default_payment_method, default_source: default_source, default_tax_rates: default_tax_rates, description: description, discounts: discounts, expand: expand, invoice_settings: invoice_settings, items: items, metadata: metadata, off_session: off_session, on_behalf_of: on_behalf_of, payment_behavior: payment_behavior, payment_settings: payment_settings, pending_invoice_item_interval: pending_invoice_item_interval, proration_behavior: proration_behavior, transfer_data: transfer_data, trial_end: trial_end, trial_from_plan: trial_from_plan, trial_period_days: trial_period_days, trial_settings: trial_settings).execute(&block)
    end
    ...
    def build_api_request_for_post_subscriptions(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_backdate_start_date = backdate_start_date).nil?
        end
        ...
        unless (_billing_mode = billing_mode).nil?
          _billing_mode.validate if _billing_mode.is_a?(OpenApi::Validatable)
        end
        ...
        unless (_trial_from_plan = trial_from_plan).nil?
        end
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(billing_mode.to_json), "billing_mode")) if !billing_mode.nil?
    ...
    def post_subscriptions_subscription_exposed_id(
      *, 
      ...
      data, _status_code, _headers = post_subscriptions_subscription_exposed_id_with_http_info(subscription_exposed_id: subscription_exposed_id, add_invoice_items: add_invoice_items, application_fee_percent: application_fee_percent, automatic_tax: automatic_tax, billing_cycle_anchor: billing_cycle_anchor, billing_thresholds: billing_thresholds, cancel_at: cancel_at, cancel_at_period_end: cancel_at_period_end, cancellation_details: cancellation_details, collection_method: collection_method, days_until_due: days_until_due, default_payment_method: default_payment_method, default_source: default_source, default_tax_rates: default_tax_rates, description: description, discounts: discounts, expand: expand, invoice_settings: invoice_settings, items: items, metadata: metadata, off_session: off_session, on_behalf_of: on_behalf_of, pause_collection: pause_collection, payment_behavior: payment_behavior, payment_settings: payment_settings, pending_invoice_item_interval: pending_invoice_item_interval, proration_behavior: proration_behavior, proration_date: proration_date, transfer_data: transfer_data, trial_end: trial_end, trial_from_plan: trial_from_plan, trial_settings: trial_settings)
      data
    end
    ...
    def post_subscriptions_subscription_exposed_id_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_subscriptions_subscription_exposed_id(subscription_exposed_id: subscription_exposed_id, add_invoice_items: add_invoice_items, application_fee_percent: application_fee_percent, automatic_tax: automatic_tax, billing_cycle_anchor: billing_cycle_anchor, billing_thresholds: billing_thresholds, cancel_at: cancel_at, cancel_at_period_end: cancel_at_period_end, cancellation_details: cancellation_details, collection_method: collection_method, days_until_due: days_until_due, default_payment_method: default_payment_method, default_source: default_source, default_tax_rates: default_tax_rates, description: description, discounts: discounts, expand: expand, invoice_settings: invoice_settings, items: items, metadata: metadata, off_session: off_session, on_behalf_of: on_behalf_of, pause_collection: pause_collection, payment_behavior: payment_behavior, payment_settings: payment_settings, pending_invoice_item_interval: pending_invoice_item_interval, proration_behavior: proration_behavior, proration_date: proration_date, transfer_data: transfer_data, trial_end: trial_end, trial_from_plan: trial_from_plan, trial_settings: trial_settings)
    ...
    def post_subscriptions_subscription_exposed_id(
      *,
      ...
      build_api_request_for_post_subscriptions_subscription_exposed_id(subscription_exposed_id: subscription_exposed_id, add_invoice_items: add_invoice_items, application_fee_percent: application_fee_percent, automatic_tax: automatic_tax, billing_cycle_anchor: billing_cycle_anchor, billing_thresholds: billing_thresholds, cancel_at: cancel_at, cancel_at_period_end: cancel_at_period_end, cancellation_details: cancellation_details, collection_method: collection_method, days_until_due: days_until_due, default_payment_method: default_payment_method, default_source: default_source, default_tax_rates: default_tax_rates, description: description, discounts: discounts, expand: expand, invoice_settings: invoice_settings, items: items, metadata: metadata, off_session: off_session, on_behalf_of: on_behalf_of, pause_collection: pause_collection, payment_behavior: payment_behavior, payment_settings: payment_settings, pending_invoice_item_interval: pending_invoice_item_interval, proration_behavior: proration_behavior, proration_date: proration_date, transfer_data: transfer_data, trial_end: trial_end, trial_from_plan: trial_from_plan, trial_settings: trial_settings).execute(&block)
    end
    ...
    def build_api_request_for_post_subscriptions_subscription_exposed_id(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_proration_date = proration_date).nil?
        end
        unless (_transfer_data = transfer_data).nil?
          _transfer_data.validate if _transfer_data.is_a?(OpenApi::Validatable)
        end
