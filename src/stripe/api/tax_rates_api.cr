...
module Stripe
  class TaxRatesApi
    ...
    # @optional @param state [String?] [ISO 3166-2 subdivision code](https://en.wikipedia.org/wiki/ISO_3166-2), without country prefix. For example, \\\"NY\\\" for New York, United States.
    ...
    POST_TAX_RATES_MAX_LENGTH_FOR_STATE = 5000
    POST_TAX_RATES_VALID_VALUES_FOR_TAX_TYPE = String.static_array("amusement_tax", "communications_tax", "gst", "hst", "igst", "jct", "lease_tax", "pst", "qst", "retail_delivery_fee", "rst", "sales_tax", "service_tax", "vat")
    # @return Crest::Request
    ...
    POST_TAX_RATES_TAX_RATE_MAX_LENGTH_FOR_STATE = 5000
    POST_TAX_RATES_TAX_RATE_VALID_VALUES_FOR_TAX_TYPE = String.static_array("amusement_tax", "communications_tax", "gst", "hst", "igst", "jct", "lease_tax", "pst", "qst", "retail_delivery_fee", "rst", "sales_tax", "service_tax", "vat")
    # @return Crest::Request
