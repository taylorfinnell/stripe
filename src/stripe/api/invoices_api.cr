...
module Stripe
  class InvoicesApi
    ...
    # @optional @param automatically_finalizes_at [Int32?] The time when this invoice should be scheduled to finalize. The invoice will be finalized at this time if it is still in draft state.
    ...
    def post_invoices_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_invoices(account_tax_ids: account_tax_ids, application_fee_amount: application_fee_amount, auto_advance: auto_advance, automatic_tax: automatic_tax, automatically_finalizes_at: automatically_finalizes_at, collection_method: collection_method, currency: currency, custom_fields: custom_fields, customer: customer, days_until_due: days_until_due, default_payment_method: default_payment_method, default_source: default_source, default_tax_rates: default_tax_rates, description: description, discounts: discounts, due_date: due_date, effective_at: effective_at, expand: expand, footer: footer, from_invoice: from_invoice, issuer: issuer, metadata: metadata, number: number, on_behalf_of: on_behalf_of, payment_settings: payment_settings, pending_invoice_items_behavior: pending_invoice_items_behavior, rendering: rendering, shipping_cost: shipping_cost, shipping_details: shipping_details, statement_descriptor: statement_descriptor, subscription: subscription, transfer_data: transfer_data)
    ...
    def post_invoices(
      *,
      ...
      build_api_request_for_post_invoices(account_tax_ids: account_tax_ids, application_fee_amount: application_fee_amount, auto_advance: auto_advance, automatic_tax: automatic_tax, automatically_finalizes_at: automatically_finalizes_at, collection_method: collection_method, currency: currency, custom_fields: custom_fields, customer: customer, days_until_due: days_until_due, default_payment_method: default_payment_method, default_source: default_source, default_tax_rates: default_tax_rates, description: description, discounts: discounts, due_date: due_date, effective_at: effective_at, expand: expand, footer: footer, from_invoice: from_invoice, issuer: issuer, metadata: metadata, number: number, on_behalf_of: on_behalf_of, payment_settings: payment_settings, pending_invoice_items_behavior: pending_invoice_items_behavior, rendering: rendering, shipping_cost: shipping_cost, shipping_details: shipping_details, statement_descriptor: statement_descriptor, subscription: subscription, transfer_data: transfer_data).execute(&block)
    end
    ...
    def build_api_request_for_post_invoices(
      *, 
      ...
      form_params << Tuple(String, Crest::ParamsValue).new("automatically_finalizes_at", automatically_finalizes_at.to_s) if !automatically_finalizes_at.nil?
    ...
    # @optional @param automatic_tax [Stripe::AutomaticTaxParam?]
    # @optional @param automatically_finalizes_at [Int32?] The time when this invoice should be scheduled to finalize. The invoice will be finalized at this time if it is still in draft state. To turn off automatic finalization, set `auto_advance` to false.
    ...
    def post_invoices_invoice_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_invoices_invoice(invoice: invoice, account_tax_ids: account_tax_ids, application_fee_amount: application_fee_amount, auto_advance: auto_advance, automatic_tax: automatic_tax, automatically_finalizes_at: automatically_finalizes_at, collection_method: collection_method, custom_fields: custom_fields, days_until_due: days_until_due, default_payment_method: default_payment_method, default_source: default_source, default_tax_rates: default_tax_rates, description: description, discounts: discounts, due_date: due_date, effective_at: effective_at, expand: expand, footer: footer, issuer: issuer, metadata: metadata, number: number, on_behalf_of: on_behalf_of, payment_settings: payment_settings, rendering: rendering, shipping_cost: shipping_cost, shipping_details: shipping_details, statement_descriptor: statement_descriptor, transfer_data: transfer_data)
    ...
    def post_invoices_invoice(
      *,
      ...
      build_api_request_for_post_invoices_invoice(invoice: invoice, account_tax_ids: account_tax_ids, application_fee_amount: application_fee_amount, auto_advance: auto_advance, automatic_tax: automatic_tax, automatically_finalizes_at: automatically_finalizes_at, collection_method: collection_method, custom_fields: custom_fields, days_until_due: days_until_due, default_payment_method: default_payment_method, default_source: default_source, default_tax_rates: default_tax_rates, description: description, discounts: discounts, due_date: due_date, effective_at: effective_at, expand: expand, footer: footer, issuer: issuer, metadata: metadata, number: number, on_behalf_of: on_behalf_of, payment_settings: payment_settings, rendering: rendering, shipping_cost: shipping_cost, shipping_details: shipping_details, statement_descriptor: statement_descriptor, transfer_data: transfer_data).execute(&block)
    end
    ...
    def build_api_request_for_post_invoices_invoice_pay(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_paid_out_of_band = paid_out_of_band).nil?
        end
