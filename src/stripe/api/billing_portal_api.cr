...
module Stripe
  class BillingPortalApi
    ...
    # @optional @param business_profile [Stripe::BusinessProfileCreateParam?]
    ...
    def post_billing_portal_configurations(
      *, 
      ...
      data, _status_code, _headers = post_billing_portal_configurations_with_http_info(features: features, business_profile: business_profile, default_return_url: default_return_url, expand: expand, login_page: login_page, metadata: metadata)
      data
    end
    ...
    def post_billing_portal_configurations_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_billing_portal_configurations(features: features, business_profile: business_profile, default_return_url: default_return_url, expand: expand, login_page: login_page, metadata: metadata)
    ...
    def post_billing_portal_configurations(
      *,
      ...
      build_api_request_for_post_billing_portal_configurations(features: features, business_profile: business_profile, default_return_url: default_return_url, expand: expand, login_page: login_page, metadata: metadata).execute(&block)
    end
