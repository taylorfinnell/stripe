...
require "../models/post_charges_request_destination" 
...
module Stripe
  class ChargesApi
    ...
    # @required @param charge [String?]
    # @optional @param amount [Int32?] The amount to capture, which must be less than or equal to the original amount.
