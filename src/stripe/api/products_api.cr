...
require "../models/price_data_without_product_with_metadata" 
...
module Stripe
  class ProductsApi
    ...
    def build_api_request_for_get_products(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_shippable = shippable).nil?
        end
    ...
    # @optional @param default_price_data [Stripe::PriceDataWithoutProductWithMetadata?]
    ...
    def post_products(
      *, 
      name : String? = nil, 
      active : Bool? = nil, 
      default_price_data : Stripe::PriceDataWithoutProductWithMetadata? = nil, 
      ...
      data, _status_code, _headers = post_products_with_http_info(name: name, active: active, default_price_data: default_price_data, description: description, expand: expand, id: id, images: images, marketing_features: marketing_features, metadata: metadata, package_dimensions: package_dimensions, shippable: shippable, statement_descriptor: statement_descriptor, tax_code: tax_code, unit_label: unit_label, url: url)
      data
    end
    ...
    def post_products_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_products(name: name, active: active, default_price_data: default_price_data, description: description, expand: expand, id: id, images: images, marketing_features: marketing_features, metadata: metadata, package_dimensions: package_dimensions, shippable: shippable, statement_descriptor: statement_descriptor, tax_code: tax_code, unit_label: unit_label, url: url)
    ...
    def post_products(
      *,
      ...
      build_api_request_for_post_products(name: name, active: active, default_price_data: default_price_data, description: description, expand: expand, id: id, images: images, marketing_features: marketing_features, metadata: metadata, package_dimensions: package_dimensions, shippable: shippable, statement_descriptor: statement_descriptor, tax_code: tax_code, unit_label: unit_label, url: url).execute(&block)
    end
