  ...
  class SubscriptionItemsApi
    ...
    def build_api_request_for_delete_subscription_items_item(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_clear_usage = clear_usage).nil?
        end
    ...
    def post_subscription_items(
      *, 
      ...
      data, _status_code, _headers = post_subscription_items_with_http_info(subscription: subscription, billing_thresholds: billing_thresholds, discounts: discounts, expand: expand, metadata: metadata, payment_behavior: payment_behavior, price: price, price_data: price_data, proration_behavior: proration_behavior, proration_date: proration_date, quantity: quantity, tax_rates: tax_rates)
      data
    end
    ...
    def post_subscription_items(
      *,
      ...
      build_api_request_for_post_subscription_items(subscription: subscription, billing_thresholds: billing_thresholds, discounts: discounts, expand: expand, metadata: metadata, payment_behavior: payment_behavior, price: price, price_data: price_data, proration_behavior: proration_behavior, proration_date: proration_date, quantity: quantity, tax_rates: tax_rates).execute(&block)
    end
    ...
    def post_subscription_items_item(
      *, 
      ...
      data, _status_code, _headers = post_subscription_items_item_with_http_info(item: item, billing_thresholds: billing_thresholds, discounts: discounts, expand: expand, metadata: metadata, off_session: off_session, payment_behavior: payment_behavior, price: price, price_data: price_data, proration_behavior: proration_behavior, proration_date: proration_date, quantity: quantity, tax_rates: tax_rates)
      data
    end
    ...
    def post_subscription_items_item_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_subscription_items_item(item: item, billing_thresholds: billing_thresholds, discounts: discounts, expand: expand, metadata: metadata, off_session: off_session, payment_behavior: payment_behavior, price: price, price_data: price_data, proration_behavior: proration_behavior, proration_date: proration_date, quantity: quantity, tax_rates: tax_rates)
    ...
    def post_subscription_items_item(
      *,
      ...
      build_api_request_for_post_subscription_items_item(item: item, billing_thresholds: billing_thresholds, discounts: discounts, expand: expand, metadata: metadata, off_session: off_session, payment_behavior: payment_behavior, price: price, price_data: price_data, proration_behavior: proration_behavior, proration_date: proration_date, quantity: quantity, tax_rates: tax_rates).execute(&block)
    end
