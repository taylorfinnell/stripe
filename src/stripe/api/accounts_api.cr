...
require "../models/account_groups_specs" 
...
require "../models/individual_update_specs" 
...
require "../models/post_accounts_request_bank_account" 
...
require "../models/us_cfpb_data_specs" 
...
module Stripe
  class AccountsApi
    ...
    # @required @param id [String?] Unique identifier for the external account to be deleted.
    # @required @param account [String?]
    ...
    def delete_accounts_account_external_accounts_id(
      *, 
      ...
      data, _status_code, _headers = delete_accounts_account_external_accounts_id_with_http_info(id: id, account: account)
      data
    end
    ...
    def delete_accounts_account_external_accounts_id_with_http_info(
      *, 
      ...
      request = build_api_request_for_delete_accounts_account_external_accounts_id(id: id, account: account)
    ...
    def delete_accounts_account_external_accounts_id(
      *,
      ...
      build_api_request_for_delete_accounts_account_external_accounts_id(id: id, account: account).execute(&block)
    end
    ...
    def build_api_request_for_delete_accounts_account_external_accounts_id(
      *, 
      ...
      # resource path
      local_var_path = "/v1/accounts/{account}/external_accounts/{id}".sub("{" + "id" + "}", URI.encode_path(id.to_s)).sub("{" + "account" + "}", URI.encode_path(account.to_s))
    ...
    def build_api_request_for_get_accounts_account_capabilities_capability(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_capability = capability).nil?
        end
        unless (_expand = expand).nil?
        end
      end
    ...
    # @required @param id [String?] Unique identifier for the external account to be retrieved.
    # @required @param account [String?]
    # @optional @param expand [Array(Array(String))?] Specifies which fields in the response should be expanded.
    ...
    def get_accounts_account_external_accounts_id(
      *, 
      ...
      data, _status_code, _headers = get_accounts_account_external_accounts_id_with_http_info(id: id, account: account, expand: expand)
      data
    end
    ...
    def get_accounts_account_external_accounts_id_with_http_info(
      *, 
      ...
      request = build_api_request_for_get_accounts_account_external_accounts_id(id: id, account: account, expand: expand)
    ...
    def get_accounts_account_external_accounts_id(
      *,
      ...
      build_api_request_for_get_accounts_account_external_accounts_id(id: id, account: account, expand: expand).execute(&block)
    end
    ...
    # @optional @param groups [Stripe::AccountGroupsSpecs?]
    ...
    def post_accounts(
      *, 
      ...
      groups : Stripe::AccountGroupsSpecs? = nil, 
      ...
      data, _status_code, _headers = post_accounts_with_http_info(account_token: account_token, bank_account: bank_account, business_profile: business_profile, business_type: business_type, capabilities: capabilities, company: company, controller: controller, country: country, default_currency: default_currency, documents: documents, email: email, expand: expand, external_account: external_account, groups: groups, individual: individual, metadata: metadata, settings: settings, tos_acceptance: tos_acceptance, _type: _type)
      data
    end
    ...
    def post_accounts_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_accounts(account_token: account_token, bank_account: bank_account, business_profile: business_profile, business_type: business_type, capabilities: capabilities, company: company, controller: controller, country: country, default_currency: default_currency, documents: documents, email: email, expand: expand, external_account: external_account, groups: groups, individual: individual, metadata: metadata, settings: settings, tos_acceptance: tos_acceptance, _type: _type)
    ...
    def post_accounts(
      *,
      ...
      build_api_request_for_post_accounts(account_token: account_token, bank_account: bank_account, business_profile: business_profile, business_type: business_type, capabilities: capabilities, company: company, controller: controller, country: country, default_currency: default_currency, documents: documents, email: email, expand: expand, external_account: external_account, groups: groups, individual: individual, metadata: metadata, settings: settings, tos_acceptance: tos_acceptance, _type: _type).execute(&block)
    end
    ...
    def build_api_request_for_post_accounts(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_groups = groups).nil?
          _groups.validate if _groups.is_a?(OpenApi::Validatable)
        end
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(groups.to_json), "groups")) if !groups.nil?
    ...
    # @required @param account [String?]
    # @optional @param account_token [String?] An [account token](https://stripe.com/docs/api#create_account_token), used to securely provide details to the account.
    # @optional @param business_profile [Stripe::BusinessProfileUpdateSpecs?]
    # @optional @param business_type [String?] The business type. Once you create an [Account Link](/api/account_links) or [Account Session](/api/account_sessions), this property can only be updated for accounts where [controller.requirement_collection](/api/accounts/object#account_object-controller-requirement_collection) is `application`, which includes Custom accounts.
    # @optional @param capabilities [Stripe::CapabilitiesParam?]
    # @optional @param company [Stripe::CompanyUpdateSpecs?]
    # @optional @param default_currency [String?] Three-letter ISO currency code representing the default currency for the account. This must be a currency that [Stripe supports in the account's country](https://docs.stripe.com/payouts).
    # @optional @param documents [Stripe::DocumentsSpecs?]
    # @optional @param email [String?] The email address of the account holder. This is only to make the account easier to identify to you. If [controller.requirement_collection](/api/accounts/object#account_object-controller-requirement_collection) is `application`, which includes Custom accounts, Stripe doesn't email the account without your consent.
    # @optional @param expand [Array(String)?] Specifies which fields in the response should be expanded.
    # @optional @param external_account [String?] A card or bank account to attach to the account for receiving [payouts](/connect/bank-debit-card-payouts) (you won’t be able to use it for top-ups). You can provide either a token, like the ones returned by [Stripe.js](/js), or a dictionary, as documented in the `external_account` parameter for [bank account](/api#account_create_bank_account) creation. <br><br>By default, providing an external account sets it as the new default external account for its currency, and deletes the old default if one exists. To add additional external accounts without replacing the existing default for the currency, use the [bank account](/api#account_create_bank_account) or [card creation](/api#account_create_card) APIs. After you create an [Account Link](/api/account_links) or [Account Session](/api/account_sessions), this property can only be updated for accounts where [controller.requirement_collection](/api/accounts/object#account_object-controller-requirement_collection) is `application`, which includes Custom accounts.
    # @optional @param groups [Stripe::AccountGroupsSpecs?]
    # @optional @param individual [Stripe::IndividualUpdateSpecs?]
    # @optional @param metadata [Stripe::PostAccountsRequestMetadata?]
    ...
    def post_accounts_account(
      *, 
      account : String? = nil, 
      account_token : String? = nil, 
      business_profile : Stripe::BusinessProfileUpdateSpecs? = nil, 
      business_type : String? = nil, 
      capabilities : Stripe::CapabilitiesParam? = nil, 
      company : Stripe::CompanyUpdateSpecs? = nil, 
      default_currency : String? = nil, 
      documents : Stripe::DocumentsSpecs? = nil, 
      email : String? = nil, 
      expand : Array(String)? = nil, 
      external_account : String? = nil, 
      groups : Stripe::AccountGroupsSpecs? = nil, 
      individual : Stripe::IndividualUpdateSpecs? = nil, 
      metadata : Stripe::PostAccountsRequestMetadata? = nil, 
    ...
    # @optional @param expand [Array(String)?] Specifies which fields in the response should be expanded.
    # @optional @param external_account [String?] A token, like the ones returned by [Stripe.js](https://stripe.com/docs/js) or a dictionary containing a user's external account details (with the options shown below). Please refer to full [documentation](https://stripe.com/docs/api/external_accounts) instead.
    ...
    def post_accounts_account_external_accounts(
      *, 
      ...
      data, _status_code, _headers = post_accounts_account_external_accounts_with_http_info(account: account, bank_account: bank_account, default_for_currency: default_for_currency, expand: expand, external_account: external_account, metadata: metadata)
      data
    end
    ...
    def post_accounts_account_external_accounts_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_accounts_account_external_accounts(account: account, bank_account: bank_account, default_for_currency: default_for_currency, expand: expand, external_account: external_account, metadata: metadata)
    ...
    def post_accounts_account_external_accounts(
      *,
      ...
      build_api_request_for_post_accounts_account_external_accounts(account: account, bank_account: bank_account, default_for_currency: default_for_currency, expand: expand, external_account: external_account, metadata: metadata).execute(&block)
    end
    ...
    # @optional @param us_cfpb_data [Stripe::UsCfpbDataSpecs?]
    ...
    def post_accounts_account_persons(
      *,
      ...
      build_api_request_for_post_accounts_account_persons(account: account, additional_tos_acceptances: additional_tos_acceptances, address: address, address_kana: address_kana, address_kanji: address_kanji, dob: dob, documents: documents, email: email, expand: expand, first_name: first_name, first_name_kana: first_name_kana, first_name_kanji: first_name_kanji, full_name_aliases: full_name_aliases, gender: gender, id_number: id_number, id_number_secondary: id_number_secondary, last_name: last_name, last_name_kana: last_name_kana, last_name_kanji: last_name_kanji, maiden_name: maiden_name, metadata: metadata, nationality: nationality, person_token: person_token, phone: phone, political_exposure: political_exposure, registered_address: registered_address, relationship: relationship, ssn_last_4: ssn_last_4, us_cfpb_data: us_cfpb_data, verification: verification).execute(&block)
    end
    ...
    POST_ACCOUNTS_ACCOUNT_PERSONS_VALID_VALUES_FOR_POLITICAL_EXPOSURE = String.static_array("existing", "none")
    # @return Crest::Request
      ...
      *, 
      ...
      if client_side_validation?
        ...
        unless (_political_exposure = political_exposure).nil?
          OpenApi::EnumValidator.validate("political_exposure", _political_exposure, POST_ACCOUNTS_ACCOUNT_PERSONS_VALID_VALUES_FOR_POLITICAL_EXPOSURE)
        end
        ...
        unless (_us_cfpb_data = us_cfpb_data).nil?
          _us_cfpb_data.validate if _us_cfpb_data.is_a?(OpenApi::Validatable)
        end
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(us_cfpb_data.to_json), "us_cfpb_data")) if !us_cfpb_data.nil?
    ...
    POST_ACCOUNTS_ACCOUNT_PERSONS_PERSON_VALID_VALUES_FOR_POLITICAL_EXPOSURE = String.static_array("existing", "none")
    # @return Crest::Request
    def build_api_request_for_post_accounts_account_persons_person(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_political_exposure = political_exposure).nil?
          OpenApi::EnumValidator.validate("political_exposure", _political_exposure, POST_ACCOUNTS_ACCOUNT_PERSONS_PERSON_VALID_VALUES_FOR_POLITICAL_EXPOSURE)
        end
        unless (_registered_address = registered_address).nil?
          _registered_address.validate if _registered_address.is_a?(OpenApi::Validatable)
        end
