...
module Stripe
  class SetupIntentsApi
    ...
    # @optional @param payment_method_configuration [String?] The ID of the [payment method configuration](https://stripe.com/docs/api/payment_method_configurations) to use with this SetupIntent.
    ...
    # @optional @param payment_method_types [Array(String)?] The list of payment method types (for example, card) that this SetupIntent can use. If you don't provide this, Stripe will dynamically show relevant payment methods from your [payment method settings](https://dashboard.stripe.com/settings/payment_methods). A list of valid payment method types can be found [here](https://docs.stripe.com/api/payment_methods/object#payment_method_object-type).
    ...
    # @optional @param payment_method_data [Stripe::PaymentMethodDataParams?]
    # @optional @param payment_method_options [Stripe::PaymentMethodOptionsParam?]
    # @optional @param payment_method_types [Array(String)?] The list of payment method types (for example, card) that this SetupIntent can set up. If you don't provide this, Stripe will dynamically show relevant payment methods from your [payment method settings](https://dashboard.stripe.com/settings/payment_methods). A list of valid payment method types can be found [here](https://docs.stripe.com/api/payment_methods/object#payment_method_object-type).
    # @return [Stripe::SetupIntent]
    ...
    def post_setup_intents_intent_confirm(
      *, 
      ...
      data, _status_code, _headers = post_setup_intents_intent_confirm_with_http_info(intent: intent, client_secret: client_secret, confirmation_token: confirmation_token, expand: expand, mandate_data: mandate_data, payment_method: payment_method, payment_method_data: payment_method_data, payment_method_options: payment_method_options, return_url: return_url, use_stripe_sdk: use_stripe_sdk)
      data
    end
    ...
    def post_setup_intents_intent_confirm_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_setup_intents_intent_confirm(intent: intent, client_secret: client_secret, confirmation_token: confirmation_token, expand: expand, mandate_data: mandate_data, payment_method: payment_method, payment_method_data: payment_method_data, payment_method_options: payment_method_options, return_url: return_url, use_stripe_sdk: use_stripe_sdk)
    ...
    def post_setup_intents_intent_confirm(
      *,
      ...
      build_api_request_for_post_setup_intents_intent_confirm(intent: intent, client_secret: client_secret, confirmation_token: confirmation_token, expand: expand, mandate_data: mandate_data, payment_method: payment_method, payment_method_data: payment_method_data, payment_method_options: payment_method_options, return_url: return_url, use_stripe_sdk: use_stripe_sdk).execute(&block)
    end
