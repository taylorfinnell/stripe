...
require "../models/post_terminal_configurations_request_wifi" 
...
module Stripe
  class TerminalApi
    ...
    def build_api_request_for_get_terminal_configurations(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_is_account_default = is_account_default).nil?
        end
      end
    ...
    GET_TERMINAL_READERS_VALID_VALUES_FOR_DEVICE_TYPE = String.static_array("bbpos_chipper2x", "bbpos_wisepad3", "bbpos_wisepos_e", "mobile_phone_reader", "simulated_stripe_s700", "simulated_wisepos_e", "stripe_m2", "stripe_s700", "verifone_P400")
    ...
    # @optional @param wifi [Stripe::PostTerminalConfigurationsRequestWifi?]
    ...
    def post_terminal_configurations(
      *, 
      ...
      wifi : Stripe::PostTerminalConfigurationsRequestWifi? = nil
    ) : Stripe::TerminalConfiguration
      data, _status_code, _headers = post_terminal_configurations_with_http_info(bbpos_wisepos_e: bbpos_wisepos_e, expand: expand, name: name, offline: offline, reboot_window: reboot_window, stripe_s700: stripe_s700, tipping: tipping, verifone_p400: verifone_p400, wifi: wifi)
      data
    end
    ...
    def post_terminal_configurations_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_terminal_configurations(bbpos_wisepos_e: bbpos_wisepos_e, expand: expand, name: name, offline: offline, reboot_window: reboot_window, stripe_s700: stripe_s700, tipping: tipping, verifone_p400: verifone_p400, wifi: wifi)
    ...
    def post_terminal_configurations(
      *,
      ...
      build_api_request_for_post_terminal_configurations(bbpos_wisepos_e: bbpos_wisepos_e, expand: expand, name: name, offline: offline, reboot_window: reboot_window, stripe_s700: stripe_s700, tipping: tipping, verifone_p400: verifone_p400, wifi: wifi).execute(&block)
    end
    ...
    def build_api_request_for_post_terminal_configurations(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_wifi = wifi).nil?
          _wifi.validate if _wifi.is_a?(OpenApi::Validatable)
        end
      end
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(wifi.to_json), "wifi")) if !wifi.nil?
    ...
    def post_terminal_configurations_configuration(
      *, 
      ...
      data, _status_code, _headers = post_terminal_configurations_configuration_with_http_info(configuration: configuration, bbpos_wisepos_e: bbpos_wisepos_e, expand: expand, name: name, offline: offline, reboot_window: reboot_window, stripe_s700: stripe_s700, tipping: tipping, verifone_p400: verifone_p400, wifi: wifi)
      data
    end
    ...
    def post_terminal_configurations_configuration_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_terminal_configurations_configuration(configuration: configuration, bbpos_wisepos_e: bbpos_wisepos_e, expand: expand, name: name, offline: offline, reboot_window: reboot_window, stripe_s700: stripe_s700, tipping: tipping, verifone_p400: verifone_p400, wifi: wifi)
    ...
    def post_terminal_configurations_configuration(
      *,
      ...
      build_api_request_for_post_terminal_configurations_configuration(configuration: configuration, bbpos_wisepos_e: bbpos_wisepos_e, expand: expand, name: name, offline: offline, reboot_window: reboot_window, stripe_s700: stripe_s700, tipping: tipping, verifone_p400: verifone_p400, wifi: wifi).execute(&block)
    end
    ...
    # @required @param display_name [String?] A name for the location. Maximum length is 1000 characters.
    ...
    POST_TERMINAL_LOCATIONS_MAX_LENGTH_FOR_CONFIGURATION_OVERRIDES = 500
    # @return Crest::Request
    ...
    # @optional @param display_name [String?]
    # @optional @param expand [Array(String)?] Specifies which fields in the response should be expanded.
    # @optional @param metadata [Stripe::PostAccountsRequestMetadata?]
    # @return [Stripe::GetTerminalLocationsLocation200Response]
    ...
    POST_TERMINAL_LOCATIONS_LOCATION_VALID_VALUES_FOR_DISPLAY_NAME = String.static_array("")
    # @return Crest::Request
    def build_api_request_for_post_terminal_locations_location(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_display_name = display_name).nil?
          OpenApi::EnumValidator.validate("display_name", _display_name, POST_TERMINAL_LOCATIONS_LOCATION_VALID_VALUES_FOR_DISPLAY_NAME)
        end
        unless (_expand = expand).nil?
        end
        unless (_metadata = metadata).nil?
    ...
    # @required @param reader [String?]
    # @required @param allow_redisplay [String?] This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow.
    ...
    def post_terminal_readers_reader_process_setup_intent(
      *, 
      ...
      data, _status_code, _headers = post_terminal_readers_reader_process_setup_intent_with_http_info(reader: reader, allow_redisplay: allow_redisplay, setup_intent: setup_intent, expand: expand, process_config: process_config)
      data
    end
    ...
    def post_terminal_readers_reader_process_setup_intent_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_terminal_readers_reader_process_setup_intent(reader: reader, allow_redisplay: allow_redisplay, setup_intent: setup_intent, expand: expand, process_config: process_config)
    ...
    def post_terminal_readers_reader_process_setup_intent(
      *,
      ...
      build_api_request_for_post_terminal_readers_reader_process_setup_intent(reader: reader, allow_redisplay: allow_redisplay, setup_intent: setup_intent, expand: expand, process_config: process_config).execute(&block)
    end

    POST_TERMINAL_READERS_READER_PROCESS_SETUP_INTENT_MAX_LENGTH_FOR_READER = 5000
    POST_TERMINAL_READERS_READER_PROCESS_SETUP_INTENT_VALID_VALUES_FOR_ALLOW_REDISPLAY = String.static_array("always", "limited", "unspecified")
    ...
    def build_api_request_for_post_terminal_readers_reader_process_setup_intent(
      *, 
      ...
      if client_side_validation?
        ...
        raise ArgumentError.new("\"allow_redisplay\" is required and cannot be null") if allow_redisplay.nil?
        unless (_allow_redisplay = allow_redisplay).nil?
          OpenApi::EnumValidator.validate("allow_redisplay", _allow_redisplay, POST_TERMINAL_READERS_READER_PROCESS_SETUP_INTENT_VALID_VALUES_FOR_ALLOW_REDISPLAY)
        end
