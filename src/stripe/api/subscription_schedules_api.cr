  ...
  class SubscriptionSchedulesApi
    ...
    def build_api_request_for_get_subscription_schedules(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_scheduled = scheduled).nil?
        end
    ...
    def post_subscription_schedules(
      *, 
      ...
      data, _status_code, _headers = post_subscription_schedules_with_http_info(billing_mode: billing_mode, customer: customer, default_settings: default_settings, end_behavior: end_behavior, expand: expand, from_subscription: from_subscription, metadata: metadata, phases: phases, start_date: start_date)
      data
    end
    ...
    def post_subscription_schedules_with_http_info(
      *, 
      ...
      request = build_api_request_for_post_subscription_schedules(billing_mode: billing_mode, customer: customer, default_settings: default_settings, end_behavior: end_behavior, expand: expand, from_subscription: from_subscription, metadata: metadata, phases: phases, start_date: start_date)
    ...
    def post_subscription_schedules(
      *,
      ...
      build_api_request_for_post_subscription_schedules(billing_mode: billing_mode, customer: customer, default_settings: default_settings, end_behavior: end_behavior, expand: expand, from_subscription: from_subscription, metadata: metadata, phases: phases, start_date: start_date).execute(&block)
    end
    ...
    # @optional @param proration_behavior [String?] If the update changes the billing configuration (item price, quantity, etc.) of the current phase, indicates how prorations from this change should be handled. The default value is `create_prorations`.
    # @return [Stripe::SubscriptionSchedule]
    ...
    def build_api_request_for_post_subscription_schedules_schedule_release(
      *, 
      ...
      if client_side_validation?
        ...
        unless (_preserve_cancel_date = preserve_cancel_date).nil?
        end
      end
