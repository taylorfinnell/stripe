...
module Stripe
  class IssuingApi
    ...
    GET_ISSUING_AUTHORIZATIONS_VALID_VALUES_FOR_STATUS = String.static_array("closed", "expired", "pending", "reversed")
    ...
    # @optional @param expand [Array(String)?] Specifies which fields in the response should be expanded.
    # @optional @param financial_account [String?] The new financial account ID the card will be associated with. This field allows a card to be reassigned to a different financial account.
    # @optional @param metadata [Hash(String, String)?]
