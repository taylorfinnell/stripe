...
module Stripe
  ...
  class TreasuryDebitReversal
    ...
    @[JSON::Field(key: "linked_flows", type: Stripe::TreasuryReceivedDebitsResourceDebitReversalLinkedFlows?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: linked_flows.nil? && !linked_flows_present?)]
