...
module Stripe
  ...
  class IssuingDisputeMerchandiseNotAsDescribedEvidence
    ...
    @[JSON::Field(key: "received_at", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: received_at.nil? && !received_at_present?)]
    getter received_at : Int32? = nil
    ...
    def received_at=(new_value : Int32?)
