...
module Stripe
  class SourceTypeAcssDebit
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_bank_address_city = @bank_address_city).nil?
      end
      unless (_bank_address_line_1 = @bank_address_line_1).nil?
      end
      unless (_bank_address_line_2 = @bank_address_line_2).nil?
      end
      unless (_bank_address_postal_code = @bank_address_postal_code).nil?
      end
