...
module Stripe
  class PaymentIntentPaymentMethodOptionsSepaDebit1
    ...
    property mandate_options : Stripe::PaymentIntentPaymentMethodOptionsMandateOptionsSepaDebit? = nil
    ...
    def_equals_and_hash(@mandate_options, @setup_future_usage, @target_date, @capture_method, @installments, @request_incremental_authorization_support, @require_cvc_recollection, @routing, @verification_method)
  end
end
