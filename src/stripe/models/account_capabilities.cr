...
module Stripe
  ...
  class AccountCapabilities
    ...
    @[JSON::Field(key: "alma_payments", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter alma_payments : String? = nil
    ERROR_MESSAGE_FOR_ALMA_PAYMENTS = "invalid value for \"alma_payments\", must be one of [active, inactive, pending]."
    VALID_VALUES_FOR_ALMA_PAYMENTS = String.static_array("active", "inactive", "pending")
    ...
    @[JSON::Field(key: "billie_payments", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter billie_payments : String? = nil
    ERROR_MESSAGE_FOR_BILLIE_PAYMENTS = "invalid value for \"billie_payments\", must be one of [active, inactive, pending]."
    VALID_VALUES_FOR_BILLIE_PAYMENTS = String.static_array("active", "inactive", "pending")
    ...
    @[JSON::Field(key: "crypto_payments", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter crypto_payments : String? = nil
    ERROR_MESSAGE_FOR_CRYPTO_PAYMENTS = "invalid value for \"crypto_payments\", must be one of [active, inactive, pending]."
    VALID_VALUES_FOR_CRYPTO_PAYMENTS = String.static_array("active", "inactive", "pending")
    ...
    @[JSON::Field(key: "kakao_pay_payments", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter kakao_pay_payments : String? = nil
    ERROR_MESSAGE_FOR_KAKAO_PAY_PAYMENTS = "invalid value for \"kakao_pay_payments\", must be one of [active, inactive, pending]."
    VALID_VALUES_FOR_KAKAO_PAY_PAYMENTS = String.static_array("active", "inactive", "pending")
    ...
    @[JSON::Field(key: "kr_card_payments", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter kr_card_payments : String? = nil
    ERROR_MESSAGE_FOR_KR_CARD_PAYMENTS = "invalid value for \"kr_card_payments\", must be one of [active, inactive, pending]."
    VALID_VALUES_FOR_KR_CARD_PAYMENTS = String.static_array("active", "inactive", "pending")
    ...
    @[JSON::Field(key: "naver_pay_payments", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter naver_pay_payments : String? = nil
    ERROR_MESSAGE_FOR_NAVER_PAY_PAYMENTS = "invalid value for \"naver_pay_payments\", must be one of [active, inactive, pending]."
    VALID_VALUES_FOR_NAVER_PAY_PAYMENTS = String.static_array("active", "inactive", "pending")
    ...
    @[JSON::Field(key: "nz_bank_account_becs_debit_payments", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter nz_bank_account_becs_debit_payments : String? = nil
    ERROR_MESSAGE_FOR_NZ_BANK_ACCOUNT_BECS_DEBIT_PAYMENTS = "invalid value for \"nz_bank_account_becs_debit_payments\", must be one of [active, inactive, pending]."
    VALID_VALUES_FOR_NZ_BANK_ACCOUNT_BECS_DEBIT_PAYMENTS = String.static_array("active", "inactive", "pending")
    ...
    @[JSON::Field(key: "pay_by_bank_payments", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter pay_by_bank_payments : String? = nil
    ERROR_MESSAGE_FOR_PAY_BY_BANK_PAYMENTS = "invalid value for \"pay_by_bank_payments\", must be one of [active, inactive, pending]."
    VALID_VALUES_FOR_PAY_BY_BANK_PAYMENTS = String.static_array("active", "inactive", "pending")



    # The status of the Payco capability of the account, or whether the account can directly process Payco payments.
    @[JSON::Field(key: "payco_payments", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter payco_payments : String? = nil
    ERROR_MESSAGE_FOR_PAYCO_PAYMENTS = "invalid value for \"payco_payments\", must be one of [active, inactive, pending]."
    VALID_VALUES_FOR_PAYCO_PAYMENTS = String.static_array("active", "inactive", "pending")
    ...
    @[JSON::Field(key: "pix_payments", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter pix_payments : String? = nil
    ERROR_MESSAGE_FOR_PIX_PAYMENTS = "invalid value for \"pix_payments\", must be one of [active, inactive, pending]."
    VALID_VALUES_FOR_PIX_PAYMENTS = String.static_array("active", "inactive", "pending")
    ...
    @[JSON::Field(key: "samsung_pay_payments", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter samsung_pay_payments : String? = nil
    ERROR_MESSAGE_FOR_SAMSUNG_PAY_PAYMENTS = "invalid value for \"samsung_pay_payments\", must be one of [active, inactive, pending]."
    VALID_VALUES_FOR_SAMSUNG_PAY_PAYMENTS = String.static_array("active", "inactive", "pending")



    # The status of the Satispay capability of the account, or whether the account can directly process Satispay payments.
    @[JSON::Field(key: "satispay_payments", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter satispay_payments : String? = nil
    ERROR_MESSAGE_FOR_SATISPAY_PAYMENTS = "invalid value for \"satispay_payments\", must be one of [active, inactive, pending]."
    VALID_VALUES_FOR_SATISPAY_PAYMENTS = String.static_array("active", "inactive", "pending")
    ...
    def initialize(
      *,
      ...
      @kakao_pay_payments : String? = nil,
      @klarna_payments : String? = nil,
      @konbini_payments : String? = nil,
      @kr_card_payments : String? = nil,
      ...
      @naver_pay_payments : String? = nil,
      @nz_bank_account_becs_debit_payments : String? = nil,
      @oxxo_payments : String? = nil,
      @p24_payments : String? = nil,
      @pay_by_bank_payments : String? = nil,
      @payco_payments : String? = nil,
      @paynow_payments : String? = nil,
      @pix_payments : String? = nil,
      @promptpay_payments : String? = nil,
      @revolut_pay_payments : String? = nil,
      @samsung_pay_payments : String? = nil,
      @satispay_payments : String? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_alma_payments = @alma_payments).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_ALMA_PAYMENTS) unless OpenApi::EnumValidator.valid?(_alma_payments, VALID_VALUES_FOR_ALMA_PAYMENTS)
      end
      ...
      unless (_billie_payments = @billie_payments).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_BILLIE_PAYMENTS) unless OpenApi::EnumValidator.valid?(_billie_payments, VALID_VALUES_FOR_BILLIE_PAYMENTS)
      end
      ...
      unless (_crypto_payments = @crypto_payments).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_CRYPTO_PAYMENTS) unless OpenApi::EnumValidator.valid?(_crypto_payments, VALID_VALUES_FOR_CRYPTO_PAYMENTS)
      end
      ...
      unless (_kakao_pay_payments = @kakao_pay_payments).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_KAKAO_PAY_PAYMENTS) unless OpenApi::EnumValidator.valid?(_kakao_pay_payments, VALID_VALUES_FOR_KAKAO_PAY_PAYMENTS)
      end
      ...
      unless (_kr_card_payments = @kr_card_payments).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_KR_CARD_PAYMENTS) unless OpenApi::EnumValidator.valid?(_kr_card_payments, VALID_VALUES_FOR_KR_CARD_PAYMENTS)
      end
      ...
      unless (_naver_pay_payments = @naver_pay_payments).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_NAVER_PAY_PAYMENTS) unless OpenApi::EnumValidator.valid?(_naver_pay_payments, VALID_VALUES_FOR_NAVER_PAY_PAYMENTS)
      end
      unless (_nz_bank_account_becs_debit_payments = @nz_bank_account_becs_debit_payments).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_NZ_BANK_ACCOUNT_BECS_DEBIT_PAYMENTS) unless OpenApi::EnumValidator.valid?(_nz_bank_account_becs_debit_payments, VALID_VALUES_FOR_NZ_BANK_ACCOUNT_BECS_DEBIT_PAYMENTS)
      end
      ...
      unless (_pay_by_bank_payments = @pay_by_bank_payments).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_PAY_BY_BANK_PAYMENTS) unless OpenApi::EnumValidator.valid?(_pay_by_bank_payments, VALID_VALUES_FOR_PAY_BY_BANK_PAYMENTS)
      end
      unless (_payco_payments = @payco_payments).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_PAYCO_PAYMENTS) unless OpenApi::EnumValidator.valid?(_payco_payments, VALID_VALUES_FOR_PAYCO_PAYMENTS)
      end
      ...
      unless (_pix_payments = @pix_payments).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_PIX_PAYMENTS) unless OpenApi::EnumValidator.valid?(_pix_payments, VALID_VALUES_FOR_PIX_PAYMENTS)
      end
      ...
      unless (_samsung_pay_payments = @samsung_pay_payments).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_SAMSUNG_PAY_PAYMENTS) unless OpenApi::EnumValidator.valid?(_samsung_pay_payments, VALID_VALUES_FOR_SAMSUNG_PAY_PAYMENTS)
      end
      unless (_satispay_payments = @satispay_payments).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_SATISPAY_PAYMENTS) unless OpenApi::EnumValidator.valid?(_satispay_payments, VALID_VALUES_FOR_SATISPAY_PAYMENTS)
      end
    ...
    def valid? : Bool
      ...
      unless (_alma_payments = @alma_payments).nil?
        return false unless OpenApi::EnumValidator.valid?(_alma_payments, VALID_VALUES_FOR_ALMA_PAYMENTS)
      end
      ...
      unless (_billie_payments = @billie_payments).nil?
        return false unless OpenApi::EnumValidator.valid?(_billie_payments, VALID_VALUES_FOR_BILLIE_PAYMENTS)
      end
      ...
      unless (_crypto_payments = @crypto_payments).nil?
        return false unless OpenApi::EnumValidator.valid?(_crypto_payments, VALID_VALUES_FOR_CRYPTO_PAYMENTS)
      end
      ...
      unless (_kakao_pay_payments = @kakao_pay_payments).nil?
        return false unless OpenApi::EnumValidator.valid?(_kakao_pay_payments, VALID_VALUES_FOR_KAKAO_PAY_PAYMENTS)
      end
      ...
      unless (_kr_card_payments = @kr_card_payments).nil?
        return false unless OpenApi::EnumValidator.valid?(_kr_card_payments, VALID_VALUES_FOR_KR_CARD_PAYMENTS)
      end
      ...
      unless (_naver_pay_payments = @naver_pay_payments).nil?
        return false unless OpenApi::EnumValidator.valid?(_naver_pay_payments, VALID_VALUES_FOR_NAVER_PAY_PAYMENTS)
      end

      unless (_nz_bank_account_becs_debit_payments = @nz_bank_account_becs_debit_payments).nil?
        return false unless OpenApi::EnumValidator.valid?(_nz_bank_account_becs_debit_payments, VALID_VALUES_FOR_NZ_BANK_ACCOUNT_BECS_DEBIT_PAYMENTS)
      end
      ...
      unless (_pay_by_bank_payments = @pay_by_bank_payments).nil?
        return false unless OpenApi::EnumValidator.valid?(_pay_by_bank_payments, VALID_VALUES_FOR_PAY_BY_BANK_PAYMENTS)
      end

      unless (_payco_payments = @payco_payments).nil?
        return false unless OpenApi::EnumValidator.valid?(_payco_payments, VALID_VALUES_FOR_PAYCO_PAYMENTS)
      end
      ...
      unless (_pix_payments = @pix_payments).nil?
        return false unless OpenApi::EnumValidator.valid?(_pix_payments, VALID_VALUES_FOR_PIX_PAYMENTS)
      end
      ...
      unless (_samsung_pay_payments = @samsung_pay_payments).nil?
        return false unless OpenApi::EnumValidator.valid?(_samsung_pay_payments, VALID_VALUES_FOR_SAMSUNG_PAY_PAYMENTS)
      end

      unless (_satispay_payments = @satispay_payments).nil?
        return false unless OpenApi::EnumValidator.valid?(_satispay_payments, VALID_VALUES_FOR_SATISPAY_PAYMENTS)
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] alma_payments Object to be assigned
    def alma_payments=(new_value : String?)

      unless new_value.nil?
        OpenApi::EnumValidator.validate("alma_payments", new_value, VALID_VALUES_FOR_ALMA_PAYMENTS)
      end

      @alma_payments = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] billie_payments Object to be assigned
    def billie_payments=(new_value : String?)

      unless new_value.nil?
        OpenApi::EnumValidator.validate("billie_payments", new_value, VALID_VALUES_FOR_BILLIE_PAYMENTS)
      end

      @billie_payments = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] crypto_payments Object to be assigned
    def crypto_payments=(new_value : String?)

      unless new_value.nil?
        OpenApi::EnumValidator.validate("crypto_payments", new_value, VALID_VALUES_FOR_CRYPTO_PAYMENTS)
      end

      @crypto_payments = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] kakao_pay_payments Object to be assigned
    def kakao_pay_payments=(new_value : String?)

      unless new_value.nil?
        OpenApi::EnumValidator.validate("kakao_pay_payments", new_value, VALID_VALUES_FOR_KAKAO_PAY_PAYMENTS)
      end

      @kakao_pay_payments = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] kr_card_payments Object to be assigned
    def kr_card_payments=(new_value : String?)

      unless new_value.nil?
        OpenApi::EnumValidator.validate("kr_card_payments", new_value, VALID_VALUES_FOR_KR_CARD_PAYMENTS)
      end

      @kr_card_payments = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] naver_pay_payments Object to be assigned
    def naver_pay_payments=(new_value : String?)

      unless new_value.nil?
        OpenApi::EnumValidator.validate("naver_pay_payments", new_value, VALID_VALUES_FOR_NAVER_PAY_PAYMENTS)
      end

      @naver_pay_payments = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] nz_bank_account_becs_debit_payments Object to be assigned
    def nz_bank_account_becs_debit_payments=(new_value : String?)

      unless new_value.nil?
        OpenApi::EnumValidator.validate("nz_bank_account_becs_debit_payments", new_value, VALID_VALUES_FOR_NZ_BANK_ACCOUNT_BECS_DEBIT_PAYMENTS)
      end

      @nz_bank_account_becs_debit_payments = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] pay_by_bank_payments Object to be assigned
    def pay_by_bank_payments=(new_value : String?)

      unless new_value.nil?
        OpenApi::EnumValidator.validate("pay_by_bank_payments", new_value, VALID_VALUES_FOR_PAY_BY_BANK_PAYMENTS)
      end

      @pay_by_bank_payments = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] payco_payments Object to be assigned
    def payco_payments=(new_value : String?)

      unless new_value.nil?
        OpenApi::EnumValidator.validate("payco_payments", new_value, VALID_VALUES_FOR_PAYCO_PAYMENTS)
      end

      @payco_payments = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] pix_payments Object to be assigned
    def pix_payments=(new_value : String?)

      unless new_value.nil?
        OpenApi::EnumValidator.validate("pix_payments", new_value, VALID_VALUES_FOR_PIX_PAYMENTS)
      end

      @pix_payments = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] samsung_pay_payments Object to be assigned
    def samsung_pay_payments=(new_value : String?)

      unless new_value.nil?
        OpenApi::EnumValidator.validate("samsung_pay_payments", new_value, VALID_VALUES_FOR_SAMSUNG_PAY_PAYMENTS)
      end

      @samsung_pay_payments = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] satispay_payments Object to be assigned
    def satispay_payments=(new_value : String?)

      unless new_value.nil?
        OpenApi::EnumValidator.validate("satispay_payments", new_value, VALID_VALUES_FOR_SATISPAY_PAYMENTS)
      end

      @satispay_payments = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
