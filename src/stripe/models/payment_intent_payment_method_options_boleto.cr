...
module Stripe
  class PaymentIntentPaymentMethodOptionsBoleto
    ...
    @[JSON::Field(key: "expires_after_days", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    ...
    def_equals_and_hash(@expires_after_days, @capture_method, @installments, @request_incremental_authorization_support, @require_cvc_recollection, @routing, @setup_future_usage, @verification_method)
  end
end
