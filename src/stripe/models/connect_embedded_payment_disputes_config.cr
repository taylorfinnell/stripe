...
require "./connect_embedded_payment_disputes_features" 
...
module Stripe
  ...
  class ConnectEmbeddedPaymentDisputesConfig
    ...
    @[JSON::Field(key: "features", type: Stripe::ConnectEmbeddedPaymentDisputesFeatures?, default: nil, required: true, nullable: false, emit_null: false)]
    getter features : Stripe::ConnectEmbeddedPaymentDisputesFeatures? = nil
    ...
    def initialize(
      *,
      # Required properties
      @enabled : Bool? = nil, 
      @features : Stripe::ConnectEmbeddedPaymentDisputesFeatures? = nil
    )
    end
    ...
    def features=(new_value : Stripe::ConnectEmbeddedPaymentDisputesFeatures?)
