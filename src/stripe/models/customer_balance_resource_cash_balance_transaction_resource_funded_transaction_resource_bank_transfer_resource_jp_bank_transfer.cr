...
module Stripe
  ...
  class CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferResourceJpBankTransfer
    ...
    @[JSON::Field(key: "sender_bank", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: sender_bank.nil? && !sender_bank_present?)]
    getter sender_bank : String? = nil
    MAX_LENGTH_FOR_SENDER_BANK = 5000

    @[JSON::Field(ignore: true)]
    property? sender_bank_present : Bool = false


    # The name of the bank branch of the sender of the funding.
    @[JSON::Field(key: "sender_branch", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: sender_branch.nil? && !sender_branch_present?)]
    getter sender_branch : String? = nil
    MAX_LENGTH_FOR_SENDER_BRANCH = 5000

    @[JSON::Field(ignore: true)]
    property? sender_branch_present : Bool = false
    ...
    def_equals_and_hash(@sender_bank, @sender_bank_present, @sender_branch, @sender_branch_present, @sender_name, @sender_name_present)
  end
end
