...
module Stripe
  class PaymentIntentPaymentMethodOptionsCardPresent
    ...
    property request_extended_authorization : Bool? = nil
    ...
    def_equals_and_hash(@capture_method, @installments, @request_incremental_authorization_support, @request_incremental_authorization_support_present, @require_cvc_recollection, @routing, @setup_future_usage, @verification_method, @request_extended_authorization, @request_extended_authorization_present)
  end
end
