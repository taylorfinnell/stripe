...
module Stripe
  ...
  class TaxProductResourceCustomerDetails
    ...
    @[JSON::Field(key: "address", type: Stripe::TaxProductResourcePostalAddress?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: address.nil? && !address_present?)]
    ...
    @[JSON::Field(key: "address_source", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: address_source.nil? && !address_source_present?)]
    ...
    @[JSON::Field(ignore: true)]
    property? address_source_present : Bool = false
    ...
    def_equals_and_hash(@tax_ids, @taxability_override, @address, @address_present, @address_source, @address_source_present, @ip_address, @ip_address_present)
  end
end
