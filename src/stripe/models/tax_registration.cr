...
module Stripe
  ...
  class TaxRegistration
    ...
    @[JSON::Field(key: "active_from", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter active_from : Int32? = nil
    ...
    def active_from=(new_value : Int32?)
    ...
    def_equals_and_hash(@active_from, @country, @country_options, @created, @id, @livemode, @object, @status, @expires_at, @expires_at_present)
  end
end
