...
module Stripe
  class PostSubscriptionsSubscriptionExposedIdRequest
    ...
    @[JSON::Field(key: "proration_date", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter proration_date : Int32? = nil
    ...
    def proration_date=(new_value : Int32?)
