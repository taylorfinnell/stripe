...
module Stripe
  class Canceled
    ...
    @[JSON::Field(key: "expected_at", type: Stripe::CanceledCanceledAt?, default: nil, required: false, nullable: false, emit_null: false)]
    getter expected_at : Stripe::CanceledCanceledAt? = nil
    ...
    def initialize(
      *,
      ...
      @expected_at : Stripe::CanceledCanceledAt? = nil,
    ...
    def expected_at=(new_value : Stripe::CanceledCanceledAt?)
