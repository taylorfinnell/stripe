...
module Stripe
  class PostInvoiceitemsRequest
    ...
    @[JSON::Field(key: "pricing", type: Stripe::PricingParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter pricing : Stripe::PricingParam? = nil
    ...
    def pricing=(new_value : Stripe::PricingParam?)
    ...
    def_equals_and_hash(@customer, @amount, @currency, @description, @discountable, @discounts, @expand, @invoice, @metadata, @period, @price_data, @pricing, @quantity, @subscription, @tax_behavior, @tax_code, @tax_rates, @unit_amount_decimal)
  end
end
