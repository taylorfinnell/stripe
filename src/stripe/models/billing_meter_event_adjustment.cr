...
module Stripe
  ...
  class BillingMeterEventAdjustment
    ...
    @[JSON::Field(key: "cancel", type: Stripe::BillingMeterResourceBillingMeterEventAdjustmentCancel?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: cancel.nil? && !cancel_present?)]
    getter cancel : Stripe::BillingMeterResourceBillingMeterEventAdjustmentCancel? = nil

    @[JSON::Field(ignore: true)]
    property? cancel_present : Bool = false
    ...
    def_equals_and_hash(@event_name, @livemode, @object, @status, @_type, @cancel, @cancel_present)
  end
end
