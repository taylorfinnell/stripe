...
module Stripe
  ...
  class IssuingCardholder
    ...
    @[JSON::Field(key: "company", type: Stripe::IssuingCardholderCompany?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: company.nil? && !company_present?)]
    ...
    @[JSON::Field(key: "individual", type: Stripe::IssuingCardholderIndividual?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: individual.nil? && !individual_present?)]
    ...
    @[JSON::Field(key: "spending_controls", type: Stripe::IssuingCardholderAuthorizationControls?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: spending_controls.nil? && !spending_controls_present?)]
    ...
    def_equals_and_hash(@billing, @created, @id, @livemode, @metadata, @name, @object, @requirements, @status, @_type, @company, @company_present, @email, @email_present, @individual, @individual_present, @phone_number, @phone_number_present, @preferred_locales, @preferred_locales_present, @spending_controls, @spending_controls_present)
  end
end
