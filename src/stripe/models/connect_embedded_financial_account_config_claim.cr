...
require "./connect_embedded_financial_account_features" 
...
module Stripe
  ...
  class ConnectEmbeddedFinancialAccountConfigClaim
    ...
    @[JSON::Field(key: "features", type: Stripe::ConnectEmbeddedFinancialAccountFeatures?, default: nil, required: true, nullable: false, emit_null: false)]
    getter features : Stripe::ConnectEmbeddedFinancialAccountFeatures? = nil
    ...
    def initialize(
      *,
      # Required properties
      @enabled : Bool? = nil, 
      @features : Stripe::ConnectEmbeddedFinancialAccountFeatures? = nil
    )
    end
    ...
    def features=(new_value : Stripe::ConnectEmbeddedFinancialAccountFeatures?)
