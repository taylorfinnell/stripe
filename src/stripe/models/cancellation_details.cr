...
module Stripe
  ...
  class CancellationDetails
    ...
    @[JSON::Field(key: "feedback", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: feedback.nil? && !feedback_present?)]
    ...
    @[JSON::Field(ignore: true)]
    property? feedback_present : Bool = false
    ...
    def_equals_and_hash(@comment, @comment_present, @feedback, @feedback_present, @reason, @reason_present)
  end
end
