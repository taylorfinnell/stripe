...
module Stripe
  ...
  class TreasuryReceivedCreditsResourceSourceFlowsDetails
    ...
    ERROR_MESSAGE_FOR__TYPE = "invalid value for \"_type\", must be one of [credit_reversal, other, outbound_payment, outbound_transfer, payout]."
    VALID_VALUES_FOR__TYPE = String.static_array("credit_reversal", "other", "outbound_payment", "outbound_transfer", "payout")
    ...
    def_equals_and_hash(@_type, @credit_reversal, @outbound_payment, @outbound_transfer, @payout)
  end
end
