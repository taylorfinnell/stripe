...
module Stripe
  ...
  class IssuingPersonalizationDesign
    ...
    @[JSON::Field(key: "card_logo", type: Stripe::IssuingPersonalizationDesignCardLogo?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: card_logo.nil? && !card_logo_present?)]
    getter card_logo : Stripe::IssuingPersonalizationDesignCardLogo? = nil

    @[JSON::Field(ignore: true)]
    property? card_logo_present : Bool = false


    @[JSON::Field(key: "carrier_text", type: Stripe::IssuingPersonalizationDesignCarrierText?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: carrier_text.nil? && !carrier_text_present?)]
    getter carrier_text : Stripe::IssuingPersonalizationDesignCarrierText? = nil

    @[JSON::Field(ignore: true)]
    property? carrier_text_present : Bool = false
    ...
    def_equals_and_hash(@created, @id, @livemode, @metadata, @object, @physical_bundle, @preferences, @rejection_reasons, @status, @card_logo, @card_logo_present, @carrier_text, @carrier_text_present, @lookup_key, @lookup_key_present, @name, @name_present)
  end
end
