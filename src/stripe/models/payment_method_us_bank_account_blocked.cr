...
module Stripe
  ...
  class PaymentMethodUsBankAccountBlocked
    ...
    @[JSON::Field(key: "network_code", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: network_code.nil? && !network_code_present?)]
    ...
    property? network_code_present : Bool = false
    ...
    def_equals_and_hash(@network_code, @network_code_present, @reason, @reason_present)
  end
end
