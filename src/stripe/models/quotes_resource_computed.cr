...
module Stripe
  ...
  class QuotesResourceComputed
    ...
    @[JSON::Field(key: "recurring", type: Stripe::QuotesResourceRecurring?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: recurring.nil? && !recurring_present?)]
