...
module Stripe
  ...
  class ClimateRemovalsOrderDeliveries
    ...
    @[JSON::Field(key: "delivered_at", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "location", type: Stripe::ClimateRemovalsLocation?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: location.nil? && !location_present?)]
    ...
    @[JSON::Field(key: "registry_url", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: registry_url.nil? && !registry_url_present?)]
    getter registry_url : String? = nil
    MAX_LENGTH_FOR_REGISTRY_URL = 5000

    @[JSON::Field(ignore: true)]
    property? registry_url_present : Bool = false
    ...
    def_equals_and_hash(@delivered_at, @metric_tons, @supplier, @location, @location_present, @registry_url, @registry_url_present)
  end
end
