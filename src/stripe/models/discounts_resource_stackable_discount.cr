...
module Stripe
  ...
  class DiscountsResourceStackableDiscount
    ...
    @[JSON::Field(key: "coupon", type: Stripe::DiscountsResourceStackableDiscountCoupon?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: coupon.nil? && !coupon_present?)]
    ...
    @[JSON::Field(key: "discount", type: Stripe::DiscountsResourceStackableDiscountDiscount?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: discount.nil? && !discount_present?)]
    ...
    @[JSON::Field(key: "promotion_code", type: Stripe::DiscountsResourceStackableDiscountPromotionCode?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: promotion_code.nil? && !promotion_code_present?)]
