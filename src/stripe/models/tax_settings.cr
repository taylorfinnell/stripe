...
module Stripe
  ...
  class TaxSettings
    ...
    @[JSON::Field(key: "head_office", type: Stripe::TaxProductResourceTaxSettingsHeadOffice?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: head_office.nil? && !head_office_present?)]
    getter head_office : Stripe::TaxProductResourceTaxSettingsHeadOffice? = nil

    @[JSON::Field(ignore: true)]
    property? head_office_present : Bool = false
    ...
    def_equals_and_hash(@defaults, @livemode, @object, @status, @status_details, @head_office, @head_office_present)
  end
end
