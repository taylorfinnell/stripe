...
require "./linked_account_options_common" 
...
module Stripe
  class PaymentIntentPaymentMethodOptionsUsBankAccount1
    ...
    @[JSON::Field(key: "financial_connections", type: Stripe::LinkedAccountOptionsCommon?, default: nil, required: false, nullable: false, emit_null: false)]
    property financial_connections : Stripe::LinkedAccountOptionsCommon? = nil
    ...
    property mandate_options : Stripe::PaymentMethodOptionsUsBankAccountMandateOptions? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @financial_connections : Stripe::LinkedAccountOptionsCommon? = nil,
    ...
    def_equals_and_hash(@financial_connections, @mandate_options, @preferred_settlement_speed, @setup_future_usage, @target_date, @verification_method, @capture_method, @installments, @request_incremental_authorization_support, @require_cvc_recollection, @routing)
  end
end
