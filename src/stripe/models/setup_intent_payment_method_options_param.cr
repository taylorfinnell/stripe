...
require "./on_demand_param" 
require "./setup_intent_payment_method_options_param_subscriptions" 
...
module Stripe
  class SetupIntentPaymentMethodOptionsParam
    ...
    @[JSON::Field(key: "on_demand", type: Stripe::OnDemandParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter on_demand : Stripe::OnDemandParam? = nil
    ...
    ERROR_MESSAGE_FOR_PREFERRED_LOCALE = "invalid value for \"preferred_locale\", must be one of [cs-CZ, da-DK, de-AT, de-CH, de-DE, el-GR, en-AT, en-AU, en-BE, en-CA, en-CH, en-CZ, en-DE, en-DK, en-ES, en-FI, en-FR, en-GB, en-GR, en-IE, en-IT, en-NL, en-NO, en-NZ, en-PL, en-PT, en-RO, en-SE, en-US, es-ES, es-US, fi-FI, fr-BE, fr-CA, fr-CH, fr-FR, it-CH, it-IT, nb-NO, nl-BE, nl-NL, pl-PL, pt-PT, ro-RO, sv-FI, sv-SE]."
    VALID_VALUES_FOR_PREFERRED_LOCALE = String.static_array("cs-CZ", "da-DK", "de-AT", "de-CH", "de-DE", "el-GR", "en-AT", "en-AU", "en-BE", "en-CA", "en-CH", "en-CZ", "en-DE", "en-DK", "en-ES", "en-FI", "en-FR", "en-GB", "en-GR", "en-IE", "en-IT", "en-NL", "en-NO", "en-NZ", "en-PL", "en-PT", "en-RO", "en-SE", "en-US", "es-ES", "es-US", "fi-FI", "fr-BE", "fr-CA", "fr-CH", "fr-FR", "it-CH", "it-IT", "nb-NO", "nl-BE", "nl-NL", "pl-PL", "pt-PT", "ro-RO", "sv-FI", "sv-SE")
    ...
    @[JSON::Field(key: "subscriptions", type: Stripe::SetupIntentPaymentMethodOptionsParamSubscriptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter subscriptions : Stripe::SetupIntentPaymentMethodOptionsParamSubscriptions? = nil
    ...
    def initialize(
      *,
      ...
      @on_demand : Stripe::OnDemandParam? = nil,
      @preferred_locale : String? = nil,
      @requestor_challenge_indicator : String? = nil,
      @subscriptions : Stripe::SetupIntentPaymentMethodOptionsParamSubscriptions? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_on_demand = @on_demand).nil?
        invalid_properties.concat(_on_demand.list_invalid_properties_for("on_demand")) if _on_demand.is_a?(OpenApi::Validatable)
      end
    ...
    def valid? : Bool
      ...
      unless (_on_demand = @on_demand).nil?
        return false if _on_demand.is_a?(OpenApi::Validatable) && !_on_demand.valid?
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] on_demand Object to be assigned
    def on_demand=(new_value : Stripe::OnDemandParam?)
    ...
    def subscriptions=(new_value : Stripe::SetupIntentPaymentMethodOptionsParamSubscriptions?)
    ...
    def_equals_and_hash(@ares_trans_status, @cryptogram, @currency, @electronic_commerce_indicator, @financial_connections, @mandate_options, @network_options, @networks, @on_demand, @preferred_locale, @requestor_challenge_indicator, @subscriptions, @transaction_id, @verification_method, @version)
  end
end
