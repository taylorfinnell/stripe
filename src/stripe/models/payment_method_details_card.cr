...
module Stripe
  ...
  class PaymentMethodDetailsCard
    ...
    @[JSON::Field(key: "checks", type: Stripe::PaymentMethodDetailsCardChecks?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: checks.nil? && !checks_present?)]
    ...
    @[JSON::Field(key: "installments", type: Stripe::PaymentMethodDetailsCardInstallments?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: installments.nil? && !installments_present?)]
    ...
    @[JSON::Field(key: "three_d_secure", type: Stripe::ThreeDSecureDetailsCharge?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: three_d_secure.nil? && !three_d_secure_present?)]
    ...
    @[JSON::Field(key: "wallet", type: Stripe::PaymentMethodDetailsCardWallet?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: wallet.nil? && !wallet_present?)]
    ...
    def_equals_and_hash(@exp_month, @exp_year, @amount_authorized, @amount_authorized_present, @authorization_code, @authorization_code_present, @brand, @brand_present, @capture_before, @checks, @checks_present, @country, @country_present, @extended_authorization, @fingerprint, @fingerprint_present, @funding, @funding_present, @incremental_authorization, @installments, @installments_present, @last4, @last4_present, @mandate, @mandate_present, @multicapture, @network, @network_present, @network_token, @network_token_present, @network_transaction_id, @network_transaction_id_present, @overcapture, @regulated_status, @regulated_status_present, @three_d_secure, @three_d_secure_present, @wallet, @wallet_present)
  end
end
