...
module Stripe
  ...
  class AutomaticTax
    ...
    ERROR_MESSAGE_FOR_DISABLED_REASON = "invalid value for \"disabled_reason\", must be one of [finalization_requires_location_inputs, finalization_system_error]."
    VALID_VALUES_FOR_DISABLED_REASON = String.static_array("finalization_requires_location_inputs", "finalization_system_error")
    ...
    def_equals_and_hash(@enabled, @disabled_reason, @disabled_reason_present, @liability, @liability_present, @provider, @provider_present, @status, @status_present)
  end
end
