...
module Stripe
  class SubscriptionDataParams
    ...
    @[JSON::Field(key: "trial_end", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def_equals_and_hash(@application_fee_percent, @billing_cycle_anchor, @billing_mode, @default_tax_rates, @description, @invoice_settings, @metadata, @on_behalf_of, @proration_behavior, @transfer_data, @trial_end, @trial_period_days, @trial_settings)
  end
end
