...
module Stripe
  class PostSetupIntentsIntentConfirmRequest
    ...
    def_equals_and_hash(@client_secret, @confirmation_token, @expand, @mandate_data, @payment_method, @payment_method_data, @payment_method_options, @return_url, @use_stripe_sdk)
  end
end
