...
require "./transfer_data_capture_params" 
...
module Stripe
  class PostPaymentIntentsIntentCaptureRequest
    ...
    @[JSON::Field(key: "amount_to_capture", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter amount_to_capture : Int32? = nil
    ...
    @[JSON::Field(key: "transfer_data", type: Stripe::TransferDataCaptureParams?, default: nil, required: false, nullable: false, emit_null: false)]
    getter transfer_data : Stripe::TransferDataCaptureParams? = nil
    ...
    def amount_to_capture=(new_value : Int32?)
    ...
    def transfer_data=(new_value : Stripe::TransferDataCaptureParams?)
