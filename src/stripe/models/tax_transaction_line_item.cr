...
module Stripe
  ...
  class TaxTransactionLineItem
    ...
    @[JSON::Field(key: "product", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: product.nil? && !product_present?)]
    ...
    @[JSON::Field(key: "reversal", type: Stripe::TaxProductResourceTaxTransactionLineItemResourceReversal?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: reversal.nil? && !reversal_present?)]
    ...
    def_equals_and_hash(@amount, @amount_tax, @id, @livemode, @object, @quantity, @reference, @tax_behavior, @tax_code, @_type, @metadata, @metadata_present, @product, @product_present, @reversal, @reversal_present)
  end
end
