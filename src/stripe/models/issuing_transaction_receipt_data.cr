...
module Stripe
  ...
  class IssuingTransactionReceiptData
    ...
    @[JSON::Field(key: "total", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: total.nil? && !total_present?)]
    ...
    @[JSON::Field(key: "unit_cost", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: unit_cost.nil? && !unit_cost_present?)]
    getter unit_cost : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_unit_cost = @unit_cost).nil?
      end
      invalid_properties
    end
