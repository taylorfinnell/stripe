...
module Stripe
  ...
  class FundingInstructionsBankTransferZenginRecord
    ...
    def_equals_and_hash(@account_holder_address, @bank_address, @account_holder_name, @account_holder_name_present, @account_number, @account_number_present, @account_type, @account_type_present, @bank_code, @bank_code_present, @bank_name, @bank_name_present, @branch_code, @branch_code_present, @branch_name, @branch_name_present)
  end
end
