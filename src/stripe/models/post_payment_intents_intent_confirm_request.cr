...
module Stripe
  class PostPaymentIntentsIntentConfirmRequest
    ...
    def_equals_and_hash(@capture_method, @client_secret, @confirmation_token, @error_on_requires_action, @expand, @mandate, @mandate_data, @off_session, @payment_method, @payment_method_data, @payment_method_options, @payment_method_types, @radar_options, @receipt_email, @return_url, @setup_future_usage, @shipping, @use_stripe_sdk)
  end
end
