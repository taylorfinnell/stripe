...
module Stripe
  ...
  class Coupon
    ...
    getter times_redeemed : Int32? = nil
    ...
    getter duration_in_months : Int32? = nil
    ...
    getter max_redemptions : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_times_redeemed = @times_redeemed).nil?
      end
      invalid_properties.push("\"valid\" is required and cannot be null") if @valid.nil?

      unless (_valid = @valid).nil?
      end
      unless (_amount_off = @amount_off).nil?
      end
      ...
      unless (_duration_in_months = @duration_in_months).nil?
      end
      unless (_max_redemptions = @max_redemptions).nil?
      end
      ...
      unless (_percent_off = @percent_off).nil?
      end
      unless (_redeem_by = @redeem_by).nil?
      end
      invalid_properties
    end
    ...
    def times_redeemed=(new_value : Int32?)
    ...
    def amount_off=(new_value : Int32?)
    ...
    def duration_in_months=(new_value : Int32?)
    ...
    def max_redemptions=(new_value : Int32?)
