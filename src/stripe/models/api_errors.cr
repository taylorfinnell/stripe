...
module Stripe
  ...
  class ApiErrors
    ...
    @[JSON::Field(key: "advice_code", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter advice_code : String? = nil
    MAX_LENGTH_FOR_ADVICE_CODE = 5000
    ...
    @[JSON::Field(key: "network_advice_code", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "network_decline_code", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_advice_code = @advice_code).nil?
        if max_length_error = OpenApi::PrimitiveValidator.max_length_error("advice_code", _advice_code.to_s.size, MAX_LENGTH_FOR_ADVICE_CODE)
    ...
    def valid? : Bool
      ...
      unless (_advice_code = @advice_code).nil?
        return false if _advice_code.to_s.size > MAX_LENGTH_FOR_ADVICE_CODE
      end
    ...
    def advice_code=(new_value : String?)
      ...
      unless new_value.nil?
        OpenApi::PrimitiveValidator.validate_max_length("advice_code", new_value.to_s.size, MAX_LENGTH_FOR_ADVICE_CODE)
      end
    ...
    def_equals_and_hash(@_type, @advice_code, @charge, @code, @decline_code, @doc_url, @message, @network_advice_code, @network_decline_code, @param, @payment_intent, @payment_method, @payment_method_type, @request_log_url, @setup_intent, @source)
  end
end
