...
module Stripe
  ...
  class PaymentMethodUsBankAccount
    ...
    @[JSON::Field(key: "networks", type: Stripe::UsBankAccountNetworks?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: networks.nil? && !networks_present?)]
    ...
    @[JSON::Field(key: "status_details", type: Stripe::PaymentMethodUsBankAccountStatusDetails?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: status_details.nil? && !status_details_present?)]
    getter status_details : Stripe::PaymentMethodUsBankAccountStatusDetails? = nil

    @[JSON::Field(ignore: true)]
    property? status_details_present : Bool = false
