...
module Stripe
  class GetTerminalReadersReader200Response
    ...
    ERROR_MESSAGE_FOR_DEVICE_TYPE = "invalid value for \"device_type\", must be one of [bbpos_chipper2x, bbpos_wisepad3, bbpos_wisepos_e, mobile_phone_reader, simulated_stripe_s700, simulated_wisepos_e, stripe_m2, stripe_s700, verifone_P400]."
    VALID_VALUES_FOR_DEVICE_TYPE = String.static_array("bbpos_chipper2x", "bbpos_wisepad3", "bbpos_wisepos_e", "mobile_phone_reader", "simulated_stripe_s700", "simulated_wisepos_e", "stripe_m2", "stripe_s700", "verifone_P400")
    ...
    @[JSON::Field(key: "action", type: Stripe::TerminalReaderReaderResourceReaderAction?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def_equals_and_hash(@deleted, @id, @object, @device_type, @label, @livemode, @metadata, @serial_number, @action, @device_sw_version, @device_sw_version_present, @ip_address, @ip_address_present, @location, @location_present, @status, @status_present)
  end
end
