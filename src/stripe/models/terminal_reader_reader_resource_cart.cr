...
module Stripe
  ...
  class TerminalReaderReaderResourceCart
    ...
    @[JSON::Field(key: "tax", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: tax.nil? && !tax_present?)]
    getter tax : Int32? = nil
