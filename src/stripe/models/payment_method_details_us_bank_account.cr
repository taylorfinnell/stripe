...
module Stripe
  ...
  class PaymentMethodDetailsUsBankAccount
    ...
    def_equals_and_hash(@account_holder_type, @account_holder_type_present, @account_type, @account_type_present, @bank_name, @bank_name_present, @fingerprint, @fingerprint_present, @last4, @last4_present, @mandate, @payment_reference, @payment_reference_present, @routing_number, @routing_number_present)
  end
end
