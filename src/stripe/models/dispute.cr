...
module Stripe
  ...
  class Dispute
    ...
    getter enhanced_eligibility_types : Array(String)? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"enhanced_eligibility_types\" is required and cannot be null") if @enhanced_eligibility_types.nil?

      unless (_enhanced_eligibility_types = @enhanced_eligibility_types).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_ENHANCED_ELIGIBILITY_TYPES) unless OpenApi::EnumValidator.valid?(_enhanced_eligibility_types, VALID_VALUES_FOR_ENHANCED_ELIGIBILITY_TYPES)
      end
      ...
      unless (_is_charge_refundable = @is_charge_refundable).nil?
      end
    ...
    def valid? : Bool
      ...
      return false if @enhanced_eligibility_types.nil?
      unless (_enhanced_eligibility_types = @enhanced_eligibility_types).nil?
        return false unless OpenApi::EnumValidator.valid?(_enhanced_eligibility_types, VALID_VALUES_FOR_ENHANCED_ELIGIBILITY_TYPES)
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] enhanced_eligibility_types Object to be assigned
    def enhanced_eligibility_types=(new_value : Array(String)?)

      raise ArgumentError.new("\"enhanced_eligibility_types\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
        OpenApi::EnumValidator.validate("enhanced_eligibility_types", new_value, VALID_VALUES_FOR_ENHANCED_ELIGIBILITY_TYPES)
      end

      @enhanced_eligibility_types = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    def_equals_and_hash(@amount, @balance_transactions, @charge, @created, @currency, @enhanced_eligibility_types, @evidence, @evidence_details, @id, @is_charge_refundable, @livemode, @metadata, @object, @reason, @status, @payment_intent, @payment_intent_present, @payment_method_details)
  end
end
