...
module Stripe
  ...
  class TreasuryReceivedDebit
    ...
    ERROR_MESSAGE_FOR_FAILURE_CODE = "invalid value for \"failure_code\", must be one of [account_closed, account_frozen, insufficient_funds, international_transaction, other]."
    VALID_VALUES_FOR_FAILURE_CODE = String.static_array("account_closed", "account_frozen", "insufficient_funds", "international_transaction", "other")
    ...
    @[JSON::Field(key: "reversal_details", type: Stripe::TreasuryReceivedDebitsResourceReversalDetails?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: reversal_details.nil? && !reversal_details_present?)]
