...
require "./outbound_transfers_payment_method_details_financial_account" 
...
module Stripe
  ...
  class OutboundTransfersPaymentMethodDetails
    ...
    @[JSON::Field(key: "financial_account", type: Stripe::OutboundTransfersPaymentMethodDetailsFinancialAccount?, default: nil, required: false, nullable: false, emit_null: false)]
    getter financial_account : Stripe::OutboundTransfersPaymentMethodDetailsFinancialAccount? = nil
    ...
    def initialize(
      *,
      ...
      @_type : String? = nil,
      # Optional properties
      @financial_account : Stripe::OutboundTransfersPaymentMethodDetailsFinancialAccount? = nil,
    ...
    def financial_account=(new_value : Stripe::OutboundTransfersPaymentMethodDetailsFinancialAccount?)
