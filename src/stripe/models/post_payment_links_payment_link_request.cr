...
module Stripe
  class PostPaymentLinksPaymentLinkRequest
    ...
    def_equals_and_hash(@active, @after_completion, @allow_promotion_codes, @automatic_tax, @billing_address_collection, @custom_fields, @custom_text, @customer_creation, @expand, @inactive_message, @invoice_creation, @line_items, @metadata, @payment_intent_data, @payment_method_collection, @payment_method_types, @phone_number_collection, @restrictions, @shipping_address_collection, @submit_type, @subscription_data, @tax_id_collection)
  end
end
