...
module Stripe
  ...
  class ConfirmationTokensResourceMandateDataResourceCustomerAcceptance
    ...
    @[JSON::Field(key: "online", type: Stripe::ConfirmationTokensResourceMandateDataResourceCustomerAcceptanceResourceOnline?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: online.nil? && !online_present?)]
    ...
    def_equals_and_hash(@_type, @online, @online_present)
  end
end
