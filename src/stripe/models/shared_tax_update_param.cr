...
module Stripe
  class SharedTaxUpdateParam
    ...
    ERROR_MESSAGE_FOR_VALIDATE_LOCATION = "invalid value for \"validate_location\", must be one of [auto, deferred, immediately]."
    VALID_VALUES_FOR_VALIDATE_LOCATION = String.static_array("auto", "deferred", "immediately")
