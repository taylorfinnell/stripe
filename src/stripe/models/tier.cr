...
module Stripe
  class Tier
    ...
    @[JSON::Field(key: "flat_amount", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "unit_amount", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
