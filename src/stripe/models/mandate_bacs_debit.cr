...
module Stripe
  ...
  class MandateBacsDebit
    ...
    @[JSON::Field(key: "revocation_reason", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: revocation_reason.nil? && !revocation_reason_present?)]
    ...
    property? revocation_reason_present : Bool = false
    ...
    def_equals_and_hash(@network_status, @reference, @url, @revocation_reason, @revocation_reason_present)
  end
end
