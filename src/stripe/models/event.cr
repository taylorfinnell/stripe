...
module Stripe
  ...
  class Event
    ...
    @[JSON::Field(key: "pending_webhooks", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter pending_webhooks : Int32? = nil
    ...
    @[JSON::Field(key: "context", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter context : String? = nil
    MAX_LENGTH_FOR_CONTEXT = 5000



    @[JSON::Field(key: "request", type: Stripe::NotificationEventRequest?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: request.nil? && !request_present?)]
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_pending_webhooks = @pending_webhooks).nil?
      end
      ...
      unless (_context = @context).nil?
        if max_length_error = OpenApi::PrimitiveValidator.max_length_error("context", _context.to_s.size, MAX_LENGTH_FOR_CONTEXT)
          invalid_properties.push(max_length_error)
        end
      end
    ...
    def valid? : Bool
      ...
      unless (_context = @context).nil?
        return false if _context.to_s.size > MAX_LENGTH_FOR_CONTEXT
      end
    ...
    def pending_webhooks=(new_value : Int32?)
    ...
    def context=(new_value : String?)

      unless new_value.nil?
        OpenApi::PrimitiveValidator.validate_max_length("context", new_value.to_s.size, MAX_LENGTH_FOR_CONTEXT)
      end
    ...
    def_equals_and_hash(@created, @data, @id, @livemode, @object, @pending_webhooks, @_type, @account, @api_version, @api_version_present, @context, @request, @request_present)
  end
end
