...
module Stripe
  class DocumentOptions
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_require_id_number = @require_id_number).nil?
      end
      unless (_require_live_capture = @require_live_capture).nil?
      end
      unless (_require_matching_selfie = @require_matching_selfie).nil?
      end
      invalid_properties
    end
