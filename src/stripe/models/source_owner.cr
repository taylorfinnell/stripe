...
module Stripe
  ...
  class SourceOwner
    ...
    @[JSON::Field(key: "verified_address", type: Stripe::Address?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: verified_address.nil? && !verified_address_present?)]
