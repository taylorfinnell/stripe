...
module Stripe
  ...
  class IssuingToken
    ...
    @[JSON::Field(key: "network_updated_at", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter network_updated_at : Int32? = nil
    ...
    @[JSON::Field(key: "device_fingerprint", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: device_fingerprint.nil? && !device_fingerprint_present?)]
    getter device_fingerprint : String? = nil
    MAX_LENGTH_FOR_DEVICE_FINGERPRINT = 5000

    @[JSON::Field(ignore: true)]
    property? device_fingerprint_present : Bool = false
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_network_updated_at = @network_updated_at).nil?
      end
    ...
    def network_updated_at=(new_value : Int32?)
    ...
    def_equals_and_hash(@card, @created, @id, @livemode, @network, @network_updated_at, @object, @status, @device_fingerprint, @device_fingerprint_present, @last4, @network_data, @wallet_provider)
  end
end
