...
module Stripe
  ...
  class IssuingAuthorizationVerificationData
    ...
    @[JSON::Field(key: "authentication_exemption", type: Stripe::IssuingAuthorizationAuthenticationExemption?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: authentication_exemption.nil? && !authentication_exemption_present?)]
    getter authentication_exemption : Stripe::IssuingAuthorizationAuthenticationExemption? = nil

    @[JSON::Field(ignore: true)]
    property? authentication_exemption_present : Bool = false
    ...
    @[JSON::Field(key: "three_d_secure", type: Stripe::IssuingAuthorizationThreeDSecure?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: three_d_secure.nil? && !three_d_secure_present?)]
    ...
    def_equals_and_hash(@address_line1_check, @address_postal_code_check, @cvc_check, @expiry_check, @authentication_exemption, @authentication_exemption_present, @postal_code, @postal_code_present, @three_d_secure, @three_d_secure_present)
  end
end
