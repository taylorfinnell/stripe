...
module Stripe
  ...
  class ProductDefaultPrice
    ...
    def_equals_and_hash(@active, @billing_scheme, @created, @currency, @id, @livemode, @metadata, @object, @product, @_type, @currency_options, @custom_unit_amount, @lookup_key, @lookup_key_present, @nickname, @nickname_present, @recurring, @tax_behavior, @tax_behavior_present, @tiers, @tiers_mode, @tiers_mode_present, @transform_quantity, @unit_amount, @unit_amount_present, @unit_amount_decimal, @unit_amount_decimal_present)
  end
end
