...
require "./optional_item_adjustable_quantity_params" 
...
module Stripe
  class OptionalItemParams
    ...
    @[JSON::Field(key: "adjustable_quantity", type: Stripe::OptionalItemAdjustableQuantityParams?, default: nil, required: false, nullable: false, emit_null: false)]
    getter adjustable_quantity : Stripe::OptionalItemAdjustableQuantityParams? = nil
    ...
    def initialize(
      *,
      ...
      @quantity : Int32? = nil,
      # Optional properties
      @adjustable_quantity : Stripe::OptionalItemAdjustableQuantityParams? = nil
    )
    end
    ...
    def adjustable_quantity=(new_value : Stripe::OptionalItemAdjustableQuantityParams?)
