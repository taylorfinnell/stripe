...
module Stripe
  ...
  class PersonAdditionalTosAcceptances
    ...
    @[JSON::Field(key: "account", type: Stripe::PersonAdditionalTosAcceptance?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: account.nil? && !account_present?)]
