...
module Stripe
  ...
  class BillingPortalSession
    ...
    @[JSON::Field(key: "flow", type: Stripe::PortalFlowsFlow?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: flow.nil? && !flow_present?)]
