...
module Stripe
  ...
  class FinancialConnectionsSession
    ...
    def_equals_and_hash(@accounts, @client_secret, @id, @livemode, @object, @permissions, @account_holder, @account_holder_present, @filters, @prefetch, @prefetch_present, @return_url)
  end
end
