...
module Stripe
  class PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequest
    ...
    @[JSON::Field(key: "amount_tip", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter amount_tip : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_amount_tip = @amount_tip).nil?
      end
    ...
    def amount_tip=(new_value : Int32?)
    ...
    def_equals_and_hash(@amount_tip, @card_present, @expand, @interac_present, @_type)
  end
end
