...
module Stripe
  ...
  class CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures
    ...
    @[JSON::Field(key: "payment_method_redisplay_limit", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: payment_method_redisplay_limit.nil? && !payment_method_redisplay_limit_present?)]
    getter payment_method_redisplay_limit : Int32? = nil

    @[JSON::Field(ignore: true)]
    property? payment_method_redisplay_limit_present : Bool = false
    ...
    @[JSON::Field(key: "payment_method_save_usage", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: payment_method_save_usage.nil? && !payment_method_save_usage_present?)]
    ...
    @[JSON::Field(ignore: true)]
    property? payment_method_save_usage_present : Bool = false
    ...
    def initialize(
      *,
      ...
      # Optional properties
      @payment_method_redisplay_limit : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_payment_method_redisplay_limit = @payment_method_redisplay_limit).nil?
      end
    ...
    def payment_method_redisplay_limit=(new_value : Int32?)
    ...
    def_equals_and_hash(@payment_method_allow_redisplay_filters, @payment_method_redisplay, @payment_method_remove, @payment_method_save, @payment_method_redisplay_limit, @payment_method_redisplay_limit_present, @payment_method_save_usage, @payment_method_save_usage_present)
  end
end
