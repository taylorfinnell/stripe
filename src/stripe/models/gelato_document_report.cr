...
module Stripe
  ...
  class GelatoDocumentReport
    ...
    @[JSON::Field(key: "error", type: Stripe::GelatoDocumentReportError?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: error.nil? && !error_present?)]
    ...
    @[JSON::Field(key: "issued_date", type: Stripe::GelatoDataDocumentReportIssuedDate?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: issued_date.nil? && !issued_date_present?)]
    ...
    @[JSON::Field(key: "sex", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: sex.nil? && !sex_present?)]
    getter sex : String? = nil
    ERROR_MESSAGE_FOR_SEX = "invalid value for \"sex\", must be one of [[redacted], female, male, unknown]."
    VALID_VALUES_FOR_SEX = String.static_array("[redacted]", "female", "male", "unknown")

    @[JSON::Field(ignore: true)]
    property? sex_present : Bool = false
    ...
    @[JSON::Field(key: "unparsed_place_of_birth", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: unparsed_place_of_birth.nil? && !unparsed_place_of_birth_present?)]
    getter unparsed_place_of_birth : String? = nil
    MAX_LENGTH_FOR_UNPARSED_PLACE_OF_BIRTH = 5000

    @[JSON::Field(ignore: true)]
    property? unparsed_place_of_birth_present : Bool = false


    # Sex as it appears in the document.
    @[JSON::Field(key: "unparsed_sex", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: unparsed_sex.nil? && !unparsed_sex_present?)]
    getter unparsed_sex : String? = nil
    MAX_LENGTH_FOR_UNPARSED_SEX = 5000

    @[JSON::Field(ignore: true)]
    property? unparsed_sex_present : Bool = false
    ...
    def initialize(
      *,
      ...
      @sex : String? = nil,
      @_type : String? = nil,
      @unparsed_place_of_birth : String? = nil,
      @unparsed_sex : String? = nil
    )
    end
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_sex = @sex).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_SEX) unless OpenApi::EnumValidator.valid?(_sex, VALID_VALUES_FOR_SEX)
      end
      unless (__type = @_type).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR__TYPE) unless OpenApi::EnumValidator.valid?(__type, VALID_VALUES_FOR__TYPE)
      end
      unless (_unparsed_place_of_birth = @unparsed_place_of_birth).nil?
        if max_length_error = OpenApi::PrimitiveValidator.max_length_error("unparsed_place_of_birth", _unparsed_place_of_birth.to_s.size, MAX_LENGTH_FOR_UNPARSED_PLACE_OF_BIRTH)
          invalid_properties.push(max_length_error)
        end
      end
      unless (_unparsed_sex = @unparsed_sex).nil?
        if max_length_error = OpenApi::PrimitiveValidator.max_length_error("unparsed_sex", _unparsed_sex.to_s.size, MAX_LENGTH_FOR_UNPARSED_SEX)
          invalid_properties.push(max_length_error)
        end
      end
      invalid_properties
    ...
    def valid? : Bool
      ...
      unless (_sex = @sex).nil?
        return false unless OpenApi::EnumValidator.valid?(_sex, VALID_VALUES_FOR_SEX)
      end
      ...
      unless (_unparsed_place_of_birth = @unparsed_place_of_birth).nil?
        return false if _unparsed_place_of_birth.to_s.size > MAX_LENGTH_FOR_UNPARSED_PLACE_OF_BIRTH
      end

      unless (_unparsed_sex = @unparsed_sex).nil?
        return false if _unparsed_sex.to_s.size > MAX_LENGTH_FOR_UNPARSED_SEX
      end
    ...
    def sex=(new_value : String?)

      unless new_value.nil?
        OpenApi::EnumValidator.validate("sex", new_value, VALID_VALUES_FOR_SEX)
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] unparsed_place_of_birth Object to be assigned
    def unparsed_place_of_birth=(new_value : String?)

      unless new_value.nil?
        OpenApi::PrimitiveValidator.validate_max_length("unparsed_place_of_birth", new_value.to_s.size, MAX_LENGTH_FOR_UNPARSED_PLACE_OF_BIRTH)
      end

      @unparsed_place_of_birth = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] unparsed_sex Object to be assigned
    def unparsed_sex=(new_value : String?)

      unless new_value.nil?
        OpenApi::PrimitiveValidator.validate_max_length("unparsed_sex", new_value.to_s.size, MAX_LENGTH_FOR_UNPARSED_SEX)
      end

      @unparsed_sex = new_value
    end
