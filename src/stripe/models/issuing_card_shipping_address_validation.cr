...
module Stripe
  ...
  class IssuingCardShippingAddressValidation
    ...
    @[JSON::Field(key: "normalized_address", type: Stripe::Address?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: normalized_address.nil? && !normalized_address_present?)]
    getter normalized_address : Stripe::Address? = nil

    @[JSON::Field(ignore: true)]
    property? normalized_address_present : Bool = false
    ...
    def_equals_and_hash(@mode, @normalized_address, @normalized_address_present, @result, @result_present)
  end
end
