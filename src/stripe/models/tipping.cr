...
module Stripe
  class Tipping
    ...
    @[JSON::Field(key: "jpy", type: Stripe::CurrencySpecificConfig?, default: nil, required: false, nullable: false, emit_null: false)]
    getter jpy : Stripe::CurrencySpecificConfig? = nil
    ...
    @[JSON::Field(key: "pln", type: Stripe::CurrencySpecificConfig?, default: nil, required: false, nullable: false, emit_null: false)]
    getter pln : Stripe::CurrencySpecificConfig? = nil
    ...
    def jpy=(new_value : Stripe::CurrencySpecificConfig?)
    ...
    def pln=(new_value : Stripe::CurrencySpecificConfig?)
