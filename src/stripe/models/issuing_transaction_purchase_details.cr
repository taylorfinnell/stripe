...
module Stripe
  ...
  class IssuingTransactionPurchaseDetails
    ...
    @[JSON::Field(key: "fleet", type: Stripe::IssuingTransactionFleetData?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: fleet.nil? && !fleet_present?)]
    ...
    @[JSON::Field(key: "flight", type: Stripe::IssuingTransactionFlightData?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: flight.nil? && !flight_present?)]
    ...
    @[JSON::Field(key: "fuel", type: Stripe::IssuingTransactionFuelData?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: fuel.nil? && !fuel_present?)]
    ...
    @[JSON::Field(key: "lodging", type: Stripe::IssuingTransactionLodgingData?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: lodging.nil? && !lodging_present?)]
    ...
    def_equals_and_hash(@fleet, @fleet_present, @flight, @flight_present, @fuel, @fuel_present, @lodging, @lodging_present, @receipt, @receipt_present, @reference, @reference_present)
  end
end
