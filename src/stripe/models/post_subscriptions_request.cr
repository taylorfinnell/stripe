...
module Stripe
  class PostSubscriptionsRequest
    ...
    @[JSON::Field(key: "backdate_start_date", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter backdate_start_date : Int32? = nil



    # A future timestamp in UTC format to anchor the subscription's [billing cycle](https://stripe.com/docs/subscriptions/billing-cycle). The anchor is the reference point that aligns future billing cycle dates. It sets the day of week for `week` intervals, the day of month for `month` and `year` intervals, and the month of year for `year` intervals.
    @[JSON::Field(key: "billing_cycle_anchor", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "billing_mode", type: Stripe::BillingMode?, default: nil, required: false, nullable: false, emit_null: false)]
    getter billing_mode : Stripe::BillingMode? = nil
    ...
    @[JSON::Field(key: "cancel_at", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "trial_period_days", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def backdate_start_date=(new_value : Int32?)
    ...
    def billing_mode=(new_value : Stripe::BillingMode?)
    ...
    def_equals_and_hash(@customer, @add_invoice_items, @application_fee_percent, @automatic_tax, @backdate_start_date, @billing_cycle_anchor, @billing_cycle_anchor_config, @billing_mode, @billing_thresholds, @cancel_at, @cancel_at_period_end, @collection_method, @currency, @days_until_due, @default_payment_method, @default_source, @default_tax_rates, @description, @discounts, @expand, @invoice_settings, @items, @metadata, @off_session, @on_behalf_of, @payment_behavior, @payment_settings, @pending_invoice_item_interval, @proration_behavior, @transfer_data, @trial_end, @trial_from_plan, @trial_period_days, @trial_settings)
  end
end
