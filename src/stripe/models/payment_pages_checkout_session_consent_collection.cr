...
module Stripe
  ...
  class PaymentPagesCheckoutSessionConsentCollection
    ...
    @[JSON::Field(key: "payment_method_reuse_agreement", type: Stripe::PaymentPagesCheckoutSessionPaymentMethodReuseAgreement?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: payment_method_reuse_agreement.nil? && !payment_method_reuse_agreement_present?)]
    getter payment_method_reuse_agreement : Stripe::PaymentPagesCheckoutSessionPaymentMethodReuseAgreement? = nil

    @[JSON::Field(ignore: true)]
    property? payment_method_reuse_agreement_present : Bool = false
    ...
    def_equals_and_hash(@payment_method_reuse_agreement, @payment_method_reuse_agreement_present, @promotions, @promotions_present, @terms_of_service, @terms_of_service_present)
  end
end
