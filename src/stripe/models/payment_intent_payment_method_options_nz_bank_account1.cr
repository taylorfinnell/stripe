...
require "./payment_intent_payment_method_options_nz_bank_account" 
...
module Stripe
  class PaymentIntentPaymentMethodOptionsNzBankAccount1
    ...
    def self.openapi_any_of
      [
      Stripe::PaymentIntentPaymentMethodOptionsNzBankAccount,
    ...
    def_equals_and_hash(@setup_future_usage, @target_date, @capture_method, @installments, @request_incremental_authorization_support, @require_cvc_recollection, @routing, @verification_method)
  end
end
