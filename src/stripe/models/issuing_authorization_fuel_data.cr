...
module Stripe
  ...
  class IssuingAuthorizationFuelData
    ...
    @[JSON::Field(key: "unit", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: unit.nil? && !unit_present?)]
    ...
    @[JSON::Field(ignore: true)]
    property? unit_present : Bool = false


    # The cost in cents per each unit of fuel, represented as a decimal string with at most 12 decimal places.
    @[JSON::Field(key: "unit_cost_decimal", type: BigDecimal?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: unit_cost_decimal.nil? && !unit_cost_decimal_present?)]
    getter unit_cost_decimal : BigDecimal? = nil

    @[JSON::Field(ignore: true)]
    property? unit_cost_decimal_present : Bool = false
    ...
    def_equals_and_hash(@industry_product_code, @industry_product_code_present, @quantity_decimal, @quantity_decimal_present, @_type, @_type_present, @unit, @unit_present, @unit_cost_decimal, @unit_cost_decimal_present)
  end
end
