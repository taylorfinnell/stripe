...
module Stripe
  ...
  class PaymentMethodCashapp
    ...
    @[JSON::Field(key: "cashtag", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: cashtag.nil? && !cashtag_present?)]
    getter cashtag : String? = nil
    MAX_LENGTH_FOR_CASHTAG = 5000

    @[JSON::Field(ignore: true)]
    property? cashtag_present : Bool = false
    ...
    def_equals_and_hash(@buyer_id, @buyer_id_present, @cashtag, @cashtag_present)
  end
end
