...
module Stripe
  ...
  class ClimateProduct
    ...
    @[JSON::Field(key: "delivery_year", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: delivery_year.nil? && !delivery_year_present?)]
    getter delivery_year : Int32? = nil

    @[JSON::Field(ignore: true)]
    property? delivery_year_present : Bool = false
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_metric_tons_available = @metric_tons_available).nil?
      end
      ...
      unless (_delivery_year = @delivery_year).nil?
      end
      invalid_properties
    end
    ...
    def delivery_year=(new_value : Int32?)
    ...
    def_equals_and_hash(@created, @current_prices_per_metric_ton, @id, @livemode, @metric_tons_available, @name, @object, @suppliers, @delivery_year, @delivery_year_present)
  end
end
