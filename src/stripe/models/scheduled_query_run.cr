...
module Stripe
  ...
  class ScheduledQueryRun
    ...
    @[JSON::Field(key: "data_load_time", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data_load_time : Int32? = nil
    ...
    @[JSON::Field(key: "result_available_until", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter result_available_until : Int32? = nil
    ...
    def initialize(
      *,
      # Required properties
      @created : Int32? = nil, 
      @data_load_time : Int32? = nil, 
      @id : String? = nil, 
      @livemode : Bool? = nil, 
      @object : String? = nil, 
      @result_available_until : Int32? = nil, 
      @sql : String? = nil, 
      @status : String? = nil, 
      @title : String? = nil,
      # Optional properties
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_data_load_time = @data_load_time).nil?
      end
      ...
      unless (_result_available_until = @result_available_until).nil?
      end
    ...
    def data_load_time=(new_value : Int32?)
    ...
    def result_available_until=(new_value : Int32?)
