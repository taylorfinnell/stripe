...
module Stripe
  ...
  class IssuingTransaction
    ...
    @[JSON::Field(key: "amount_details", type: Stripe::IssuingTransactionAmountDetails?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: amount_details.nil? && !amount_details_present?)]
    ...
    @[JSON::Field(key: "network_data", type: Stripe::IssuingTransactionNetworkData?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: network_data.nil? && !network_data_present?)]
