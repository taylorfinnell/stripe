...
require "./dispute_enhanced_evidence" 
...
module Stripe
  ...
  class DisputeEvidence
    ...
    @[JSON::Field(key: "enhanced_evidence", type: Stripe::DisputeEnhancedEvidence?, default: nil, required: true, nullable: false, emit_null: false)]
    getter enhanced_evidence : Stripe::DisputeEnhancedEvidence? = nil
    ...
    def initialize(
      *,
      # Required properties
      @enhanced_evidence : Stripe::DisputeEnhancedEvidence? = nil,
      # Optional properties
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"enhanced_evidence\" is required and cannot be null") if @enhanced_evidence.nil?

      unless (_enhanced_evidence = @enhanced_evidence).nil?
        invalid_properties.concat(_enhanced_evidence.list_invalid_properties_for("enhanced_evidence")) if _enhanced_evidence.is_a?(OpenApi::Validatable)
      end
    ...
    def valid? : Bool
      ...
      return false if @enhanced_evidence.nil?
      unless (_enhanced_evidence = @enhanced_evidence).nil?
        return false if _enhanced_evidence.is_a?(OpenApi::Validatable) && !_enhanced_evidence.valid?
      end
    ...
    # @param [Object] enhanced_evidence Object to be assigned
    def enhanced_evidence=(new_value : Stripe::DisputeEnhancedEvidence?)

      raise ArgumentError.new("\"enhanced_evidence\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end

      @enhanced_evidence = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
