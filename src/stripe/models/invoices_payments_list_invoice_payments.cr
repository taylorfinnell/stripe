...
module Stripe
  class InvoicesPaymentsListInvoicePayments
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::InvoicePayment)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::InvoicePayment)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::InvoicePayment)? = nil, 
      @has_more : Bool? = nil, 
      @object : String? = nil, 
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::InvoicePayment)?)
