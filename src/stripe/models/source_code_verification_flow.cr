...
module Stripe
  ...
  class SourceCodeVerificationFlow
    ...
    @[JSON::Field(key: "attempts_remaining", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter attempts_remaining : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_attempts_remaining = @attempts_remaining).nil?
      end
    ...
    def attempts_remaining=(new_value : Int32?)
