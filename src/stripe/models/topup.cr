...
module Stripe
  ...
  class Topup
    ...
    getter expected_availability_date : Int32? = nil
    ...
    @[JSON::Field(key: "source", type: Stripe::Source?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: source.nil? && !source_present?)]
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_expected_availability_date = @expected_availability_date).nil?
      end
    ...
    def expected_availability_date=(new_value : Int32?)
