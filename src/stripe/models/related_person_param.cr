...
module Stripe
  class RelatedPersonParam
    ...
    @[JSON::Field(key: "person", type: String?, default: nil, required: true, nullable: false, emit_null: false)]
    getter person : String? = nil
    MAX_LENGTH_FOR_PERSON = 5000
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"person\" is required and cannot be null") if @person.nil?

      unless (_person = @person).nil?
        if max_length_error = OpenApi::PrimitiveValidator.max_length_error("person", _person.to_s.size, MAX_LENGTH_FOR_PERSON)
          invalid_properties.push(max_length_error)
        end
      end
      invalid_properties
    ...
    def valid? : Bool
      ...
      unless (_person = @person).nil?
        return false if _person.to_s.size > MAX_LENGTH_FOR_PERSON
      end
    ...
    def person=(new_value : String?)

      raise ArgumentError.new("\"person\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
        OpenApi::PrimitiveValidator.validate_max_length("person", new_value.to_s.size, MAX_LENGTH_FOR_PERSON)
      end
    ...
    def_equals_and_hash(@account, @person)
  end
end
