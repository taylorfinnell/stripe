...
module Stripe
  class DocumentsSpecs
    ...
    @[JSON::Field(key: "proof_of_address", type: Stripe::DocumentsParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter proof_of_address : Stripe::DocumentsParam? = nil
    ...
    @[JSON::Field(key: "proof_of_ultimate_beneficial_ownership", type: Stripe::DocumentsParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter proof_of_ultimate_beneficial_ownership : Stripe::DocumentsParam? = nil
    ...
    def initialize(
      *,
      ...
      @proof_of_address : Stripe::DocumentsParam? = nil,
      @proof_of_registration : Stripe::DocumentsParam? = nil,
      @proof_of_ultimate_beneficial_ownership : Stripe::DocumentsParam? = nil
    )
    end
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_proof_of_address = @proof_of_address).nil?
        invalid_properties.concat(_proof_of_address.list_invalid_properties_for("proof_of_address")) if _proof_of_address.is_a?(OpenApi::Validatable)
      end
      ...
      unless (_proof_of_ultimate_beneficial_ownership = @proof_of_ultimate_beneficial_ownership).nil?
        invalid_properties.concat(_proof_of_ultimate_beneficial_ownership.list_invalid_properties_for("proof_of_ultimate_beneficial_ownership")) if _proof_of_ultimate_beneficial_ownership.is_a?(OpenApi::Validatable)
      end
      invalid_properties
    end
    ...
    def valid? : Bool
      ...
      unless (_proof_of_address = @proof_of_address).nil?
        return false if _proof_of_address.is_a?(OpenApi::Validatable) && !_proof_of_address.valid?
      end
      ...
      unless (_proof_of_ultimate_beneficial_ownership = @proof_of_ultimate_beneficial_ownership).nil?
        return false if _proof_of_ultimate_beneficial_ownership.is_a?(OpenApi::Validatable) && !_proof_of_ultimate_beneficial_ownership.valid?
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] proof_of_address Object to be assigned
    def proof_of_address=(new_value : Stripe::DocumentsParam?)

      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end

      @proof_of_address = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] proof_of_ultimate_beneficial_ownership Object to be assigned
    def proof_of_ultimate_beneficial_ownership=(new_value : Stripe::DocumentsParam?)

      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end

      @proof_of_ultimate_beneficial_ownership = new_value
    end
    ...
    def_equals_and_hash(@bank_account_ownership_verification, @company_license, @company_memorandum_of_association, @company_ministerial_decree, @company_registration_verification, @company_tax_id_verification, @proof_of_address, @proof_of_registration, @proof_of_ultimate_beneficial_ownership)
  end
end
