...
module Stripe
  ...
  class SetupAttemptPaymentMethodDetailsIdeal
    ...
    ERROR_MESSAGE_FOR_BANK = "invalid value for \"bank\", must be one of [abn_amro, asn_bank, bunq, buut, handelsbanken, ing, knab, moneyou, n26, nn, rabobank, regiobank, revolut, sns_bank, triodos_bank, van_lanschot, yoursafe]."
    VALID_VALUES_FOR_BANK = String.static_array("abn_amro", "asn_bank", "bunq", "buut", "handelsbanken", "ing", "knab", "moneyou", "n26", "nn", "rabobank", "regiobank", "revolut", "sns_bank", "triodos_bank", "van_lanschot", "yoursafe")
    ...
    ERROR_MESSAGE_FOR_BIC = "invalid value for \"bic\", must be one of [ABNANL2A, ASNBNL21, BITSNL2A, BUNQNL2A, BUUTNL2A, FVLBNL22, HANDNL2A, INGBNL2A, KNABNL2H, MOYONL21, NNBANL2G, NTSBDEB1, RABONL2U, RBRBNL21, REVOIE23, REVOLT21, SNSBNL2A, TRIONL2U]."
    VALID_VALUES_FOR_BIC = String.static_array("ABNANL2A", "ASNBNL21", "BITSNL2A", "BUNQNL2A", "BUUTNL2A", "FVLBNL22", "HANDNL2A", "INGBNL2A", "KNABNL2H", "MOYONL21", "NNBANL2G", "NTSBDEB1", "RABONL2U", "RBRBNL21", "REVOIE23", "REVOLT21", "SNSBNL2A", "TRIONL2U")
