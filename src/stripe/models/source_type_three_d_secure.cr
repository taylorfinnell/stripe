...
module Stripe
  class SourceTypeThreeDSecure
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_authenticated = @authenticated).nil?
      end
    ...
    def_equals_and_hash(@address_line1_check, @address_line1_check_present, @address_zip_check, @address_zip_check_present, @authenticated, @authenticated_present, @brand, @brand_present, @card, @card_present, @country, @country_present, @customer, @customer_present, @cvc_check, @cvc_check_present, @dynamic_last4, @dynamic_last4_present, @exp_month, @exp_month_present, @exp_year, @exp_year_present, @fingerprint, @funding, @funding_present, @last4, @last4_present, @name, @name_present, @three_d_secure, @tokenization_method, @tokenization_method_present)
  end
end
