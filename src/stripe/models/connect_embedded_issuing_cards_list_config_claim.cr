...
require "./connect_embedded_issuing_cards_list_features" 
...
module Stripe
  ...
  class ConnectEmbeddedIssuingCardsListConfigClaim
    ...
    @[JSON::Field(key: "features", type: Stripe::ConnectEmbeddedIssuingCardsListFeatures?, default: nil, required: true, nullable: false, emit_null: false)]
    getter features : Stripe::ConnectEmbeddedIssuingCardsListFeatures? = nil
    ...
    def initialize(
      *,
      # Required properties
      @enabled : Bool? = nil, 
      @features : Stripe::ConnectEmbeddedIssuingCardsListFeatures? = nil
    )
    end
    ...
    def features=(new_value : Stripe::ConnectEmbeddedIssuingCardsListFeatures?)
