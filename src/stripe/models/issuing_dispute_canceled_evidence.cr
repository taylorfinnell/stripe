...
module Stripe
  ...
  class IssuingDisputeCanceledEvidence
    ...
    @[JSON::Field(key: "expected_at", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: expected_at.nil? && !expected_at_present?)]
    getter expected_at : Int32? = nil
    ...
    def expected_at=(new_value : Int32?)
