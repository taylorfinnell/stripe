...
module Stripe
  class PaymentIntentPaymentMethodOptionsKlarna
    ...
    def_equals_and_hash(@capture_method, @installments, @request_incremental_authorization_support, @require_cvc_recollection, @routing, @setup_future_usage, @verification_method, @preferred_locale, @preferred_locale_present)
  end
end
