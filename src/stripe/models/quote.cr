...
module Stripe
  ...
  class Quote
    ...
    @[JSON::Field(key: "from_quote", type: Stripe::QuotesResourceFromQuote?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: from_quote.nil? && !from_quote_present?)]
    ...
    @[JSON::Field(key: "transfer_data", type: Stripe::QuotesResourceTransferData?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: transfer_data.nil? && !transfer_data_present?)]
    ...
    def_equals_and_hash(@amount_subtotal, @amount_total, @automatic_tax, @collection_method, @computed, @created, @discounts, @expires_at, @id, @invoice_settings, @livemode, @metadata, @object, @status, @status_transitions, @subscription_data, @total_details, @application, @application_present, @application_fee_amount, @application_fee_amount_present, @application_fee_percent, @application_fee_percent_present, @currency, @currency_present, @customer, @customer_present, @default_tax_rates, @description, @description_present, @footer, @footer_present, @from_quote, @from_quote_present, @header, @header_present, @invoice, @invoice_present, @line_items, @number, @number_present, @on_behalf_of, @on_behalf_of_present, @subscription, @subscription_present, @subscription_schedule, @subscription_schedule_present, @test_clock, @test_clock_present, @transfer_data, @transfer_data_present)
  end
end
