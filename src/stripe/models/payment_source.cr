...
require "./account_group_membership" 
...
module Stripe
  class PaymentSource
    ...
    ERROR_MESSAGE_FOR__TYPE = "invalid value for \"_type\", must be one of [custom, express, none, standard, ach_credit_transfer, ach_debit, acss_debit, alipay, au_becs_debit, bancontact, card, card_present, eps, giropay, ideal, klarna, multibanco, p24, sepa_debit, sofort, three_d_secure, wechat]."
    VALID_VALUES_FOR__TYPE = String.static_array("custom", "express", "none", "standard", "ach_credit_transfer", "ach_debit", "acss_debit", "alipay", "au_becs_debit", "bancontact", "card", "card_present", "eps", "giropay", "ideal", "klarna", "multibanco", "p24", "sepa_debit", "sofort", "three_d_secure", "wechat")
    ...
    @[JSON::Field(key: "groups", type: Stripe::AccountGroupMembership?, default: nil, required: false, nullable: false, emit_null: false)]
    property groups : Stripe::AccountGroupMembership? = nil
    ...
    property card_present : Stripe::SourceTypeCardPresent? = nil
    ...
    @[JSON::Field(key: "owner", type: Stripe::SourceOwner?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def initialize(
      *,
      ...
      @groups : Stripe::AccountGroupMembership? = nil,
    ...
    def_equals_and_hash(@country, @created, @id, @object, @_type, @currency, @last4, @status, @brand, @exp_month, @exp_year, @funding, @client_secret, @flow, @livemode, @business_profile, @business_type, @business_type_present, @capabilities, @charges_enabled, @company, @controller, @default_currency, @details_submitted, @email, @email_present, @external_accounts, @future_requirements, @groups, @individual, @metadata, @metadata_present, @payouts_enabled, @requirements, @settings, @tos_acceptance, @account, @account_present, @account_holder_name, @account_holder_name_present, @account_holder_type, @account_holder_type_present, @account_type, @account_type_present, @available_payout_methods, @available_payout_methods_present, @bank_name, @bank_name_present, @customer, @default_for_currency, @default_for_currency_present, @fingerprint, @fingerprint_present, @routing_number, @routing_number_present, @address_city, @address_city_present, @address_country, @address_country_present, @address_line1, @address_line1_present, @address_line1_check, @address_line1_check_present, @address_line2, @address_line2_present, @address_state, @address_state_present, @address_zip, @address_zip_present, @address_zip_check, @address_zip_check_present, @allow_redisplay, @allow_redisplay_present, @cvc_check, @cvc_check_present, @dynamic_last4, @dynamic_last4_present, @iin, @name, @name_present, @networks, @regulated_status, @regulated_status_present, @tokenization_method, @tokenization_method_present, @ach_credit_transfer, @ach_debit, @acss_debit, @alipay, @amount, @amount_present, @au_becs_debit, @bancontact, @card, @card_present, @code_verification, @eps, @giropay, @ideal, @klarna, @multibanco, @owner, @p24, @receiver, @redirect, @sepa_debit, @sofort, @source_order, @statement_descriptor, @statement_descriptor_present, @three_d_secure, @usage, @usage_present, @wechat)
  end
end
