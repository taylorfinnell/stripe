...
module Stripe
  ...
  class DeletedDiscount
    ...
    def_equals_and_hash(@coupon, @deleted, @id, @object, @start, @checkout_session, @checkout_session_present, @customer, @customer_present, @invoice, @invoice_present, @invoice_item, @invoice_item_present, @promotion_code, @promotion_code_present, @subscription, @subscription_present, @subscription_item, @subscription_item_present)
  end
end
