...
module Stripe
  ...
  class TaxCalculationLineItem
    ...
    def_equals_and_hash(@amount, @amount_tax, @id, @livemode, @object, @quantity, @reference, @tax_behavior, @tax_code, @metadata, @metadata_present, @product, @product_present, @tax_breakdown, @tax_breakdown_present)
  end
end
