...
module Stripe
  class InvoiceSettings
    ...
    @[JSON::Field(key: "account_tax_ids", type: Stripe::AddInvoiceItemEntryTaxRates?, default: nil, required: false, nullable: false, emit_null: false)]
    getter account_tax_ids : Stripe::AddInvoiceItemEntryTaxRates? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @account_tax_ids : Stripe::AddInvoiceItemEntryTaxRates? = nil,
    ...
    def account_tax_ids=(new_value : Stripe::AddInvoiceItemEntryTaxRates?)
