...
require "./billing_credit_grants_resource_scope" 
...
module Stripe
  ...
  class BillingCreditGrantsResourceApplicabilityConfig
    ...
    @[JSON::Field(key: "scope", type: Stripe::BillingCreditGrantsResourceScope?, default: nil, required: true, nullable: false, emit_null: false)]
    getter scope : Stripe::BillingCreditGrantsResourceScope? = nil
    ...
    def initialize(
      *,
      # Required properties
      @scope : Stripe::BillingCreditGrantsResourceScope? = nil
    )
    end
    ...
    def scope=(new_value : Stripe::BillingCreditGrantsResourceScope?)
