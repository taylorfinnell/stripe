...
module Stripe
  ...
  class TreasuryReceivedDebitsResourceLinkedFlows
    ...
    @[JSON::Field(key: "payout", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: payout.nil? && !payout_present?)]
    ...
    def_equals_and_hash(@debit_reversal, @debit_reversal_present, @inbound_transfer, @inbound_transfer_present, @issuing_authorization, @issuing_authorization_present, @issuing_transaction, @issuing_transaction_present, @payout, @payout_present)
  end
end
