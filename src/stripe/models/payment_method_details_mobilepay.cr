...
module Stripe
  ...
  class PaymentMethodDetailsMobilepay
    ...
    @[JSON::Field(key: "card", type: Stripe::InternalCard?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: card.nil? && !card_present?)]
