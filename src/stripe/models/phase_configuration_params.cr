...
module Stripe
  class PhaseConfigurationParams
    ...
    @[JSON::Field(key: "default_tax_rates", type: Stripe::AddInvoiceItemEntryTaxRates?, default: nil, required: false, nullable: false, emit_null: false)]
    getter default_tax_rates : Stripe::AddInvoiceItemEntryTaxRates? = nil
    ...
    @[JSON::Field(key: "iterations", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter iterations : Int32? = nil
    ...
    def initialize(
      *,
      ...
      @default_tax_rates : Stripe::AddInvoiceItemEntryTaxRates? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_iterations = @iterations).nil?
      end
    ...
    def default_tax_rates=(new_value : Stripe::AddInvoiceItemEntryTaxRates?)
    ...
    def iterations=(new_value : Int32?)
    ...
    def_equals_and_hash(@items, @add_invoice_items, @application_fee_percent, @automatic_tax, @billing_cycle_anchor, @billing_thresholds, @collection_method, @currency, @default_payment_method, @default_tax_rates, @description, @discounts, @end_date, @invoice_settings, @iterations, @metadata, @on_behalf_of, @proration_behavior, @start_date, @transfer_data, @trial, @trial_end)
  end
end
