...
module Stripe
  ...
  class PortalFlowsRetention
    ...
    @[JSON::Field(key: "coupon_offer", type: Stripe::PortalFlowsCouponOffer?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: coupon_offer.nil? && !coupon_offer_present?)]
    getter coupon_offer : Stripe::PortalFlowsCouponOffer? = nil

    @[JSON::Field(ignore: true)]
    property? coupon_offer_present : Bool = false
    ...
    def_equals_and_hash(@_type, @coupon_offer, @coupon_offer_present)
  end
end
