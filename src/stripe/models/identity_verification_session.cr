...
module Stripe
  ...
  class IdentityVerificationSession
    ...
    @[JSON::Field(key: "last_error", type: Stripe::GelatoSessionLastError?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: last_error.nil? && !last_error_present?)]
    ...
    @[JSON::Field(key: "options", type: Stripe::GelatoVerificationSessionOptions?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: options.nil? && !options_present?)]
    ...
    @[JSON::Field(key: "redaction", type: Stripe::VerificationSessionRedaction?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: redaction.nil? && !redaction_present?)]
    ...
    # Customer ID
    @[JSON::Field(key: "related_customer", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: related_customer.nil? && !related_customer_present?)]
    getter related_customer : String? = nil
    MAX_LENGTH_FOR_RELATED_CUSTOMER = 5000

    @[JSON::Field(ignore: true)]
    property? related_customer_present : Bool = false


    @[JSON::Field(key: "related_person", type: Stripe::GelatoRelatedPerson?, default: nil, required: false, nullable: false, emit_null: false)]
    getter related_person : Stripe::GelatoRelatedPerson? = nil
    ...
    def initialize(
      *,
      ...
      @related_person : Stripe::GelatoRelatedPerson? = nil,
      @url : String? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_related_person = @related_person).nil?
        invalid_properties.concat(_related_person.list_invalid_properties_for("related_person")) if _related_person.is_a?(OpenApi::Validatable)
      end
      unless (_url = @url).nil?
    ...
    def valid? : Bool
      ...
      unless (_related_person = @related_person).nil?
        return false if _related_person.is_a?(OpenApi::Validatable) && !_related_person.valid?
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] related_person Object to be assigned
    def related_person=(new_value : Stripe::GelatoRelatedPerson?)

      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end

      @related_person = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    def_equals_and_hash(@created, @id, @livemode, @metadata, @object, @status, @_type, @client_reference_id, @client_reference_id_present, @client_secret, @client_secret_present, @last_error, @last_error_present, @last_verification_report, @last_verification_report_present, @options, @options_present, @provided_details, @provided_details_present, @redaction, @redaction_present, @related_customer, @related_customer_present, @related_person, @url, @url_present, @verification_flow, @verified_outputs, @verified_outputs_present)
  end
end
