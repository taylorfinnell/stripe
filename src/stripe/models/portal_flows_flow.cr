...
module Stripe
  ...
  class PortalFlowsFlow
    ...
    @[JSON::Field(key: "subscription_cancel", type: Stripe::PortalFlowsFlowSubscriptionCancel?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: subscription_cancel.nil? && !subscription_cancel_present?)]
    ...
    @[JSON::Field(key: "subscription_update", type: Stripe::PortalFlowsFlowSubscriptionUpdate?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: subscription_update.nil? && !subscription_update_present?)]
    ...
    @[JSON::Field(key: "subscription_update_confirm", type: Stripe::PortalFlowsFlowSubscriptionUpdateConfirm?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: subscription_update_confirm.nil? && !subscription_update_confirm_present?)]
    getter subscription_update_confirm : Stripe::PortalFlowsFlowSubscriptionUpdateConfirm? = nil

    @[JSON::Field(ignore: true)]
    property? subscription_update_confirm_present : Bool = false
    ...
    def_equals_and_hash(@after_completion, @_type, @subscription_cancel, @subscription_cancel_present, @subscription_update, @subscription_update_present, @subscription_update_confirm, @subscription_update_confirm_present)
  end
end
