...
module Stripe
  ...
  class CustomerTax
    ...
    @[JSON::Field(key: "location", type: Stripe::CustomerTaxLocation?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: location.nil? && !location_present?)]
