...
module Stripe
  ...
  class Charge
    ...
    getter amount_captured : Int32? = nil
    ...
    getter amount_refunded : Int32? = nil
    ...
    @[JSON::Field(key: "fraud_details", type: Stripe::ChargeFraudDetails?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: fraud_details.nil? && !fraud_details_present?)]
    ...
    @[JSON::Field(key: "outcome", type: Stripe::ChargeOutcome?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: outcome.nil? && !outcome_present?)]
    ...
    @[JSON::Field(key: "payment_method_details", type: Stripe::PaymentMethodDetails?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: payment_method_details.nil? && !payment_method_details_present?)]
    ...
    @[JSON::Field(key: "transfer_data", type: Stripe::ChargeTransferData?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: transfer_data.nil? && !transfer_data_present?)]
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_amount_captured = @amount_captured).nil?
      end
    ...
    def amount_captured=(new_value : Int32?)
    ...
    def amount_refunded=(new_value : Int32?)
