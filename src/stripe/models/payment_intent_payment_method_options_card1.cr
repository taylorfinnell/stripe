...
module Stripe
  class PaymentIntentPaymentMethodOptionsCard1
    ...
    property mandate_options : Stripe::PaymentMethodOptionsCardMandateOptions? = nil
    ...
    property request_extended_authorization : String? = nil
    ...
    property request_incremental_authorization : String? = nil
    ...
    property request_multicapture : String? = nil
    ...
    property request_overcapture : String? = nil
    ...
    def_equals_and_hash(@capture_method, @installments, @mandate_options, @network, @network_present, @request_extended_authorization, @request_incremental_authorization, @request_multicapture, @request_overcapture, @request_three_d_secure, @request_three_d_secure_present, @require_cvc_recollection, @setup_future_usage, @statement_descriptor_suffix_kana, @statement_descriptor_suffix_kanji, @request_incremental_authorization_support, @routing, @verification_method)
  end
end
