...
module Stripe
  ...
  class Product
    ...
    @[JSON::Field(key: "package_dimensions", type: Stripe::PackageDimensions?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: package_dimensions.nil? && !package_dimensions_present?)]
    ...
    def_equals_and_hash(@active, @created, @id, @images, @livemode, @marketing_features, @metadata, @name, @object, @updated, @default_price, @default_price_present, @description, @description_present, @package_dimensions, @package_dimensions_present, @shippable, @shippable_present, @statement_descriptor, @statement_descriptor_present, @tax_code, @tax_code_present, @unit_label, @unit_label_present, @url, @url_present)
  end
end
