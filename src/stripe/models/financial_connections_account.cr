...
module Stripe
  ...
  class FinancialConnectionsAccount
    ...
    @[JSON::Field(key: "account_holder", type: Stripe::BankConnectionsResourceAccountholder?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: account_holder.nil? && !account_holder_present?)]
    ...
    @[JSON::Field(key: "balance", type: Stripe::BankConnectionsResourceBalance?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: balance.nil? && !balance_present?)]
    ...
    @[JSON::Field(key: "balance_refresh", type: Stripe::BankConnectionsResourceBalanceRefresh?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: balance_refresh.nil? && !balance_refresh_present?)]
    ...
    @[JSON::Field(key: "ownership", type: Stripe::FinancialConnectionsAccountOwnership?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: ownership.nil? && !ownership_present?)]
    ...
    @[JSON::Field(key: "ownership_refresh", type: Stripe::BankConnectionsResourceOwnershipRefresh?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: ownership_refresh.nil? && !ownership_refresh_present?)]
    ...
    @[JSON::Field(key: "subscriptions", type: Array(String)?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: subscriptions.nil? && !subscriptions_present?)]
    ...
    @[JSON::Field(key: "transaction_refresh", type: Stripe::BankConnectionsResourceTransactionRefresh?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: transaction_refresh.nil? && !transaction_refresh_present?)]
    getter transaction_refresh : Stripe::BankConnectionsResourceTransactionRefresh? = nil

    @[JSON::Field(ignore: true)]
    property? transaction_refresh_present : Bool = false
