...
module Stripe
  ...
  class PaymentMethodCardPresent
    ...
    @[JSON::Field(key: "networks", type: Stripe::PaymentMethodCardPresentNetworks?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: networks.nil? && !networks_present?)]
    ...
    def_equals_and_hash(@exp_month, @exp_year, @brand, @brand_present, @brand_product, @brand_product_present, @cardholder_name, @cardholder_name_present, @country, @country_present, @description, @description_present, @fingerprint, @fingerprint_present, @funding, @funding_present, @issuer, @issuer_present, @last4, @last4_present, @networks, @networks_present, @offline, @offline_present, @preferred_locales, @preferred_locales_present, @read_method, @read_method_present, @wallet)
  end
end
