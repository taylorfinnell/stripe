...
module Stripe
  ...
  class IssuingCardPersonalizationDesign
    ...
    @[JSON::Field(key: "carrier_text", type: Stripe::IssuingPersonalizationDesignCarrierText?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def_equals_and_hash(@created, @id, @livemode, @metadata, @object, @physical_bundle, @preferences, @rejection_reasons, @status, @card_logo, @card_logo_present, @carrier_text, @lookup_key, @lookup_key_present, @name, @name_present)
  end
end
