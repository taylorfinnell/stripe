...
require "./quotes_resource_transfer_data_destination" 
...
module Stripe
  ...
  class QuotesResourceTransferData
    ...
    @[JSON::Field(key: "destination", type: Stripe::QuotesResourceTransferDataDestination?, default: nil, required: true, nullable: false, emit_null: false)]
    getter destination : Stripe::QuotesResourceTransferDataDestination? = nil
    ...
    def initialize(
      *,
      # Required properties
      @destination : Stripe::QuotesResourceTransferDataDestination? = nil,
      # Optional properties
      @amount : Int32? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_amount_percent = @amount_percent).nil?
      end
      invalid_properties
    end
    ...
    def destination=(new_value : Stripe::QuotesResourceTransferDataDestination?)
