...
module Stripe
  ...
  class SourceReceiverFlow
    ...
    @[JSON::Field(key: "amount_charged", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter amount_charged : Int32? = nil



    # The total amount received by the receiver source. `amount_received = amount_returned + amount_charged` should be true for consumed sources unless customers deposit excess funds. The amount received is expressed in the source's currency.
    @[JSON::Field(key: "amount_received", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter amount_received : Int32? = nil



    # The total amount that was returned to the customer. The amount returned is expressed in the source's currency.
    @[JSON::Field(key: "amount_returned", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter amount_returned : Int32? = nil
    ...
    def initialize(
      *,
      # Required properties
      @amount_charged : Int32? = nil, 
      @amount_received : Int32? = nil, 
      @amount_returned : Int32? = nil, 
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_amount_charged = @amount_charged).nil?
      end
      ...
      unless (_amount_returned = @amount_returned).nil?
      end
    ...
    def amount_charged=(new_value : Int32?)
    ...
    def amount_returned=(new_value : Int32?)
