...
module Stripe
  ...
  class SigmaSigmaApiQuery
    ...
    ERROR_MESSAGE_FOR_OBJECT = "invalid value for \"object\", must be one of [sigma.sigma_api_query]."
    VALID_VALUES_FOR_OBJECT = String.static_array("sigma.sigma_api_query")
    ...
    def_equals_and_hash(@created, @id, @livemode, @name, @object, @sql)
  end
end
