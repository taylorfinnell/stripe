...
module Stripe
  ...
  class FinancialReportingFinanceReportRunRunParameters
    ...
    @[JSON::Field(key: "interval_end", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter interval_end : Int32? = nil
    ...
    @[JSON::Field(key: "interval_start", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter interval_start : Int32? = nil
    ...
    def initialize(
      *,
      ...
      @currency : String? = nil,
      @interval_end : Int32? = nil,
      @interval_start : Int32? = nil,
      @payout : String? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_interval_end = @interval_end).nil?
      end
      unless (_interval_start = @interval_start).nil?
      end
    ...
    def interval_end=(new_value : Int32?)
    ...
    def interval_start=(new_value : Int32?)
