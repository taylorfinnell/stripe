...
module Stripe
  class PostTreasuryOutboundTransfersRequest
    ...
    def_equals_and_hash(@amount, @currency, @financial_account, @description, @destination_payment_method, @destination_payment_method_data, @destination_payment_method_options, @expand, @metadata, @statement_descriptor)
  end
end
