...
module Stripe
  ...
  class InvoicesPaymentSettings
    ...
    @[JSON::Field(key: "payment_method_options", type: Stripe::InvoicesPaymentMethodOptions?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: payment_method_options.nil? && !payment_method_options_present?)]
