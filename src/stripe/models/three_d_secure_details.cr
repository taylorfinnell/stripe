...
module Stripe
  ...
  class ThreeDSecureDetails
    ...
    def_equals_and_hash(@authentication_flow, @authentication_flow_present, @electronic_commerce_indicator, @electronic_commerce_indicator_present, @result, @result_present, @result_reason, @result_reason_present, @transaction_id, @transaction_id_present, @version, @version_present)
  end
end
