...
require "./optional_fields_customer_address" 
...
module Stripe
  class CustomerShipping
    ...
    @[JSON::Field(key: "address", type: Stripe::OptionalFieldsCustomerAddress?, default: nil, required: true, nullable: false, emit_null: false)]
    getter address : Stripe::OptionalFieldsCustomerAddress? = nil
    ...
    def initialize(
      *,
      # Required properties
      @address : Stripe::OptionalFieldsCustomerAddress? = nil, 
      @name : String? = nil,
      # Optional properties
      @phone : String? = nil
    )
    ...
    def address=(new_value : Stripe::OptionalFieldsCustomerAddress?)
