...
module Stripe
  ...
  class IdentityVerificationReport
    ...
    def_equals_and_hash(@created, @id, @livemode, @object, @_type, @client_reference_id, @client_reference_id_present, @document, @email, @id_number, @options, @phone, @selfie, @verification_flow, @verification_session, @verification_session_present)
  end
end
