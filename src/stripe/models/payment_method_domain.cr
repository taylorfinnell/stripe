...
module Stripe
  ...
  class PaymentMethodDomain
    ...
    @[JSON::Field(key: "amazon_pay", type: Stripe::PaymentMethodDomainResourcePaymentMethodStatus?, default: nil, required: true, nullable: false, emit_null: false)]
    getter amazon_pay : Stripe::PaymentMethodDomainResourcePaymentMethodStatus? = nil
    ...
    @[JSON::Field(key: "klarna", type: Stripe::PaymentMethodDomainResourcePaymentMethodStatus?, default: nil, required: true, nullable: false, emit_null: false)]
    getter klarna : Stripe::PaymentMethodDomainResourcePaymentMethodStatus? = nil
    ...
    def initialize(
      *,
      # Required properties
      @amazon_pay : Stripe::PaymentMethodDomainResourcePaymentMethodStatus? = nil, 
      ...
      @id : String? = nil, 
      @klarna : Stripe::PaymentMethodDomainResourcePaymentMethodStatus? = nil, 
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"amazon_pay\" is required and cannot be null") if @amazon_pay.nil?
      ...
      invalid_properties.push("\"klarna\" is required and cannot be null") if @klarna.nil?
    ...
    def valid? : Bool
      ...
      return false if @amazon_pay.nil?
      unless (_amazon_pay = @amazon_pay).nil?
    ...
    def amazon_pay=(new_value : Stripe::PaymentMethodDomainResourcePaymentMethodStatus?)

      raise ArgumentError.new("\"amazon_pay\" is required and cannot be null") if new_value.nil?
    ...
    def klarna=(new_value : Stripe::PaymentMethodDomainResourcePaymentMethodStatus?)

      raise ArgumentError.new("\"klarna\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def_equals_and_hash(@amazon_pay, @apple_pay, @created, @domain_name, @enabled, @google_pay, @id, @klarna, @link, @livemode, @object, @paypal)
  end
end
