...
require "./gelato_session_matching_options" 
...
module Stripe
  ...
  class GelatoVerificationSessionOptions
    ...
    @[JSON::Field(key: "matching", type: Stripe::GelatoSessionMatchingOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter matching : Stripe::GelatoSessionMatchingOptions? = nil
    ...
    def initialize(
      *,
      ...
      @matching : Stripe::GelatoSessionMatchingOptions? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_matching = @matching).nil?
        invalid_properties.concat(_matching.list_invalid_properties_for("matching")) if _matching.is_a?(OpenApi::Validatable)
      end
    ...
    def valid? : Bool
      ...
      unless (_matching = @matching).nil?
        return false if _matching.is_a?(OpenApi::Validatable) && !_matching.valid?
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] matching Object to be assigned
    def matching=(new_value : Stripe::GelatoSessionMatchingOptions?)
    ...
    def_equals_and_hash(@document, @email, @id_number, @matching, @phone)
  end
end
