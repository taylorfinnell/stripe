...
require "./terminal_configuration_configuration_resource_wifi_config" 
...
module Stripe
  ...
  class TerminalConfiguration
    ...
    @[JSON::Field(key: "wifi", type: Stripe::TerminalConfigurationConfigurationResourceWifiConfig?, default: nil, required: false, nullable: false, emit_null: false)]
    getter wifi : Stripe::TerminalConfigurationConfigurationResourceWifiConfig? = nil
    ...
    def initialize(
      *,
      ...
      @wifi : Stripe::TerminalConfigurationConfigurationResourceWifiConfig? = nil
    )
    end
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_wifi = @wifi).nil?
        invalid_properties.concat(_wifi.list_invalid_properties_for("wifi")) if _wifi.is_a?(OpenApi::Validatable)
      end
      invalid_properties
    end
    ...
    def valid? : Bool
      ...
      unless (_wifi = @wifi).nil?
        return false if _wifi.is_a?(OpenApi::Validatable) && !_wifi.valid?
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] wifi Object to be assigned
    def wifi=(new_value : Stripe::TerminalConfigurationConfigurationResourceWifiConfig?)
    ...
    def_equals_and_hash(@id, @livemode, @object, @bbpos_wisepos_e, @is_account_default, @is_account_default_present, @name, @name_present, @offline, @reboot_window, @stripe_s700, @tipping, @verifone_p400, @wifi)
  end
end
