...
module Stripe
  ...
  class FinancialConnectionsAccountOwner
    ...
    @[JSON::Field(key: "refreshed_at", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: refreshed_at.nil? && !refreshed_at_present?)]
    getter refreshed_at : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_refreshed_at = @refreshed_at).nil?
      end
      invalid_properties
    end
    ...
    def refreshed_at=(new_value : Int32?)
