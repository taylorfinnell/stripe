...
module Stripe
  ...
  class IssuingCardholderVerification
    ...
    @[JSON::Field(key: "document", type: Stripe::IssuingCardholderIdDocument?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: document.nil? && !document_present?)]
