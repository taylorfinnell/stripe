...
module Stripe
  ...
  class SubscriptionsResourcePendingUpdate
    ...
    @[JSON::Field(key: "billing_cycle_anchor", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: billing_cycle_anchor.nil? && !billing_cycle_anchor_present?)]
