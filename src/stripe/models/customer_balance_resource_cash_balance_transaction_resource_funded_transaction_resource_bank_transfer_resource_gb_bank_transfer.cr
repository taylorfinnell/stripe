...
module Stripe
  ...
  class CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferResourceGbBankTransfer
    ...
    @[JSON::Field(key: "account_number_last4", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: account_number_last4.nil? && !account_number_last4_present?)]
    getter account_number_last4 : String? = nil
    MAX_LENGTH_FOR_ACCOUNT_NUMBER_LAST4 = 5000

    @[JSON::Field(ignore: true)]
    property? account_number_last4_present : Bool = false
    ...
    def_equals_and_hash(@account_number_last4, @account_number_last4_present, @sender_name, @sender_name_present, @sort_code, @sort_code_present)
  end
end
