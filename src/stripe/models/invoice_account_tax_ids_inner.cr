...
module Stripe
  class InvoiceAccountTaxIdsInner
    ...
    @[JSON::Field(key: "owner", type: Stripe::TaxIDsOwner?, default: nil, required: false, nullable: false, emit_null: false)]
    property owner : Stripe::TaxIDsOwner? = nil



    @[JSON::Field(key: "verification", type: Stripe::TaxIdVerification?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def_equals_and_hash(@deleted, @id, @object, @created, @livemode, @_type, @value, @country, @country_present, @customer, @customer_present, @owner, @verification)
  end
end
