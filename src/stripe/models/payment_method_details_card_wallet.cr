...
module Stripe
  ...
  class PaymentMethodDetailsCardWallet
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_amex_express_checkout = @amex_express_checkout).nil?
      end
    ...
    def_equals_and_hash(@_type, @amex_express_checkout, @apple_pay, @dynamic_last4, @dynamic_last4_present, @google_pay, @link, @masterpass, @samsung_pay, @visa_checkout)
  end
end
