...
module Stripe
  ...
  class PaymentIntentProcessingCustomerNotification
    ...
    @[JSON::Field(key: "completes_at", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: completes_at.nil? && !completes_at_present?)]
    getter completes_at : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_approval_requested = @approval_requested).nil?
      end
      unless (_completes_at = @completes_at).nil?
      end
      invalid_properties
    end
    ...
    def completes_at=(new_value : Int32?)
