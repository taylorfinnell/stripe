...
module Stripe
  ...
  class Price
    ...
    @[JSON::Field(key: "custom_unit_amount", type: Stripe::CustomUnitAmount?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: custom_unit_amount.nil? && !custom_unit_amount_present?)]
    ...
    @[JSON::Field(key: "recurring", type: Stripe::Recurring?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: recurring.nil? && !recurring_present?)]
    ...
    @[JSON::Field(key: "transform_quantity", type: Stripe::TransformQuantity?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: transform_quantity.nil? && !transform_quantity_present?)]
