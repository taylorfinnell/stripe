...
module Stripe
  class PaymentIntentPaymentMethodOptionsKonbini
    ...
    property confirmation_number : String? = nil
    ...
    @[JSON::Field(key: "expires_after_days", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: expires_after_days.nil? && !expires_after_days_present?)]
    property expires_after_days : Int32? = nil
    ...
    def_equals_and_hash(@capture_method, @installments, @request_incremental_authorization_support, @require_cvc_recollection, @routing, @setup_future_usage, @verification_method, @confirmation_number, @confirmation_number_present, @expires_after_days, @expires_after_days_present, @expires_at, @expires_at_present, @product_description, @product_description_present)
  end
end
