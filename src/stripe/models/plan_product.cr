...
module Stripe
  ...
  class PlanProduct
    ...
    @[JSON::Field(key: "package_dimensions", type: Stripe::PackageDimensions?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def_equals_and_hash(@deleted, @id, @object, @active, @created, @images, @livemode, @marketing_features, @metadata, @name, @updated, @default_price, @default_price_present, @description, @description_present, @package_dimensions, @shippable, @shippable_present, @statement_descriptor, @statement_descriptor_present, @tax_code, @tax_code_present, @unit_label, @unit_label_present, @url, @url_present)
  end
end
