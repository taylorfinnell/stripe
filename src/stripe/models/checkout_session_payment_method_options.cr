...
require "./checkout_kakao_pay_payment_method_options" 
require "./checkout_klarna_payment_method_options" 
require "./checkout_konbini_payment_method_options" 
require "./checkout_kr_card_payment_method_options" 
...
require "./checkout_naver_pay_payment_method_options" 
require "./checkout_oxxo_payment_method_options" 
require "./checkout_p24_payment_method_options" 
require "./checkout_payco_payment_method_options" 
...
require "./checkout_samsung_pay_payment_method_options" 
...
module Stripe
  ...
  class CheckoutSessionPaymentMethodOptions
    ...
    @[JSON::Field(key: "kakao_pay", type: Stripe::CheckoutKakaoPayPaymentMethodOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter kakao_pay : Stripe::CheckoutKakaoPayPaymentMethodOptions? = nil
    ...
    @[JSON::Field(key: "kr_card", type: Stripe::CheckoutKrCardPaymentMethodOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter kr_card : Stripe::CheckoutKrCardPaymentMethodOptions? = nil
    ...
    @[JSON::Field(key: "naver_pay", type: Stripe::CheckoutNaverPayPaymentMethodOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter naver_pay : Stripe::CheckoutNaverPayPaymentMethodOptions? = nil
    ...
    @[JSON::Field(key: "payco", type: Stripe::CheckoutPaycoPaymentMethodOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter payco : Stripe::CheckoutPaycoPaymentMethodOptions? = nil
    ...
    @[JSON::Field(key: "samsung_pay", type: Stripe::CheckoutSamsungPayPaymentMethodOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter samsung_pay : Stripe::CheckoutSamsungPayPaymentMethodOptions? = nil
    ...
    def initialize(
      *,
      ...
      @kakao_pay : Stripe::CheckoutKakaoPayPaymentMethodOptions? = nil,
      @klarna : Stripe::CheckoutKlarnaPaymentMethodOptions? = nil,
      @konbini : Stripe::CheckoutKonbiniPaymentMethodOptions? = nil,
      @kr_card : Stripe::CheckoutKrCardPaymentMethodOptions? = nil,
      ...
      @naver_pay : Stripe::CheckoutNaverPayPaymentMethodOptions? = nil,
      @oxxo : Stripe::CheckoutOxxoPaymentMethodOptions? = nil,
      @p24 : Stripe::CheckoutP24PaymentMethodOptions? = nil,
      @payco : Stripe::CheckoutPaycoPaymentMethodOptions? = nil,
      ...
      @samsung_pay : Stripe::CheckoutSamsungPayPaymentMethodOptions? = nil,
    ...
    def kakao_pay=(new_value : Stripe::CheckoutKakaoPayPaymentMethodOptions?)
    ...
    def kr_card=(new_value : Stripe::CheckoutKrCardPaymentMethodOptions?)
    ...
    def naver_pay=(new_value : Stripe::CheckoutNaverPayPaymentMethodOptions?)
    ...
    def payco=(new_value : Stripe::CheckoutPaycoPaymentMethodOptions?)
    ...
    def samsung_pay=(new_value : Stripe::CheckoutSamsungPayPaymentMethodOptions?)
