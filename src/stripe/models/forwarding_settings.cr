...
module Stripe
  class ForwardingSettings
    ...
    ERROR_MESSAGE_FOR__TYPE = "invalid value for \"_type\", must be one of [financial_account, payment_method]."
    VALID_VALUES_FOR__TYPE = String.static_array("financial_account", "payment_method")
    ...
    def_equals_and_hash(@_type, @financial_account, @payment_method)
  end
end
