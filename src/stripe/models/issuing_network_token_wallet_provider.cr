...
module Stripe
  ...
  class IssuingNetworkTokenWalletProvider
    ...
    @[JSON::Field(key: "account_trust_score", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter account_trust_score : Int32? = nil
    ...
    @[JSON::Field(key: "device_trust_score", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter device_trust_score : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_account_trust_score = @account_trust_score).nil?
      end
      ...
      unless (_device_trust_score = @device_trust_score).nil?
      end
    ...
    def account_trust_score=(new_value : Int32?)
    ...
    def device_trust_score=(new_value : Int32?)
