...
module Stripe
  class PaymentIntentPaymentMethodOptionsSwish1
    ...
    def_equals_and_hash(@reference, @reference_present, @setup_future_usage, @capture_method, @installments, @request_incremental_authorization_support, @require_cvc_recollection, @routing, @verification_method)
  end
end
