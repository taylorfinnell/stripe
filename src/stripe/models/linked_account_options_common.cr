...
require "./payment_flows_private_payment_methods_financial_connections_common_linked_account_options_filters" 
...
module Stripe
  ...
  class LinkedAccountOptionsCommon
    ...
    @[JSON::Field(key: "filters", type: Stripe::PaymentFlowsPrivatePaymentMethodsFinancialConnectionsCommonLinkedAccountOptionsFilters?, default: nil, required: false, nullable: false, emit_null: false)]
    getter filters : Stripe::PaymentFlowsPrivatePaymentMethodsFinancialConnectionsCommonLinkedAccountOptionsFilters? = nil
    ...
    @[JSON::Field(key: "prefetch", type: Array(String)?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: prefetch.nil? && !prefetch_present?)]
    ...
    property? prefetch_present : Bool = false
    ...
    def initialize(
      *,
      # Optional properties
      @filters : Stripe::PaymentFlowsPrivatePaymentMethodsFinancialConnectionsCommonLinkedAccountOptionsFilters? = nil,
    ...
    def filters=(new_value : Stripe::PaymentFlowsPrivatePaymentMethodsFinancialConnectionsCommonLinkedAccountOptionsFilters?)
    ...
    def_equals_and_hash(@filters, @permissions, @prefetch, @prefetch_present, @return_url)
  end
end
