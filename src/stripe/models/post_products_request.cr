...
require "./price_data_without_product_with_metadata" 
...
module Stripe
  class PostProductsRequest
    ...
    @[JSON::Field(key: "default_price_data", type: Stripe::PriceDataWithoutProductWithMetadata?, default: nil, required: false, nullable: false, emit_null: false)]
    getter default_price_data : Stripe::PriceDataWithoutProductWithMetadata? = nil
    ...
    def default_price_data=(new_value : Stripe::PriceDataWithoutProductWithMetadata?)
    ...
    def_equals_and_hash(@name, @active, @default_price_data, @description, @expand, @id, @images, @marketing_features, @metadata, @package_dimensions, @shippable, @statement_descriptor, @tax_code, @unit_label, @url)
  end
end
