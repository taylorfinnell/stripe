...
module Stripe
  class SourceTypeMultibanco
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_refund_account_holder_address_city = @refund_account_holder_address_city).nil?
      end
      unless (_refund_account_holder_address_country = @refund_account_holder_address_country).nil?
      end
      unless (_refund_account_holder_address_line1 = @refund_account_holder_address_line1).nil?
      end
      unless (_refund_account_holder_address_line2 = @refund_account_holder_address_line2).nil?
      end
      unless (_refund_account_holder_address_postal_code = @refund_account_holder_address_postal_code).nil?
      end
      unless (_refund_account_holder_address_state = @refund_account_holder_address_state).nil?
      end
      unless (_refund_account_holder_name = @refund_account_holder_name).nil?
      end
      unless (_refund_iban = @refund_iban).nil?
      end
      invalid_properties
    end
