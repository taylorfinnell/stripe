...
module Stripe
  ...
  class IssuingPersonalizationDesignCarrierText
    ...
    @[JSON::Field(key: "footer_body", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: footer_body.nil? && !footer_body_present?)]
    getter footer_body : String? = nil
    MAX_LENGTH_FOR_FOOTER_BODY = 5000

    @[JSON::Field(ignore: true)]
    property? footer_body_present : Bool = false


    # The footer title text of the carrier letter.
    @[JSON::Field(key: "footer_title", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: footer_title.nil? && !footer_title_present?)]
    getter footer_title : String? = nil
    MAX_LENGTH_FOR_FOOTER_TITLE = 5000

    @[JSON::Field(ignore: true)]
    property? footer_title_present : Bool = false


    # The header body text of the carrier letter.
    @[JSON::Field(key: "header_body", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: header_body.nil? && !header_body_present?)]
    getter header_body : String? = nil
    MAX_LENGTH_FOR_HEADER_BODY = 5000

    @[JSON::Field(ignore: true)]
    property? header_body_present : Bool = false


    # The header title text of the carrier letter.
    @[JSON::Field(key: "header_title", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: header_title.nil? && !header_title_present?)]
    getter header_title : String? = nil
    MAX_LENGTH_FOR_HEADER_TITLE = 5000

    @[JSON::Field(ignore: true)]
    property? header_title_present : Bool = false
    ...
    def_equals_and_hash(@footer_body, @footer_body_present, @footer_title, @footer_title_present, @header_body, @header_body_present, @header_title, @header_title_present)
  end
end
