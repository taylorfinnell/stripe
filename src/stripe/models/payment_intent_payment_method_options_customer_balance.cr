...
module Stripe
  class PaymentIntentPaymentMethodOptionsCustomerBalance
    ...
    property bank_transfer : Stripe::PaymentMethodOptionsCustomerBalanceBankTransfer? = nil
    ...
    def_equals_and_hash(@capture_method, @installments, @request_incremental_authorization_support, @require_cvc_recollection, @routing, @setup_future_usage, @verification_method, @bank_transfer, @funding_type, @funding_type_present)
  end
end
