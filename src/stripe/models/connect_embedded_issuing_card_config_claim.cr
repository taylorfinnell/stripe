...
require "./connect_embedded_issuing_card_features" 
...
module Stripe
  ...
  class ConnectEmbeddedIssuingCardConfigClaim
    ...
    @[JSON::Field(key: "features", type: Stripe::ConnectEmbeddedIssuingCardFeatures?, default: nil, required: true, nullable: false, emit_null: false)]
    getter features : Stripe::ConnectEmbeddedIssuingCardFeatures? = nil
    ...
    def initialize(
      *,
      # Required properties
      @enabled : Bool? = nil, 
      @features : Stripe::ConnectEmbeddedIssuingCardFeatures? = nil
    )
    end
    ...
    def features=(new_value : Stripe::ConnectEmbeddedIssuingCardFeatures?)
