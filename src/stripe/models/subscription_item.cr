...
module Stripe
  ...
  class SubscriptionItem
    ...
    @[JSON::Field(key: "current_period_end", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter current_period_end : Int32? = nil



    # The start time of this subscription item's current billing period.
    @[JSON::Field(key: "current_period_start", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter current_period_start : Int32? = nil
    ...
    @[JSON::Field(key: "billing_thresholds", type: Stripe::SubscriptionItemBillingThresholds?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: billing_thresholds.nil? && !billing_thresholds_present?)]
    ...
    def initialize(
      *,
      # Required properties
      @created : Int32? = nil, 
      @current_period_end : Int32? = nil, 
      @current_period_start : Int32? = nil, 
    ...
    def current_period_end=(new_value : Int32?)
    ...
    def current_period_start=(new_value : Int32?)
    ...
    def_equals_and_hash(@created, @current_period_end, @current_period_start, @discounts, @id, @metadata, @object, @price, @subscription, @billing_thresholds, @billing_thresholds_present, @quantity, @tax_rates, @tax_rates_present)
  end
end
