...
require "./payment_method_details_passthrough_card" 
...
module Stripe
  ...
  class AmazonPayUnderlyingPaymentMethodFundingDetails
    ...
    @[JSON::Field(key: "card", type: Stripe::PaymentMethodDetailsPassthroughCard?, default: nil, required: false, nullable: false, emit_null: false)]
    getter card : Stripe::PaymentMethodDetailsPassthroughCard? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @card : Stripe::PaymentMethodDetailsPassthroughCard? = nil,
      @_type : String? = nil
    )
    end
    ...
    def card=(new_value : Stripe::PaymentMethodDetailsPassthroughCard?)
    ...
    def_equals_and_hash(@card, @_type, @_type_present)
  end
end
