...
module Stripe
  ...
  class TerminalReader
    ...
    @[JSON::Field(key: "action", type: Stripe::TerminalReaderReaderResourceReaderAction?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: action.nil? && !action_present?)]
