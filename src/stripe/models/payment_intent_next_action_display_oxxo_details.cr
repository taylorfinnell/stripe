...
module Stripe
  ...
  class PaymentIntentNextActionDisplayOxxoDetails
    ...
    @[JSON::Field(key: "expires_after", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: expires_after.nil? && !expires_after_present?)]
    getter expires_after : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_expires_after = @expires_after).nil?
      end
    ...
    def expires_after=(new_value : Int32?)
