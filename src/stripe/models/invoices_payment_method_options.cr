...
module Stripe
  ...
  class InvoicesPaymentMethodOptions
    ...
    @[JSON::Field(key: "card", type: Stripe::InvoicePaymentMethodOptionsCard?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: card.nil? && !card_present?)]
