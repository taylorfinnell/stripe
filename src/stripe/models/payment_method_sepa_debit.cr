...
module Stripe
  ...
  class PaymentMethodSepaDebit
    ...
    @[JSON::Field(key: "generated_from", type: Stripe::SepaDebitGeneratedFrom?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: generated_from.nil? && !generated_from_present?)]
