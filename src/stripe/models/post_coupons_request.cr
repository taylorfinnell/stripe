...
module Stripe
  class PostCouponsRequest
    ...
    @[JSON::Field(key: "amount_off", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "duration_in_months", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "max_redemptions", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "redeem_by", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
