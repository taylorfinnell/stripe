...
module Stripe
  ...
  class PaymentMethodOptionsCardMandateOptions
    ...
    @[JSON::Field(key: "end_date", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: end_date.nil? && !end_date_present?)]
    ...
    @[JSON::Field(key: "interval_count", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: interval_count.nil? && !interval_count_present?)]
