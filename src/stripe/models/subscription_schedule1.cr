...
module Stripe
  ...
  class SubscriptionSchedule1
    ...
    property completed_at : Int32? = nil

    @[JSON::Field(ignore: true)]
    property? completed_at_present : Bool = false


    @[JSON::Field(key: "current_phase", type: Stripe::SubscriptionScheduleCurrentPhase?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    property released_at : Int32? = nil
    ...
    def_equals_and_hash(@billing_mode, @created, @customer, @default_settings, @end_behavior, @id, @livemode, @object, @phases, @status, @application, @application_present, @canceled_at, @canceled_at_present, @completed_at, @completed_at_present, @current_phase, @metadata, @metadata_present, @released_at, @released_at_present, @released_subscription, @released_subscription_present, @subscription, @subscription_present, @test_clock, @test_clock_present)
  end
end
