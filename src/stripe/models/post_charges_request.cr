...
require "./post_charges_request_destination" 
...
module Stripe
  class PostChargesRequest
    ...
    @[JSON::Field(key: "application_fee", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter application_fee : Int32? = nil
    ...
    def application_fee=(new_value : Int32?)
