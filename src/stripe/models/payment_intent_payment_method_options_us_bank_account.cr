...
module Stripe
  ...
  class PaymentIntentPaymentMethodOptionsUsBankAccount
    ...
    getter financial_connections : Stripe::LinkedAccountOptionsCommon? = nil
    ...
    def financial_connections=(new_value : Stripe::LinkedAccountOptionsCommon?)
    ...
    def_equals_and_hash(@financial_connections, @mandate_options, @preferred_settlement_speed, @setup_future_usage, @target_date, @verification_method)
  end
end
