...
require "./dispute_payment_method_details_amazon_pay" 
...
module Stripe
  ...
  class DisputePaymentMethodDetails
    ...
    ERROR_MESSAGE_FOR__TYPE = "invalid value for \"_type\", must be one of [amazon_pay, card, klarna, paypal]."
    VALID_VALUES_FOR__TYPE = String.static_array("amazon_pay", "card", "klarna", "paypal")
    ...
    @[JSON::Field(key: "amazon_pay", type: Stripe::DisputePaymentMethodDetailsAmazonPay?, default: nil, required: false, nullable: false, emit_null: false)]
    getter amazon_pay : Stripe::DisputePaymentMethodDetailsAmazonPay? = nil
    ...
    def initialize(
      *,
      ...
      @_type : String? = nil,
      # Optional properties
      @amazon_pay : Stripe::DisputePaymentMethodDetailsAmazonPay? = nil,
    ...
    def amazon_pay=(new_value : Stripe::DisputePaymentMethodDetailsAmazonPay?)
    ...
    def_equals_and_hash(@_type, @amazon_pay, @card, @klarna, @paypal)
  end
end
