...
module Stripe
  ...
  class EmailSent
    ...
    @[JSON::Field(key: "email_sent_at", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter email_sent_at : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_email_sent_at = @email_sent_at).nil?
      end
    ...
    def email_sent_at=(new_value : Int32?)
