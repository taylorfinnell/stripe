...
module Stripe
  ...
  class PaymentMethodConfigResourceDisplayPreference
    ...
    @[JSON::Field(key: "overridable", type: Bool?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: overridable.nil? && !overridable_present?)]
    getter overridable : Bool? = nil

    @[JSON::Field(ignore: true)]
    property? overridable_present : Bool = false
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_overridable = @overridable).nil?
      end
      invalid_properties
    end
    ...
    def_equals_and_hash(@preference, @value, @overridable, @overridable_present)
  end
end
