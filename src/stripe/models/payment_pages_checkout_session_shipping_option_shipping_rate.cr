...
module Stripe
  ...
  class PaymentPagesCheckoutSessionShippingOptionShippingRate
    ...
    @[JSON::Field(key: "delivery_estimate", type: Stripe::ShippingRateDeliveryEstimate?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def_equals_and_hash(@active, @created, @id, @livemode, @metadata, @object, @_type, @delivery_estimate, @display_name, @display_name_present, @fixed_amount, @tax_behavior, @tax_behavior_present, @tax_code, @tax_code_present)
  end
end
