...
module Stripe
  ...
  class PaymentIntentNextActionDisplayBankTransferInstructions
    ...
    @[JSON::Field(key: "amount_remaining", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: amount_remaining.nil? && !amount_remaining_present?)]
