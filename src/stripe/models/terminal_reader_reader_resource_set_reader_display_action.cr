...
module Stripe
  ...
  class TerminalReaderReaderResourceSetReaderDisplayAction
    ...
    @[JSON::Field(key: "cart", type: Stripe::TerminalReaderReaderResourceCart?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: cart.nil? && !cart_present?)]
