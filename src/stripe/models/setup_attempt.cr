...
module Stripe
  ...
  class SetupAttempt
    ...
    @[JSON::Field(key: "setup_error", type: Stripe::ApiErrors?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: setup_error.nil? && !setup_error_present?)]
