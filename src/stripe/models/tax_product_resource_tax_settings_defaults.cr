...
module Stripe
  ...
  class TaxProductResourceTaxSettingsDefaults
    ...
    @[JSON::Field(key: "tax_code", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: tax_code.nil? && !tax_code_present?)]
    ...
    def_equals_and_hash(@tax_behavior, @tax_behavior_present, @tax_code, @tax_code_present)
  end
end
