...
module Stripe
  ...
  class PortalFlowsFlowAfterCompletion
    ...
    @[JSON::Field(key: "hosted_confirmation", type: Stripe::PortalFlowsAfterCompletionHostedConfirmation?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: hosted_confirmation.nil? && !hosted_confirmation_present?)]
    ...
    @[JSON::Field(key: "redirect", type: Stripe::PortalFlowsAfterCompletionRedirect?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: redirect.nil? && !redirect_present?)]
