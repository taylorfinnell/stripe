...
module Stripe
  ...
  class IssuingTransactionNetworkData
    ...
    @[JSON::Field(key: "processing_date", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: processing_date.nil? && !processing_date_present?)]
    getter processing_date : String? = nil
    MAX_LENGTH_FOR_PROCESSING_DATE = 5000

    @[JSON::Field(ignore: true)]
    property? processing_date_present : Bool = false
    ...
    def_equals_and_hash(@authorization_code, @authorization_code_present, @processing_date, @processing_date_present, @transaction_id, @transaction_id_present)
  end
end
