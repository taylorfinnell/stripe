...
module Stripe
  ...
  class InvoiceRenderingPdf
    ...
    @[JSON::Field(key: "page_size", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: page_size.nil? && !page_size_present?)]
    ...
    def_equals_and_hash(@page_size, @page_size_present)
  end
end
