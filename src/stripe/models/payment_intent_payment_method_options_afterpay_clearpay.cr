...
module Stripe
  class PaymentIntentPaymentMethodOptionsAfterpayClearpay
    ...
    def_equals_and_hash(@capture_method, @installments, @request_incremental_authorization_support, @require_cvc_recollection, @routing, @setup_future_usage, @verification_method, @reference, @reference_present)
  end
end
