...
module Stripe
  ...
  class InvoiceSettingCustomerSetting
    ...
    @[JSON::Field(key: "rendering_options", type: Stripe::InvoiceSettingCustomerRenderingOptions?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: rendering_options.nil? && !rendering_options_present?)]
