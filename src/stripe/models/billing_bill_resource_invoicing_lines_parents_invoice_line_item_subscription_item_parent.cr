...
module Stripe
  ...
  class BillingBillResourceInvoicingLinesParentsInvoiceLineItemSubscriptionItemParent
    ...
    def_equals_and_hash(@proration, @subscription_item, @invoice_item, @invoice_item_present, @proration_details, @proration_details_present, @subscription, @subscription_present)
  end
end
