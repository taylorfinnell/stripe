...
module Stripe
  ...
  class ThreeDSecureDetailsCharge
    ...
    @[JSON::Field(key: "electronic_commerce_indicator", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: electronic_commerce_indicator.nil? && !electronic_commerce_indicator_present?)]
    ...
    @[JSON::Field(ignore: true)]
    property? electronic_commerce_indicator_present : Bool = false


    # The exemption requested via 3DS and accepted by the issuer at authentication time.
    @[JSON::Field(key: "exemption_indicator", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: exemption_indicator.nil? && !exemption_indicator_present?)]
    ...
    @[JSON::Field(ignore: true)]
    property? exemption_indicator_present : Bool = false
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_exemption_indicator_applied = @exemption_indicator_applied).nil?
      end
    ...
    def_equals_and_hash(@authentication_flow, @authentication_flow_present, @electronic_commerce_indicator, @electronic_commerce_indicator_present, @exemption_indicator, @exemption_indicator_present, @exemption_indicator_applied, @result, @result_present, @result_reason, @result_reason_present, @transaction_id, @transaction_id_present, @version, @version_present)
  end
end
