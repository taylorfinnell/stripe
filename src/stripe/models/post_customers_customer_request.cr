...
require "./post_charges_request_card" 
require "./post_customers_customer_request_bank_account" 
require "./post_customers_request_address" 
require "./post_customers_request_shipping" 
require "./shared_tax_update_param" 
...
module Stripe
  class PostCustomersCustomerRequest
    ...
    @[JSON::Field(key: "balance", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter balance : Int32? = nil
    ...
    @[JSON::Field(key: "next_invoice_sequence", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter next_invoice_sequence : Int32? = nil
    ...
    @[JSON::Field(key: "tax", type: Stripe::SharedTaxUpdateParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter tax : Stripe::SharedTaxUpdateParam? = nil
    ...
    def next_invoice_sequence=(new_value : Int32?)
    ...
    def tax=(new_value : Stripe::SharedTaxUpdateParam?)
    ...
    def_equals_and_hash(@address, @balance, @bank_account, @card, @cash_balance, @default_alipay_account, @default_bank_account, @default_card, @default_source, @description, @email, @expand, @invoice_prefix, @invoice_settings, @metadata, @name, @next_invoice_sequence, @phone, @preferred_locales, @shipping, @source, @tax, @tax_exempt)
  end
end
