...
require "./payment_links_resource_optional_item_adjustable_quantity" 
...
module Stripe
  ...
  class PaymentLinksResourceOptionalItem
    ...
    @[JSON::Field(key: "adjustable_quantity", type: Stripe::PaymentLinksResourceOptionalItemAdjustableQuantity?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: adjustable_quantity.nil? && !adjustable_quantity_present?)]
    getter adjustable_quantity : Stripe::PaymentLinksResourceOptionalItemAdjustableQuantity? = nil
    ...
    def initialize(
      *,
      ...
      @quantity : Int32? = nil,
      # Optional properties
      @adjustable_quantity : Stripe::PaymentLinksResourceOptionalItemAdjustableQuantity? = nil
    )
    end
    ...
    def adjustable_quantity=(new_value : Stripe::PaymentLinksResourceOptionalItemAdjustableQuantity?)
