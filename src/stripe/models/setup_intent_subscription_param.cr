...
module Stripe
  class SetupIntentSubscriptionParam
    ...
    @[JSON::Field(key: "next_billing", type: Stripe::SubscriptionNextBillingParam?, default: nil, required: true, nullable: false, emit_null: false)]
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"next_billing\" is required and cannot be null") if @next_billing.nil?
    ...
    def valid? : Bool
      ...
      return false if @next_billing.nil?
      unless (_next_billing = @next_billing).nil?
    ...
    def next_billing=(new_value : Stripe::SubscriptionNextBillingParam?)
      ...
      raise ArgumentError.new("\"next_billing\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
    ...
    def_equals_and_hash(@interval, @next_billing, @reference, @interval_count, @name)
  end
end
