...
module Stripe
  ...
  class IssuingPersonalizationDesignRejectionReasons
    ...
    @[JSON::Field(key: "card_logo", type: Array(String)?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: card_logo.nil? && !card_logo_present?)]
    ...
    @[JSON::Field(key: "carrier_text", type: Array(String)?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: carrier_text.nil? && !carrier_text_present?)]
    ...
    def_equals_and_hash(@card_logo, @card_logo_present, @carrier_text, @carrier_text_present)
  end
end
