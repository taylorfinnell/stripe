...
module Stripe
  class CustomTextParam
    ...
    @[JSON::Field(key: "shipping_address", type: Stripe::CustomTextParamAfterSubmit?, default: nil, required: false, nullable: false, emit_null: false)]
    getter shipping_address : Stripe::CustomTextParamAfterSubmit? = nil



    @[JSON::Field(key: "submit", type: Stripe::CustomTextParamAfterSubmit?, default: nil, required: false, nullable: false, emit_null: false)]
    getter submit : Stripe::CustomTextParamAfterSubmit? = nil



    @[JSON::Field(key: "terms_of_service_acceptance", type: Stripe::CustomTextParamAfterSubmit?, default: nil, required: false, nullable: false, emit_null: false)]
    getter terms_of_service_acceptance : Stripe::CustomTextParamAfterSubmit? = nil
    ...
    def initialize(
      *,
      ...
      @shipping_address : Stripe::CustomTextParamAfterSubmit? = nil,
      @submit : Stripe::CustomTextParamAfterSubmit? = nil,
      @terms_of_service_acceptance : Stripe::CustomTextParamAfterSubmit? = nil
    )
    end
    ...
    def shipping_address=(new_value : Stripe::CustomTextParamAfterSubmit?)
    ...
    def submit=(new_value : Stripe::CustomTextParamAfterSubmit?)
    ...
    def terms_of_service_acceptance=(new_value : Stripe::CustomTextParamAfterSubmit?)
