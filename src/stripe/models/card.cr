...
module Stripe
  ...
  class Card
    ...
    def_equals_and_hash(@brand, @exp_month, @exp_year, @funding, @id, @last4, @object, @account, @account_present, @address_city, @address_city_present, @address_country, @address_country_present, @address_line1, @address_line1_present, @address_line1_check, @address_line1_check_present, @address_line2, @address_line2_present, @address_state, @address_state_present, @address_zip, @address_zip_present, @address_zip_check, @address_zip_check_present, @allow_redisplay, @allow_redisplay_present, @available_payout_methods, @available_payout_methods_present, @country, @country_present, @currency, @currency_present, @customer, @customer_present, @cvc_check, @cvc_check_present, @default_for_currency, @default_for_currency_present, @dynamic_last4, @dynamic_last4_present, @fingerprint, @fingerprint_present, @iin, @metadata, @metadata_present, @name, @name_present, @networks, @regulated_status, @regulated_status_present, @status, @status_present, @tokenization_method, @tokenization_method_present)
  end
end
