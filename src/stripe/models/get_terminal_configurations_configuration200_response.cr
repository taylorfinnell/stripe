...
module Stripe
  class GetTerminalConfigurationsConfiguration200Response
    ...
    property wifi : Stripe::TerminalConfigurationConfigurationResourceWifiConfig? = nil
    ...
    def_equals_and_hash(@deleted, @id, @object, @livemode, @bbpos_wisepos_e, @is_account_default, @is_account_default_present, @name, @name_present, @offline, @reboot_window, @stripe_s700, @tipping, @verifone_p400, @wifi)
  end
end
