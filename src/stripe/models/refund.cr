...
module Stripe
  ...
  class Refund
    ...
    getter pending_reason : String? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_pending_reason = @pending_reason).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_PENDING_REASON) unless OpenApi::EnumValidator.valid?(_pending_reason, VALID_VALUES_FOR_PENDING_REASON)
      end
    ...
    def valid? : Bool
      ...
      unless (_pending_reason = @pending_reason).nil?
        return false unless OpenApi::EnumValidator.valid?(_pending_reason, VALID_VALUES_FOR_PENDING_REASON)
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] pending_reason Object to be assigned
    def pending_reason=(new_value : String?)

      unless new_value.nil?
        OpenApi::EnumValidator.validate("pending_reason", new_value, VALID_VALUES_FOR_PENDING_REASON)
      end

      @pending_reason = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
