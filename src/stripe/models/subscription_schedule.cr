...
module Stripe
  ...
  class SubscriptionSchedule
    ...
    @[JSON::Field(key: "completed_at", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: completed_at.nil? && !completed_at_present?)]
    getter completed_at : Int32? = nil

    @[JSON::Field(ignore: true)]
    property? completed_at_present : Bool = false


    @[JSON::Field(key: "current_phase", type: Stripe::SubscriptionScheduleCurrentPhase?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: current_phase.nil? && !current_phase_present?)]
    ...
    @[JSON::Field(key: "released_at", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: released_at.nil? && !released_at_present?)]
    getter released_at : Int32? = nil
    ...
    def completed_at=(new_value : Int32?)
    ...
    def released_at=(new_value : Int32?)
    ...
    def_equals_and_hash(@billing_mode, @created, @customer, @default_settings, @end_behavior, @id, @livemode, @object, @phases, @status, @application, @application_present, @canceled_at, @canceled_at_present, @completed_at, @completed_at_present, @current_phase, @current_phase_present, @metadata, @metadata_present, @released_at, @released_at_present, @released_subscription, @released_subscription_present, @subscription, @subscription_present, @test_clock, @test_clock_present)
  end
end
