...
module Stripe
  ...
  class GelatoIdNumberReport
    ...
    @[JSON::Field(key: "error", type: Stripe::GelatoIdNumberReportError?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: error.nil? && !error_present?)]
