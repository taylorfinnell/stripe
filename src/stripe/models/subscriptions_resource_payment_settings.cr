...
module Stripe
  ...
  class SubscriptionsResourcePaymentSettings
    ...
    @[JSON::Field(key: "payment_method_options", type: Stripe::SubscriptionsResourcePaymentMethodOptions?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: payment_method_options.nil? && !payment_method_options_present?)]
    ...
    ERROR_MESSAGE_FOR_PAYMENT_METHOD_TYPES = "invalid value for \"payment_method_types\", must be one of [ach_credit_transfer, ach_debit, acss_debit, affirm, amazon_pay, au_becs_debit, bacs_debit, bancontact, boleto, card, cashapp, crypto, customer_balance, eps, fpx, giropay, grabpay, ideal, jp_credit_transfer, kakao_pay, klarna, konbini, kr_card, link, multibanco, naver_pay, nz_bank_account, p24, payco, paynow, paypal, promptpay, revolut_pay, sepa_credit_transfer, sepa_debit, sofort, swish, us_bank_account, wechat_pay]."
    VALID_VALUES_FOR_PAYMENT_METHOD_TYPES = String.static_array("ach_credit_transfer", "ach_debit", "acss_debit", "affirm", "amazon_pay", "au_becs_debit", "bacs_debit", "bancontact", "boleto", "card", "cashapp", "crypto", "customer_balance", "eps", "fpx", "giropay", "grabpay", "ideal", "jp_credit_transfer", "kakao_pay", "klarna", "konbini", "kr_card", "link", "multibanco", "naver_pay", "nz_bank_account", "p24", "payco", "paynow", "paypal", "promptpay", "revolut_pay", "sepa_credit_transfer", "sepa_debit", "sofort", "swish", "us_bank_account", "wechat_pay")
