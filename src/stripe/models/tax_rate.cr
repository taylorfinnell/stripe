...
module Stripe
  ...
  class TaxRate
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_inclusive = @inclusive).nil?
      end
      ...
      unless (_effective_percentage = @effective_percentage).nil?
      end
