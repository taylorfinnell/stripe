...
module Stripe
  ...
  class PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceEnterpriseFeaturesOvercaptureOvercapture
    ...
    @[JSON::Field(key: "maximum_amount_capturable", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter maximum_amount_capturable : Int32? = nil
    ...
    def initialize(
      *,
      # Required properties
      @maximum_amount_capturable : Int32? = nil, 
      @status : String? = nil
    )
    end
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_maximum_amount_capturable = @maximum_amount_capturable).nil?
      end
    ...
    def maximum_amount_capturable=(new_value : Int32?)
