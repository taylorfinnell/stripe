...
module Stripe
  ...
  class IssuingTransactionFlightData
    ...
    @[JSON::Field(key: "departure_at", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: departure_at.nil? && !departure_at_present?)]
    getter departure_at : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_departure_at = @departure_at).nil?
      end
      ...
      unless (_refundable = @refundable).nil?
      end
    ...
    def departure_at=(new_value : Int32?)
