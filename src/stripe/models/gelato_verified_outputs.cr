...
module Stripe
  ...
  class GelatoVerifiedOutputs
    ...
    def_equals_and_hash(@address, @address_present, @dob, @dob_present, @email, @email_present, @first_name, @first_name_present, @id_number, @id_number_present, @id_number_type, @id_number_type_present, @last_name, @last_name_present, @phone, @phone_present, @sex, @sex_present, @unparsed_place_of_birth, @unparsed_place_of_birth_present, @unparsed_sex, @unparsed_sex_present)
  end
end
