...
module Stripe
  ...
  class BillingMeter
    ...
    @[JSON::Field(key: "event_time_window", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: event_time_window.nil? && !event_time_window_present?)]
    ...
    property? event_time_window_present : Bool = false
    ...
    def_equals_and_hash(@created, @customer_mapping, @default_aggregation, @display_name, @event_name, @id, @livemode, @object, @status, @status_transitions, @updated, @value_settings, @event_time_window, @event_time_window_present)
  end
end
