...
module Stripe
  ...
  class IssuingTransactionBalanceTransaction
    ...
    property available_on : Int32? = nil
    ...
    property balance_type : String? = nil
    ...
    property source : Stripe::BalanceTransactionSource? = nil
