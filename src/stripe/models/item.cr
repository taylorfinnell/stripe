...
module Stripe
  ...
  class Item
    ...
    @[JSON::Field(key: "price", type: Stripe::Price?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: price.nil? && !price_present?)]
    ...
    def_equals_and_hash(@amount_discount, @amount_subtotal, @amount_tax, @amount_total, @currency, @id, @object, @description, @description_present, @discounts, @price, @price_present, @quantity, @quantity_present, @taxes)
  end
end
