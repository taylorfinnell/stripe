...
module Stripe
  class PaymentIntentPaymentMethodOptionsWechatPay
    ...
    def_equals_and_hash(@capture_method, @installments, @request_incremental_authorization_support, @require_cvc_recollection, @routing, @setup_future_usage, @verification_method, @app_id, @app_id_present, @client, @client_present)
  end
end
