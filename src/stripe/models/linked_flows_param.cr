...
module Stripe
  class LinkedFlowsParam
    ...
    ERROR_MESSAGE_FOR_SOURCE_FLOW_TYPE = "invalid value for \"source_flow_type\", must be one of [credit_reversal, other, outbound_payment, outbound_transfer, payout]."
    VALID_VALUES_FOR_SOURCE_FLOW_TYPE = String.static_array("credit_reversal", "other", "outbound_payment", "outbound_transfer", "payout")
