...
module Stripe
  ...
  class PaymentMethodCardGeneratedCard
    ...
    @[JSON::Field(key: "payment_method_details", type: Stripe::CardGeneratedFromPaymentMethodDetails?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: payment_method_details.nil? && !payment_method_details_present?)]
