...
module Stripe
  ...
  class CustomerBalanceTransaction
    ...
    getter checkout_session : Stripe::CustomerBalanceTransactionCheckoutSession? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_checkout_session = @checkout_session).nil?
        invalid_properties.concat(_checkout_session.list_invalid_properties_for("checkout_session")) if _checkout_session.is_a?(OpenApi::Validatable)
      end
    ...
    def valid? : Bool
      ...
      unless (_checkout_session = @checkout_session).nil?
        return false if _checkout_session.is_a?(OpenApi::Validatable) && !_checkout_session.valid?
      end
    ...
    def checkout_session=(new_value : Stripe::CustomerBalanceTransactionCheckoutSession?)
