...
require "./connect_embedded_financial_account_transactions_features" 
...
module Stripe
  ...
  class ConnectEmbeddedFinancialAccountTransactionsConfigClaim
    ...
    @[JSON::Field(key: "features", type: Stripe::ConnectEmbeddedFinancialAccountTransactionsFeatures?, default: nil, required: true, nullable: false, emit_null: false)]
    getter features : Stripe::ConnectEmbeddedFinancialAccountTransactionsFeatures? = nil
    ...
    def initialize(
      *,
      # Required properties
      @enabled : Bool? = nil, 
      @features : Stripe::ConnectEmbeddedFinancialAccountTransactionsFeatures? = nil
    )
    end
    ...
    def features=(new_value : Stripe::ConnectEmbeddedFinancialAccountTransactionsFeatures?)
