...
module Stripe
  ...
  class SubscriptionScheduleAddInvoiceItemPrice
    ...
    @[JSON::Field(key: "transform_quantity", type: Stripe::TransformQuantity?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    property unit_amount : Int32? = nil
    ...
    def_equals_and_hash(@deleted, @id, @object, @active, @billing_scheme, @created, @currency, @livemode, @metadata, @product, @_type, @currency_options, @custom_unit_amount, @lookup_key, @lookup_key_present, @nickname, @nickname_present, @recurring, @tax_behavior, @tax_behavior_present, @tiers, @tiers_mode, @tiers_mode_present, @transform_quantity, @unit_amount, @unit_amount_present, @unit_amount_decimal, @unit_amount_decimal_present)
  end
end
