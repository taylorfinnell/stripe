...
require "./invoices_settings_specs_create" 
...
module Stripe
  class SettingsSpecs
    ...
    @[JSON::Field(key: "invoices", type: Stripe::InvoicesSettingsSpecsCreate?, default: nil, required: false, nullable: false, emit_null: false)]
    getter invoices : Stripe::InvoicesSettingsSpecsCreate? = nil
    ...
    def initialize(
      *,
      ...
      @invoices : Stripe::InvoicesSettingsSpecsCreate? = nil,
    ...
    def invoices=(new_value : Stripe::InvoicesSettingsSpecsCreate?)
