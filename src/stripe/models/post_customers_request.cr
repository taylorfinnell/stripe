...
require "./shared_tax_create_param" 
...
module Stripe
  class PostCustomersRequest
    ...
    @[JSON::Field(key: "tax", type: Stripe::SharedTaxCreateParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter tax : Stripe::SharedTaxCreateParam? = nil
    ...
    def tax=(new_value : Stripe::SharedTaxCreateParam?)
    ...
    def_equals_and_hash(@address, @balance, @cash_balance, @description, @email, @expand, @invoice_prefix, @invoice_settings, @metadata, @name, @next_invoice_sequence, @payment_method, @phone, @preferred_locales, @shipping, @source, @tax, @tax_exempt, @tax_id_data, @test_clock)
  end
end
