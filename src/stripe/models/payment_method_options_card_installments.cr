...
module Stripe
  ...
  class PaymentMethodOptionsCardInstallments
    ...
    @[JSON::Field(key: "plan", type: Stripe::PaymentMethodDetailsCardInstallmentsPlan?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: plan.nil? && !plan_present?)]
