...
module Stripe
  ...
  class AccountBacsDebitPaymentsSettings
    ...
    @[JSON::Field(key: "service_user_number", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: service_user_number.nil? && !service_user_number_present?)]
    getter service_user_number : String? = nil
    MAX_LENGTH_FOR_SERVICE_USER_NUMBER = 5000

    @[JSON::Field(ignore: true)]
    property? service_user_number_present : Bool = false
    ...
    def_equals_and_hash(@display_name, @display_name_present, @service_user_number, @service_user_number_present)
  end
end
