...
module Stripe
  ...
  class PortalFlowsFlowSubscriptionUpdateConfirm
    ...
    @[JSON::Field(key: "discounts", type: Array(Stripe::PortalFlowsSubscriptionUpdateConfirmDiscount)?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: discounts.nil? && !discounts_present?)]
    ...
    def_equals_and_hash(@items, @subscription, @discounts, @discounts_present)
  end
end
