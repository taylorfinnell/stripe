...
module Stripe
  ...
  class InvoicesResourceShippingCost
    ...
    @[JSON::Field(key: "shipping_rate", type: Stripe::InvoicesResourceShippingCostShippingRate?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: shipping_rate.nil? && !shipping_rate_present?)]
