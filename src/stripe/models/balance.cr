...
require "./balance_detail_ungated" 
...
module Stripe
  ...
  class Balance
    ...
    @[JSON::Field(key: "refund_and_dispute_prefunding", type: Stripe::BalanceDetailUngated?, default: nil, required: false, nullable: false, emit_null: false)]
    getter refund_and_dispute_prefunding : Stripe::BalanceDetailUngated? = nil
    ...
    def initialize(
      *,
      ...
      @refund_and_dispute_prefunding : Stripe::BalanceDetailUngated? = nil
    )
    end
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_refund_and_dispute_prefunding = @refund_and_dispute_prefunding).nil?
        invalid_properties.concat(_refund_and_dispute_prefunding.list_invalid_properties_for("refund_and_dispute_prefunding")) if _refund_and_dispute_prefunding.is_a?(OpenApi::Validatable)
      end
      invalid_properties
    end
    ...
    def valid? : Bool
      ...
      unless (_refund_and_dispute_prefunding = @refund_and_dispute_prefunding).nil?
        return false if _refund_and_dispute_prefunding.is_a?(OpenApi::Validatable) && !_refund_and_dispute_prefunding.valid?
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] refund_and_dispute_prefunding Object to be assigned
    def refund_and_dispute_prefunding=(new_value : Stripe::BalanceDetailUngated?)

      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end

      @refund_and_dispute_prefunding = new_value
    end
    ...
    def_equals_and_hash(@available, @livemode, @object, @pending, @connect_reserved, @instant_available, @issuing, @refund_and_dispute_prefunding)
  end
end
