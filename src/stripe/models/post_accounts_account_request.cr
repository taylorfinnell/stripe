...
require "./account_groups_specs" 
require "./business_profile_update_specs" 
require "./capabilities_param" 
require "./company_update_specs" 
require "./documents_specs" 
require "./individual_update_specs" 
...
module Stripe
  class PostAccountsAccountRequest
    ...
    @[JSON::Field(key: "business_profile", type: Stripe::BusinessProfileUpdateSpecs?, default: nil, required: false, nullable: false, emit_null: false)]
    getter business_profile : Stripe::BusinessProfileUpdateSpecs? = nil
    ...
    @[JSON::Field(key: "company", type: Stripe::CompanyUpdateSpecs?, default: nil, required: false, nullable: false, emit_null: false)]
    getter company : Stripe::CompanyUpdateSpecs? = nil
    ...
    @[JSON::Field(key: "groups", type: Stripe::AccountGroupsSpecs?, default: nil, required: false, nullable: false, emit_null: false)]
    getter groups : Stripe::AccountGroupsSpecs? = nil



    @[JSON::Field(key: "individual", type: Stripe::IndividualUpdateSpecs?, default: nil, required: false, nullable: false, emit_null: false)]
    getter individual : Stripe::IndividualUpdateSpecs? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_groups = @groups).nil?
        invalid_properties.concat(_groups.list_invalid_properties_for("groups")) if _groups.is_a?(OpenApi::Validatable)
      end
    ...
    def valid? : Bool
      ...
      unless (_groups = @groups).nil?
        return false if _groups.is_a?(OpenApi::Validatable) && !_groups.valid?
      end
    ...
    def business_profile=(new_value : Stripe::BusinessProfileUpdateSpecs?)
    ...
    def company=(new_value : Stripe::CompanyUpdateSpecs?)
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] groups Object to be assigned
    def groups=(new_value : Stripe::AccountGroupsSpecs?)
    ...
    def individual=(new_value : Stripe::IndividualUpdateSpecs?)
    ...
    def_equals_and_hash(@account_token, @business_profile, @business_type, @capabilities, @company, @default_currency, @documents, @email, @expand, @external_account, @groups, @individual, @metadata, @settings, @tos_acceptance)
  end
end
