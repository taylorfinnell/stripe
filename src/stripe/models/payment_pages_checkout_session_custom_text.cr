...
module Stripe
  ...
  class PaymentPagesCheckoutSessionCustomText
    ...
    @[JSON::Field(key: "after_submit", type: Stripe::PaymentPagesCheckoutSessionCustomTextPosition?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: after_submit.nil? && !after_submit_present?)]
    ...
    @[JSON::Field(key: "shipping_address", type: Stripe::PaymentPagesCheckoutSessionCustomTextPosition?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: shipping_address.nil? && !shipping_address_present?)]
    ...
    @[JSON::Field(key: "submit", type: Stripe::PaymentPagesCheckoutSessionCustomTextPosition?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: submit.nil? && !submit_present?)]
    ...
    @[JSON::Field(key: "terms_of_service_acceptance", type: Stripe::PaymentPagesCheckoutSessionCustomTextPosition?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: terms_of_service_acceptance.nil? && !terms_of_service_acceptance_present?)]
