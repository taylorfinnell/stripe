...
module Stripe
  ...
  class TerminalConfigurationConfigurationResourceCurrencySpecificConfig
    ...
    @[JSON::Field(key: "smart_tip_threshold", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter smart_tip_threshold : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_fixed_amounts = @fixed_amounts).nil?
      end
      unless (_percentages = @percentages).nil?
      end
      unless (_smart_tip_threshold = @smart_tip_threshold).nil?
      end
      invalid_properties
    end
    ...
    def smart_tip_threshold=(new_value : Int32?)
