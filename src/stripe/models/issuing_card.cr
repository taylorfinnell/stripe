...
module Stripe
  ...
  class IssuingCard
    ...
    @[JSON::Field(key: "personalization_design", type: Stripe::IssuingCardPersonalizationDesign?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: personalization_design.nil? && !personalization_design_present?)]
    getter personalization_design : Stripe::IssuingCardPersonalizationDesign? = nil

    @[JSON::Field(ignore: true)]
    property? personalization_design_present : Bool = false
    ...
    @[JSON::Field(key: "shipping", type: Stripe::IssuingCardShipping?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: shipping.nil? && !shipping_present?)]
    ...
    @[JSON::Field(key: "wallets", type: Stripe::IssuingCardWallets?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: wallets.nil? && !wallets_present?)]
