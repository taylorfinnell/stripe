...
module Stripe
  ...
  class PaymentIntentPaymentMethodOptionsCard
    ...
    @[JSON::Field(key: "installments", type: Stripe::PaymentMethodOptionsCardInstallments?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: installments.nil? && !installments_present?)]
    ...
    @[JSON::Field(key: "mandate_options", type: Stripe::PaymentMethodOptionsCardMandateOptions?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: mandate_options.nil? && !mandate_options_present?)]
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_require_cvc_recollection = @require_cvc_recollection).nil?
      end
