...
module Stripe
  class MerchandiseNotAsDescribed
    ...
    @[JSON::Field(key: "received_at", type: Stripe::CanceledCanceledAt?, default: nil, required: false, nullable: false, emit_null: false)]
    getter received_at : Stripe::CanceledCanceledAt? = nil
    ...
    @[JSON::Field(key: "returned_at", type: Stripe::CanceledCanceledAt?, default: nil, required: false, nullable: false, emit_null: false)]
    getter returned_at : Stripe::CanceledCanceledAt? = nil
    ...
    def initialize(
      *,
      ...
      @received_at : Stripe::CanceledCanceledAt? = nil,
      @return_description : String? = nil,
      @return_status : String? = nil,
      @returned_at : Stripe::CanceledCanceledAt? = nil
    )
    end
    ...
    def received_at=(new_value : Stripe::CanceledCanceledAt?)
    ...
    def returned_at=(new_value : Stripe::CanceledCanceledAt?)
