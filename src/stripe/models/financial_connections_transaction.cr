...
module Stripe
  ...
  class FinancialConnectionsTransaction
    ...
    @[JSON::Field(key: "transacted_at", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter transacted_at : Int32? = nil
    ...
    def transacted_at=(new_value : Int32?)
