...
module Stripe
  ...
  class MandatePaymentMethodDetails
    ...
    # 
    @[JSON::Field(key: "naver_pay", type: JSON::Any?, default: nil, required: false, nullable: false, emit_null: false)]
    getter naver_pay : JSON::Any? = nil
    ...
    def naver_pay=(new_value : JSON::Any?)
    ...
    def_equals_and_hash(@_type, @acss_debit, @amazon_pay, @au_becs_debit, @bacs_debit, @card, @cashapp, @kakao_pay, @klarna, @kr_card, @link, @naver_pay, @nz_bank_account, @paypal, @revolut_pay, @sepa_debit, @us_bank_account)
  end
end
