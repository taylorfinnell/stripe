...
module Stripe
  class PostSubscriptionItemsItemRequest
    ...
    def_equals_and_hash(@billing_thresholds, @discounts, @expand, @metadata, @off_session, @payment_behavior, @price, @price_data, @proration_behavior, @proration_date, @quantity, @tax_rates)
  end
end
