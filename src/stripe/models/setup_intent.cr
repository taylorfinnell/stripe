...
module Stripe
  ...
  class SetupIntent
    ...
    @[JSON::Field(key: "automatic_payment_methods", type: Stripe::PaymentFlowsAutomaticPaymentMethodsSetupIntent?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: automatic_payment_methods.nil? && !automatic_payment_methods_present?)]
    ...
    @[JSON::Field(key: "last_setup_error", type: Stripe::ApiErrors?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: last_setup_error.nil? && !last_setup_error_present?)]
    ...
    @[JSON::Field(key: "next_action", type: Stripe::SetupIntentNextAction?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: next_action.nil? && !next_action_present?)]
    ...
    @[JSON::Field(key: "payment_method_options", type: Stripe::SetupIntentPaymentMethodOptions?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: payment_method_options.nil? && !payment_method_options_present?)]
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_attach_to_self = @attach_to_self).nil?
      end
