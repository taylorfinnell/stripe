...
module Stripe
  ...
  class SubscriptionsResourcePaymentMethodOptions
    ...
    @[JSON::Field(key: "acss_debit", type: Stripe::InvoicePaymentMethodOptionsAcssDebit?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: acss_debit.nil? && !acss_debit_present?)]
    ...
    @[JSON::Field(key: "bancontact", type: Stripe::InvoicePaymentMethodOptionsBancontact?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: bancontact.nil? && !bancontact_present?)]
    ...
    @[JSON::Field(key: "card", type: Stripe::SubscriptionPaymentMethodOptionsCard?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: card.nil? && !card_present?)]
    ...
    @[JSON::Field(key: "customer_balance", type: Stripe::InvoicePaymentMethodOptionsCustomerBalance?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: customer_balance.nil? && !customer_balance_present?)]
    ...
    @[JSON::Field(key: "us_bank_account", type: Stripe::InvoicePaymentMethodOptionsUsBankAccount?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: us_bank_account.nil? && !us_bank_account_present?)]
    ...
    def_equals_and_hash(@acss_debit, @acss_debit_present, @bancontact, @bancontact_present, @card, @card_present, @customer_balance, @customer_balance_present, @konbini, @sepa_debit, @us_bank_account, @us_bank_account_present)
  end
end
