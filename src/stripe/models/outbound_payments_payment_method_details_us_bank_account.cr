...
module Stripe
  ...
  class OutboundPaymentsPaymentMethodDetailsUsBankAccount
    ...
    def_equals_and_hash(@network, @account_holder_type, @account_holder_type_present, @account_type, @account_type_present, @bank_name, @bank_name_present, @fingerprint, @fingerprint_present, @last4, @last4_present, @mandate, @routing_number, @routing_number_present)
  end
end
