...
module Stripe
  class PostSubscriptionItemsRequest
    ...
    def_equals_and_hash(@subscription, @billing_thresholds, @discounts, @expand, @metadata, @payment_behavior, @price, @price_data, @proration_behavior, @proration_date, @quantity, @tax_rates)
  end
end
