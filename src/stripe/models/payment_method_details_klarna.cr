...
module Stripe
  ...
  class PaymentMethodDetailsKlarna
    ...
    @[JSON::Field(key: "payer_details", type: Stripe::KlarnaPayerDetails?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: payer_details.nil? && !payer_details_present?)]
    getter payer_details : Stripe::KlarnaPayerDetails? = nil

    @[JSON::Field(ignore: true)]
    property? payer_details_present : Bool = false
    ...
    def initialize(
      *,
      # Optional properties
      @payer_details : Stripe::KlarnaPayerDetails? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_payer_details = @payer_details).nil?
        invalid_properties.concat(_payer_details.list_invalid_properties_for("payer_details")) if _payer_details.is_a?(OpenApi::Validatable)
      end
    ...
    def valid? : Bool
      ...
      unless (_payer_details = @payer_details).nil?
        return false if _payer_details.is_a?(OpenApi::Validatable) && !_payer_details.valid?
      end
    ...
    # @param [Object] payer_details Object to be assigned
    def payer_details=(new_value : Stripe::KlarnaPayerDetails?)

      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end

      @payer_details = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    def_equals_and_hash(@payer_details, @payer_details_present, @payment_method_category, @payment_method_category_present, @preferred_locale, @preferred_locale_present)
  end
end
