...
module Stripe
  ...
  class TreasuryReceivedDebitsResourceReversalDetails
    ...
    @[JSON::Field(key: "deadline", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: deadline.nil? && !deadline_present?)]
    getter deadline : Int32? = nil
