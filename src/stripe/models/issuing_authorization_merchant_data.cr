...
module Stripe
  ...
  class IssuingAuthorizationMerchantData
    ...
    @[JSON::Field(key: "terminal_id", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: terminal_id.nil? && !terminal_id_present?)]
    getter terminal_id : String? = nil
    MAX_LENGTH_FOR_TERMINAL_ID = 5000

    @[JSON::Field(ignore: true)]
    property? terminal_id_present : Bool = false
    ...
    def_equals_and_hash(@category, @category_code, @network_id, @city, @city_present, @country, @country_present, @name, @name_present, @postal_code, @postal_code_present, @state, @state_present, @tax_id, @tax_id_present, @terminal_id, @terminal_id_present, @url, @url_present)
  end
end
