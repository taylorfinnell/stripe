...
module Stripe
  class SearchResult
    ...
    @[JSON::Field(key: "total_count", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter total_count : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_total_count = @total_count).nil?
      end
      invalid_properties
    end
    ...
    def total_count=(new_value : Int32?)
