...
module Stripe
  ...
  class TaxProductResourceLineItemTaxBreakdown
    ...
    @[JSON::Field(key: "tax_rate_details", type: Stripe::TaxProductResourceLineItemTaxRateDetails?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: tax_rate_details.nil? && !tax_rate_details_present?)]
    ...
    def_equals_and_hash(@amount, @jurisdiction, @sourcing, @taxability_reason, @taxable_amount, @tax_rate_details, @tax_rate_details_present)
  end
end
