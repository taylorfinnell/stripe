...
module Stripe
  ...
  class SubscriptionSchedulePhaseConfiguration
    ...
    @[JSON::Field(key: "end_date", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter end_date : Int32? = nil
    ...
    @[JSON::Field(key: "invoice_settings", type: Stripe::InvoiceSettingSubscriptionSchedulePhaseSetting?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: invoice_settings.nil? && !invoice_settings_present?)]
