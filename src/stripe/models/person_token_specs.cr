...
module Stripe
  class PersonTokenSpecs
    ...
    @[JSON::Field(key: "full_name_aliases", type: Stripe::AddInvoiceItemEntryTaxRates?, default: nil, required: false, nullable: false, emit_null: false)]
    getter full_name_aliases : Stripe::AddInvoiceItemEntryTaxRates? = nil
    ...
    @[JSON::Field(key: "us_cfpb_data", type: Stripe::UsCfpbDataSpecs?, default: nil, required: false, nullable: false, emit_null: false)]
    getter us_cfpb_data : Stripe::UsCfpbDataSpecs? = nil
    ...
    def initialize(
      *,
      ...
      @full_name_aliases : Stripe::AddInvoiceItemEntryTaxRates? = nil,
      @gender : String? = nil,
    ...
    def full_name_aliases=(new_value : Stripe::AddInvoiceItemEntryTaxRates?)
    ...
    def us_cfpb_data=(new_value : Stripe::UsCfpbDataSpecs?)
