...
require "./invoice_setting_checkout_rendering_options" 
...
module Stripe
  ...
  class PaymentPagesCheckoutSessionInvoiceSettings
    ...
    @[JSON::Field(key: "issuer", type: Stripe::ConnectAccountReference?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: issuer.nil? && !issuer_present?)]
    ...
    @[JSON::Field(key: "rendering_options", type: Stripe::InvoiceSettingCheckoutRenderingOptions?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: rendering_options.nil? && !rendering_options_present?)]
    getter rendering_options : Stripe::InvoiceSettingCheckoutRenderingOptions? = nil
    ...
    def initialize(
      *,
      ...
      @rendering_options : Stripe::InvoiceSettingCheckoutRenderingOptions? = nil
    )
    end
    ...
    def rendering_options=(new_value : Stripe::InvoiceSettingCheckoutRenderingOptions?)
    ...
    def_equals_and_hash(@account_tax_ids, @account_tax_ids_present, @custom_fields, @custom_fields_present, @description, @description_present, @footer, @footer_present, @issuer, @issuer_present, @metadata, @metadata_present, @rendering_options, @rendering_options_present)
  end
end
