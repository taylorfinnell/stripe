...
module Stripe
  class PostBillingPortalConfigurationsRequest
    ...
    @[JSON::Field(key: "business_profile", type: Stripe::BusinessProfileCreateParam?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def_equals_and_hash(@features, @business_profile, @default_return_url, @expand, @login_page, @metadata)
  end
end
