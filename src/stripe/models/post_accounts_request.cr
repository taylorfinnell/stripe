...
module Stripe
  class PostAccountsRequest
    ...
    def_equals_and_hash(@account_token, @bank_account, @business_profile, @business_type, @capabilities, @company, @controller, @country, @default_currency, @documents, @email, @expand, @external_account, @groups, @individual, @metadata, @settings, @tos_acceptance, @_type)
  end
end
