...
module Stripe
  ...
  class PaymentPagesCheckoutSessionCustomFieldsLabel
    ...
    @[JSON::Field(key: "custom", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: custom.nil? && !custom_present?)]
    getter custom : String? = nil
    MAX_LENGTH_FOR_CUSTOM = 5000

    @[JSON::Field(ignore: true)]
    property? custom_present : Bool = false
    ...
    def_equals_and_hash(@_type, @custom, @custom_present)
  end
end
