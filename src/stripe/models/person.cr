...
module Stripe
  ...
  class Person
    ...
    @[JSON::Field(key: "us_cfpb_data", type: Stripe::PersonUsCfpbData?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: us_cfpb_data.nil? && !us_cfpb_data_present?)]
    getter us_cfpb_data : Stripe::PersonUsCfpbData? = nil

    @[JSON::Field(ignore: true)]
    property? us_cfpb_data_present : Bool = false
    ...
    def initialize(
      *,
      ...
      @us_cfpb_data : Stripe::PersonUsCfpbData? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_id_number_provided = @id_number_provided).nil?
      end
      unless (_id_number_secondary_provided = @id_number_secondary_provided).nil?
      end
      ...
      unless (_ssn_last_4_provided = @ssn_last_4_provided).nil?
      end
      unless (_us_cfpb_data = @us_cfpb_data).nil?
        invalid_properties.concat(_us_cfpb_data.list_invalid_properties_for("us_cfpb_data")) if _us_cfpb_data.is_a?(OpenApi::Validatable)
      end
    ...
    def valid? : Bool
      ...
      unless (_us_cfpb_data = @us_cfpb_data).nil?
        return false if _us_cfpb_data.is_a?(OpenApi::Validatable) && !_us_cfpb_data.valid?
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] us_cfpb_data Object to be assigned
    def us_cfpb_data=(new_value : Stripe::PersonUsCfpbData?)

      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end

      @us_cfpb_data = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
