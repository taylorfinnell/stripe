...
module Stripe
  ...
  class PaymentLinksResourceShippingOption
    ...
    @[JSON::Field(key: "shipping_amount", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter shipping_amount : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_shipping_amount = @shipping_amount).nil?
      end
    ...
    def shipping_amount=(new_value : Int32?)
