...
module Stripe
  ...
  class PortalFlowsFlowSubscriptionCancel
    ...
    @[JSON::Field(key: "retention", type: Stripe::PortalFlowsRetention?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: retention.nil? && !retention_present?)]
    getter retention : Stripe::PortalFlowsRetention? = nil

    @[JSON::Field(ignore: true)]
    property? retention_present : Bool = false
    ...
    def_equals_and_hash(@subscription, @retention, @retention_present)
  end
end
