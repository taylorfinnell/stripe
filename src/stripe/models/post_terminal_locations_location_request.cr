...
module Stripe
  class PostTerminalLocationsLocationRequest
    ...
    ERROR_MESSAGE_FOR_DISPLAY_NAME = "invalid value for \"display_name\", must be one of []."
    VALID_VALUES_FOR_DISPLAY_NAME = String.static_array("")
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_display_name = @display_name).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_DISPLAY_NAME) unless OpenApi::EnumValidator.valid?(_display_name, VALID_VALUES_FOR_DISPLAY_NAME)
      end
    ...
    def valid? : Bool
      ...
      unless (_display_name = @display_name).nil?
        return false unless OpenApi::EnumValidator.valid?(_display_name, VALID_VALUES_FOR_DISPLAY_NAME)
      end
    ...
    def display_name=(new_value : String?)
      ...
      unless new_value.nil?
        OpenApi::EnumValidator.validate("display_name", new_value, VALID_VALUES_FOR_DISPLAY_NAME)
      end
