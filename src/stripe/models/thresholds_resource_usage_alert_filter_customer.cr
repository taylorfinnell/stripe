...
module Stripe
  ...
  class ThresholdsResourceUsageAlertFilterCustomer
    ...
    def_equals_and_hash(@created, @id, @livemode, @object, @address, @balance, @cash_balance, @currency, @currency_present, @default_source, @default_source_present, @delinquent, @delinquent_present, @description, @description_present, @discount, @email, @email_present, @invoice_credit_balance, @invoice_prefix, @invoice_prefix_present, @invoice_settings, @metadata, @name, @name_present, @next_invoice_sequence, @phone, @phone_present, @preferred_locales, @preferred_locales_present, @shipping, @sources, @subscriptions, @tax, @tax_exempt, @tax_exempt_present, @tax_ids, @test_clock, @test_clock_present)
  end
end
