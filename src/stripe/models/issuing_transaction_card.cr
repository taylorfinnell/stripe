...
module Stripe
  ...
  class IssuingTransactionCard
    ...
    @[JSON::Field(key: "shipping", type: Stripe::IssuingCardShipping?, default: nil, required: false, nullable: false, emit_null: false)]
    property shipping : Stripe::IssuingCardShipping? = nil



    @[JSON::Field(key: "wallets", type: Stripe::IssuingCardWallets?, default: nil, required: false, nullable: false, emit_null: false)]
