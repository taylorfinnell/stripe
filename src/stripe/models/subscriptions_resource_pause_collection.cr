...
module Stripe
  ...
  class SubscriptionsResourcePauseCollection
    ...
    @[JSON::Field(key: "resumes_at", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: resumes_at.nil? && !resumes_at_present?)]
    getter resumes_at : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_resumes_at = @resumes_at).nil?
      end
      invalid_properties
    end
    ...
    def resumes_at=(new_value : Int32?)
