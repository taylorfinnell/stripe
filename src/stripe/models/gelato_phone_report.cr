...
module Stripe
  ...
  class GelatoPhoneReport
    ...
    @[JSON::Field(key: "error", type: Stripe::GelatoPhoneReportError?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: error.nil? && !error_present?)]
    ...
    def_equals_and_hash(@status, @error, @error_present, @phone, @phone_present)
  end
end
