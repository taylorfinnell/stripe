...
module Stripe
  class ConnectJsAccountTokenCompanySpecs
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_ownership_declaration_shown_and_signed = @ownership_declaration_shown_and_signed).nil?
      end
    ...
    def_equals_and_hash(@address, @address_kana, @address_kanji, @directors_provided, @directorship_declaration, @executives_provided, @export_license_id, @export_purpose_code, @name, @name_kana, @name_kanji, @owners_provided, @ownership_declaration, @ownership_declaration_shown_and_signed, @ownership_exemption_reason, @phone, @registration_date, @registration_number, @structure, @tax_id, @tax_id_registrar, @vat_id, @verification)
  end
end
