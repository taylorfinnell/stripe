...
module Stripe
  ...
  class Invoice
    ...
    getter amount_remaining : Int32? = nil
    ...
    getter attempt_count : Int32? = nil
    ...
    getter post_payment_credit_notes_amount : Int32? = nil
    ...
    getter pre_payment_credit_notes_amount : Int32? = nil
    ...
    getter starting_balance : Int32? = nil
    ...
    getter automatically_finalizes_at : Int32? = nil
    ...
    @[JSON::Field(key: "confirmation_secret", type: Stripe::InvoicesResourceConfirmationSecret?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: confirmation_secret.nil? && !confirmation_secret_present?)]
    getter confirmation_secret : Stripe::InvoicesResourceConfirmationSecret? = nil

    @[JSON::Field(ignore: true)]
    property? confirmation_secret_present : Bool = false
    ...
    @[JSON::Field(key: "customer_address", type: Stripe::Address?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: customer_address.nil? && !customer_address_present?)]
    ...
    @[JSON::Field(key: "customer_shipping", type: Stripe::Shipping?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: customer_shipping.nil? && !customer_shipping_present?)]
    ...
    getter ending_balance : Int32? = nil
    ...
    @[JSON::Field(key: "from_invoice", type: Stripe::InvoicesResourceFromInvoice?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: from_invoice.nil? && !from_invoice_present?)]
    ...
    @[JSON::Field(key: "last_finalization_error", type: Stripe::ApiErrors?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: last_finalization_error.nil? && !last_finalization_error_present?)]
    ...
    getter next_payment_attempt : Int32? = nil
    ...
    @[JSON::Field(key: "parent", type: Stripe::BillingBillResourceInvoicingParentsInvoiceParent?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: parent.nil? && !parent_present?)]
    getter parent : Stripe::BillingBillResourceInvoicingParentsInvoiceParent? = nil
    ...
    getter payments : Stripe::InvoicesPaymentsListInvoicePayments? = nil
    ...
    @[JSON::Field(key: "rendering", type: Stripe::InvoicesResourceInvoiceRendering?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: rendering.nil? && !rendering_present?)]
    getter rendering : Stripe::InvoicesResourceInvoiceRendering? = nil

    @[JSON::Field(ignore: true)]
    property? rendering_present : Bool = false
    ...
    @[JSON::Field(key: "shipping_details", type: Stripe::Shipping?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: shipping_details.nil? && !shipping_details_present?)]
    ...
    getter total_pretax_credit_amounts : Array(Stripe::InvoicesResourcePretaxCreditAmount)? = nil
    ...
    getter webhooks_delivered_at : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_amount_due = @amount_due).nil?
      end
      invalid_properties.push("\"amount_overpaid\" is required and cannot be null") if @amount_overpaid.nil?

      unless (_amount_overpaid = @amount_overpaid).nil?
      end
      ...
      unless (_amount_remaining = @amount_remaining).nil?
      end
      ...
      unless (_attempt_count = @attempt_count).nil?
      end
      invalid_properties.push("\"attempted\" is required and cannot be null") if @attempted.nil?

      unless (_attempted = @attempted).nil?
      end
      invalid_properties.push("\"auto_advance\" is required and cannot be null") if @auto_advance.nil?

      unless (_auto_advance = @auto_advance).nil?
      end
      ...
      unless (_post_payment_credit_notes_amount = @post_payment_credit_notes_amount).nil?
      end
      ...
      unless (_pre_payment_credit_notes_amount = @pre_payment_credit_notes_amount).nil?
      end
      ...
      unless (_automatically_finalizes_at = @automatically_finalizes_at).nil?
      end
      ...
      unless (_confirmation_secret = @confirmation_secret).nil?
        invalid_properties.concat(_confirmation_secret.list_invalid_properties_for("confirmation_secret")) if _confirmation_secret.is_a?(OpenApi::Validatable)
      end
      ...
      unless (_next_payment_attempt = @next_payment_attempt).nil?
      end
      ...
      unless (_total_pretax_credit_amounts = @total_pretax_credit_amounts).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "total_pretax_credit_amounts", container: _total_pretax_credit_amounts)) if _total_pretax_credit_amounts.is_a?(Array)
      end
      ...
      unless (_webhooks_delivered_at = @webhooks_delivered_at).nil?
      end
      invalid_properties
    end
    ...
    def valid? : Bool
      ...
      return false if @amount_overpaid.nil?
      unless (_amount_overpaid = @amount_overpaid).nil?
      end
      ...
      return false if @auto_advance.nil?
      unless (_auto_advance = @auto_advance).nil?
      end
      ...
      unless (_confirmation_secret = @confirmation_secret).nil?
        return false if _confirmation_secret.is_a?(OpenApi::Validatable) && !_confirmation_secret.valid?
      end
      ...
      unless (_total_pretax_credit_amounts = @total_pretax_credit_amounts).nil?
        return false if _total_pretax_credit_amounts.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _total_pretax_credit_amounts)
      end
    ...
    def amount_due=(new_value : Int32?)
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] amount_overpaid Object to be assigned
    def amount_overpaid=(new_value : Int32?)

      raise ArgumentError.new("\"amount_overpaid\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end

      @amount_overpaid = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    def amount_remaining=(new_value : Int32?)
    ...
    def attempt_count=(new_value : Int32?)
    ...
    def auto_advance=(new_value : Bool?)
      ...
      raise ArgumentError.new("\"auto_advance\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end
    ...
    def period_end=(new_value : Int32?)
    ...
    def period_start=(new_value : Int32?)
    ...
    def post_payment_credit_notes_amount=(new_value : Int32?)
    ...
    def pre_payment_credit_notes_amount=(new_value : Int32?)
    ...
    def starting_balance=(new_value : Int32?)
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] automatically_finalizes_at Object to be assigned
    def automatically_finalizes_at=(new_value : Int32?)

      unless new_value.nil?
      end

      @automatically_finalizes_at = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] confirmation_secret Object to be assigned
    def confirmation_secret=(new_value : Stripe::InvoicesResourceConfirmationSecret?)

      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end

      @confirmation_secret = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    def ending_balance=(new_value : Int32?)
    ...
    def next_payment_attempt=(new_value : Int32?)
    ...
    def parent=(new_value : Stripe::BillingBillResourceInvoicingParentsInvoiceParent?)
    ...
    def payments=(new_value : Stripe::InvoicesPaymentsListInvoicePayments?)
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] total_pretax_credit_amounts Object to be assigned
    def total_pretax_credit_amounts=(new_value : Array(Stripe::InvoicesResourcePretaxCreditAmount)?)

      unless new_value.nil?
        OpenApi::ContainerValidator.validate(container: new_value) if new_value.is_a?(Array)
      end

      @total_pretax_credit_amounts = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    def webhooks_delivered_at=(new_value : Int32?)
