...
module Stripe
  ...
  class ChargeOutcome
    ...
    @[JSON::Field(key: "advice_code", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: advice_code.nil? && !advice_code_present?)]
    getter advice_code : String? = nil
    ERROR_MESSAGE_FOR_ADVICE_CODE = "invalid value for \"advice_code\", must be one of [confirm_card_data, do_not_try_again, try_again_later]."
    VALID_VALUES_FOR_ADVICE_CODE = String.static_array("confirm_card_data", "do_not_try_again", "try_again_later")

    @[JSON::Field(ignore: true)]
    property? advice_code_present : Bool = false


    # For charges declined by the network, a 2 digit code which indicates the advice returned by the network on how to proceed with an error.
    @[JSON::Field(key: "network_advice_code", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: network_advice_code.nil? && !network_advice_code_present?)]
    getter network_advice_code : String? = nil
    MAX_LENGTH_FOR_NETWORK_ADVICE_CODE = 5000

    @[JSON::Field(ignore: true)]
    property? network_advice_code_present : Bool = false
    ...
    @[JSON::Field(key: "risk_score", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter risk_score : Int32? = nil
    ...
    def initialize(
      *,
      ...
      @_type : String? = nil,
      # Optional properties
      @advice_code : String? = nil,
      @network_advice_code : String? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_advice_code = @advice_code).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_ADVICE_CODE) unless OpenApi::EnumValidator.valid?(_advice_code, VALID_VALUES_FOR_ADVICE_CODE)
      end
      unless (_network_advice_code = @network_advice_code).nil?
        if max_length_error = OpenApi::PrimitiveValidator.max_length_error("network_advice_code", _network_advice_code.to_s.size, MAX_LENGTH_FOR_NETWORK_ADVICE_CODE)
          invalid_properties.push(max_length_error)
        end
      end
    ...
    def valid? : Bool
      ...
      unless (_advice_code = @advice_code).nil?
        return false unless OpenApi::EnumValidator.valid?(_advice_code, VALID_VALUES_FOR_ADVICE_CODE)
      end

      unless (_network_advice_code = @network_advice_code).nil?
        return false if _network_advice_code.to_s.size > MAX_LENGTH_FOR_NETWORK_ADVICE_CODE
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] advice_code Object to be assigned
    def advice_code=(new_value : String?)

      unless new_value.nil?
        OpenApi::EnumValidator.validate("advice_code", new_value, VALID_VALUES_FOR_ADVICE_CODE)
      end

      @advice_code = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] network_advice_code Object to be assigned
    def network_advice_code=(new_value : String?)

      unless new_value.nil?
        OpenApi::PrimitiveValidator.validate_max_length("network_advice_code", new_value.to_s.size, MAX_LENGTH_FOR_NETWORK_ADVICE_CODE)
      end

      @network_advice_code = new_value
    end
    # Custom attribute writer method checking allowed values (enum).
    ...
    def risk_score=(new_value : Int32?)
    ...
    def_equals_and_hash(@_type, @advice_code, @advice_code_present, @network_advice_code, @network_advice_code_present, @network_decline_code, @network_decline_code_present, @network_status, @network_status_present, @reason, @reason_present, @risk_level, @risk_score, @rule, @seller_message, @seller_message_present)
  end
end
