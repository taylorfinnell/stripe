...
require "./payment_flows_private_payment_methods_kakao_pay_payment_method_options" 
...
module Stripe
  class PaymentIntentPaymentMethodOptionsKakaoPay
    ...
    def self.openapi_any_of
      [
      Stripe::PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions,
    ...
    def_equals_and_hash(@capture_method, @setup_future_usage, @installments, @request_incremental_authorization_support, @require_cvc_recollection, @routing, @verification_method)
  end
end
