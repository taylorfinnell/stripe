...
module Stripe
  ...
  class SetupIntentPaymentMethodOptionsCard
    ...
    @[JSON::Field(key: "mandate_options", type: Stripe::SetupIntentPaymentMethodOptionsCardMandateOptions?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: mandate_options.nil? && !mandate_options_present?)]
