...
require "./external_account_payout_bank_account" 
...
module Stripe
  ...
  class PostAccountsRequestBankAccount
    ...
    property documents : Stripe::ExternalAccountDocumentsParam? = nil
    ...
    def_equals_and_hash(@account_number, @country, @account_holder_name, @account_holder_type, @account_type, @currency, @documents, @object, @routing_number)
  end
end
