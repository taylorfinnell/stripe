...
require "./connect_embedded_disputes_list_features" 
...
module Stripe
  ...
  class ConnectEmbeddedDisputesListConfig
    ...
    @[JSON::Field(key: "features", type: Stripe::ConnectEmbeddedDisputesListFeatures?, default: nil, required: true, nullable: false, emit_null: false)]
    getter features : Stripe::ConnectEmbeddedDisputesListFeatures? = nil
    ...
    def initialize(
      *,
      # Required properties
      @enabled : Bool? = nil, 
      @features : Stripe::ConnectEmbeddedDisputesListFeatures? = nil
    )
    end
    ...
    def features=(new_value : Stripe::ConnectEmbeddedDisputesListFeatures?)
