...
module Stripe
  ...
  class PaymentMethodDetailsPaypal
    ...
    @[JSON::Field(key: "payer_name", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: payer_name.nil? && !payer_name_present?)]
    getter payer_name : String? = nil
    MAX_LENGTH_FOR_PAYER_NAME = 5000

    @[JSON::Field(ignore: true)]
    property? payer_name_present : Bool = false


    @[JSON::Field(key: "seller_protection", type: Stripe::PaypalSellerProtection?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: seller_protection.nil? && !seller_protection_present?)]
    getter seller_protection : Stripe::PaypalSellerProtection? = nil

    @[JSON::Field(ignore: true)]
    property? seller_protection_present : Bool = false
    ...
    def_equals_and_hash(@country, @country_present, @payer_email, @payer_email_present, @payer_id, @payer_id_present, @payer_name, @payer_name_present, @seller_protection, @seller_protection_present, @transaction_id, @transaction_id_present)
  end
end
