...
module Stripe
  ...
  class PaymentMethodCardWalletMasterpass
    ...
    @[JSON::Field(key: "billing_address", type: Stripe::Address?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: billing_address.nil? && !billing_address_present?)]
    ...
    @[JSON::Field(key: "shipping_address", type: Stripe::Address?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: shipping_address.nil? && !shipping_address_present?)]
