...
module Stripe
  ...
  class TreasuryOutboundTransfer
    ...
    @[JSON::Field(key: "returned_details", type: Stripe::TreasuryOutboundTransfersResourceReturnedDetails?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: returned_details.nil? && !returned_details_present?)]
    ...
    @[JSON::Field(key: "tracking_details", type: Stripe::TreasuryOutboundTransfersResourceOutboundTransferResourceTrackingDetails?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: tracking_details.nil? && !tracking_details_present?)]
    ...
    def_equals_and_hash(@amount, @cancelable, @created, @currency, @destination_payment_method_details, @expected_arrival_date, @financial_account, @id, @livemode, @metadata, @object, @statement_descriptor, @status, @status_transitions, @transaction, @description, @description_present, @destination_payment_method, @destination_payment_method_present, @hosted_regulatory_receipt_url, @hosted_regulatory_receipt_url_present, @returned_details, @returned_details_present, @tracking_details, @tracking_details_present)
  end
end
