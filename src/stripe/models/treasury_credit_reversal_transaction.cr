...
module Stripe
  ...
  class TreasuryCreditReversalTransaction
    ...
    def_equals_and_hash(@amount, @balance_impact, @created, @currency, @description, @financial_account, @flow_type, @id, @livemode, @object, @status, @status_transitions, @entries, @entries_present, @flow, @flow_present, @flow_details)
  end
end
