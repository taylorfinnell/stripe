...
module Stripe
  ...
  class ShippingRate
    ...
    @[JSON::Field(key: "delivery_estimate", type: Stripe::ShippingRateDeliveryEstimate?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: delivery_estimate.nil? && !delivery_estimate_present?)]
