...
module Stripe
  class PostIdentityVerificationSessionsRequest
    ...
    @[JSON::Field(key: "related_person", type: Stripe::RelatedPersonParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter related_person : Stripe::RelatedPersonParam? = nil
    ...
    def related_person=(new_value : Stripe::RelatedPersonParam?)
    ...
    def_equals_and_hash(@client_reference_id, @expand, @metadata, @options, @provided_details, @related_customer, @related_person, @return_url, @_type, @verification_flow)
  end
end
