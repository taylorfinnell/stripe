...
module Stripe
  ...
  class Plan
    ...
    @[JSON::Field(key: "transform_usage", type: Stripe::TransformUsage?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: transform_usage.nil? && !transform_usage_present?)]
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_amount_decimal = @amount_decimal).nil?
      end
    ...
    def_equals_and_hash(@active, @billing_scheme, @created, @currency, @id, @interval, @interval_count, @livemode, @object, @usage_type, @amount, @amount_present, @amount_decimal, @amount_decimal_present, @metadata, @metadata_present, @meter, @meter_present, @nickname, @nickname_present, @product, @product_present, @tiers, @tiers_mode, @tiers_mode_present, @transform_usage, @transform_usage_present, @trial_period_days, @trial_period_days_present)
  end
end
