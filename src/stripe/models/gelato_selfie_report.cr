...
module Stripe
  ...
  class GelatoSelfieReport
    ...
    @[JSON::Field(key: "error", type: Stripe::GelatoSelfieReportError?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: error.nil? && !error_present?)]
