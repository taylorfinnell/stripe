...
module Stripe
  ...
  class PromotionCodesResourceRestrictions
    ...
    @[JSON::Field(key: "minimum_amount", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: minimum_amount.nil? && !minimum_amount_present?)]
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_first_time_transaction = @first_time_transaction).nil?
      end
