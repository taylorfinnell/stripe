...
module Stripe
  ...
  class TransformUsage
    ...
    @[JSON::Field(key: "divide_by", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter divide_by : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_divide_by = @divide_by).nil?
      end
