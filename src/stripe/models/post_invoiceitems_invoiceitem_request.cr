...
module Stripe
  class PostInvoiceitemsInvoiceitemRequest
    ...
    def_equals_and_hash(@amount, @description, @discountable, @discounts, @expand, @metadata, @period, @price_data, @pricing, @quantity, @tax_behavior, @tax_code, @tax_rates, @unit_amount_decimal)
  end
end
