...
module Stripe
  ...
  class PaymentIntentReview
    ...
    ERROR_MESSAGE_FOR_CLOSED_REASON = "invalid value for \"closed_reason\", must be one of [approved, canceled, disputed, redacted, refunded, refunded_as_fraud]."
    VALID_VALUES_FOR_CLOSED_REASON = String.static_array("approved", "canceled", "disputed", "redacted", "refunded", "refunded_as_fraud")
    ...
    @[JSON::Field(key: "ip_address_location", type: Stripe::RadarReviewResourceLocation?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "session", type: Stripe::RadarReviewResourceSession?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def_equals_and_hash(@created, @id, @livemode, @object, @open, @opened_reason, @reason, @billing_zip, @billing_zip_present, @charge, @charge_present, @closed_reason, @closed_reason_present, @ip_address, @ip_address_present, @ip_address_location, @payment_intent, @session)
  end
end
