...
module Stripe
  class UpdateApiParam
    ...
    @[JSON::Field(key: "exp_month", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter exp_month : Int32? = nil



    @[JSON::Field(key: "exp_year", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
