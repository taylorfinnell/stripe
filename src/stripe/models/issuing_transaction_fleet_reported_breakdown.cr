...
module Stripe
  ...
  class IssuingTransactionFleetReportedBreakdown
    ...
    @[JSON::Field(key: "fuel", type: Stripe::IssuingTransactionFleetFuelPriceData?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: fuel.nil? && !fuel_present?)]
    ...
    @[JSON::Field(key: "non_fuel", type: Stripe::IssuingTransactionFleetNonFuelPriceData?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: non_fuel.nil? && !non_fuel_present?)]
    ...
    @[JSON::Field(key: "tax", type: Stripe::IssuingTransactionFleetTaxData?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: tax.nil? && !tax_present?)]
