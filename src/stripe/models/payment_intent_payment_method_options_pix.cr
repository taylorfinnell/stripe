...
module Stripe
  class PaymentIntentPaymentMethodOptionsPix
    ...
    @[JSON::Field(key: "expires_after_seconds", type: Int32?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: expires_after_seconds.nil? && !expires_after_seconds_present?)]
    property expires_after_seconds : Int32? = nil
    ...
    def self.openapi_any_of
      ...
      Stripe::PaymentMethodOptionsPix
      ]
    end
    ...
    def initialize(
      *,
      ...
      @expires_after_seconds : Int32? = nil,
    ...
    def_equals_and_hash(@capture_method, @installments, @request_incremental_authorization_support, @require_cvc_recollection, @routing, @setup_future_usage, @verification_method, @expires_after_seconds, @expires_after_seconds_present, @expires_at, @expires_at_present)
  end
end
