...
module Stripe
  ...
  class TreasuryFinancialAccount
    ...
    def_equals_and_hash(@balance, @country, @created, @financial_addresses, @id, @livemode, @object, @status, @status_details, @supported_currencies, @active_features, @features, @is_default, @metadata, @metadata_present, @nickname, @nickname_present, @pending_features, @platform_restrictions, @platform_restrictions_present, @restricted_features)
  end
end
