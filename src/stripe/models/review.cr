...
module Stripe
  ...
  class Review
    ...
    @[JSON::Field(key: "ip_address_location", type: Stripe::RadarReviewResourceLocation?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: ip_address_location.nil? && !ip_address_location_present?)]
    ...
    @[JSON::Field(key: "session", type: Stripe::RadarReviewResourceSession?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: session.nil? && !session_present?)]
