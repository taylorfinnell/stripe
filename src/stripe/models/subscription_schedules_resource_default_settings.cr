...
module Stripe
  ...
  class SubscriptionSchedulesResourceDefaultSettings
    ...
    def_equals_and_hash(@billing_cycle_anchor, @invoice_settings, @application_fee_percent, @application_fee_percent_present, @automatic_tax, @billing_thresholds, @billing_thresholds_present, @collection_method, @collection_method_present, @default_payment_method, @default_payment_method_present, @description, @description_present, @on_behalf_of, @on_behalf_of_present, @transfer_data, @transfer_data_present)
  end
end
