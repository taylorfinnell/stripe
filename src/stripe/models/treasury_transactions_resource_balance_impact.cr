...
module Stripe
  ...
  class TreasuryTransactionsResourceBalanceImpact
    ...
    @[JSON::Field(key: "cash", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter cash : Int32? = nil



    # The change made to funds that are not spendable yet, but will become available at a later time.
    @[JSON::Field(key: "inbound_pending", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter inbound_pending : Int32? = nil



    # The change made to funds in the account, but not spendable because they are being held for pending outbound flows.
    @[JSON::Field(key: "outbound_pending", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter outbound_pending : Int32? = nil
    ...
    def initialize(
      *,
      # Required properties
      @cash : Int32? = nil, 
      @inbound_pending : Int32? = nil, 
      @outbound_pending : Int32? = nil
    )
    end
    ...
    def inbound_pending=(new_value : Int32?)
    ...
    def outbound_pending=(new_value : Int32?)
