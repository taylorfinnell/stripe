...
module Stripe
  ...
  class BillingMeterEventSummary
    ...
    @[JSON::Field(key: "end_time", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter end_time : Int32? = nil
    ...
    @[JSON::Field(key: "start_time", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter start_time : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_aggregated_value = @aggregated_value).nil?
      end
    ...
    def start_time=(new_value : Int32?)
