...
module Stripe
  ...
  class DisputePaymentMethodDetailsCard
    ...
    ERROR_MESSAGE_FOR_CASE_TYPE = "invalid value for \"case_type\", must be one of [chargeback, compliance, inquiry]."
    VALID_VALUES_FOR_CASE_TYPE = String.static_array("chargeback", "compliance", "inquiry")
    ...
    def_equals_and_hash(@brand, @case_type, @network_reason_code, @network_reason_code_present)
  end
end
