...
module Stripe
  class PaymentIntentPaymentMethodOptionsBancontact
    ...
    def_equals_and_hash(@preferred_language, @capture_method, @installments, @request_incremental_authorization_support, @require_cvc_recollection, @routing, @setup_future_usage, @verification_method)
  end
end
