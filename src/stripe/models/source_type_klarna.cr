...
module Stripe
  class SourceTypeKlarna
    ...
    @[JSON::Field(key: "shipping_delay", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    getter shipping_delay : Int32? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_background_image_url = @background_image_url).nil?
      end
      unless (_client_token = @client_token).nil?
      end
      ...
      unless (_page_title = @page_title).nil?
      end
      unless (_pay_later_asset_urls_descriptive = @pay_later_asset_urls_descriptive).nil?
      end
      unless (_pay_later_asset_urls_standard = @pay_later_asset_urls_standard).nil?
      end
      unless (_pay_later_name = @pay_later_name).nil?
      end
      unless (_pay_later_redirect_url = @pay_later_redirect_url).nil?
      end
      unless (_pay_now_asset_urls_descriptive = @pay_now_asset_urls_descriptive).nil?
      end
      unless (_pay_now_asset_urls_standard = @pay_now_asset_urls_standard).nil?
      end
      unless (_pay_now_name = @pay_now_name).nil?
      end
      unless (_pay_now_redirect_url = @pay_now_redirect_url).nil?
      end
      unless (_pay_over_time_asset_urls_descriptive = @pay_over_time_asset_urls_descriptive).nil?
      end
      unless (_pay_over_time_asset_urls_standard = @pay_over_time_asset_urls_standard).nil?
      end
      unless (_pay_over_time_name = @pay_over_time_name).nil?
      end
      unless (_pay_over_time_redirect_url = @pay_over_time_redirect_url).nil?
      end
      unless (_payment_method_categories = @payment_method_categories).nil?
      end
      unless (_purchase_country = @purchase_country).nil?
      end
      unless (_purchase_type = @purchase_type).nil?
      end
      unless (_redirect_url = @redirect_url).nil?
      end
      unless (_shipping_delay = @shipping_delay).nil?
      end
      unless (_shipping_first_name = @shipping_first_name).nil?
      end
      unless (_shipping_last_name = @shipping_last_name).nil?
      end
      invalid_properties
    end
    ...
    def shipping_delay=(new_value : Int32?)
