...
module Stripe
  ...
  class PaymentPagesCheckoutSessionSavedPaymentMethodOptions
    ...
    @[JSON::Field(key: "allow_redisplay_filters", type: Array(String)?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: allow_redisplay_filters.nil? && !allow_redisplay_filters_present?)]
    ...
    property? allow_redisplay_filters_present : Bool = false


    # Enable customers to choose if they wish to remove their saved payment methods. Disabled by default.
    @[JSON::Field(key: "payment_method_remove", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: payment_method_remove.nil? && !payment_method_remove_present?)]
    ...
    @[JSON::Field(ignore: true)]
    property? payment_method_remove_present : Bool = false


    # Enable customers to choose if they wish to save their payment method for future use. Disabled by default.
    @[JSON::Field(key: "payment_method_save", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: payment_method_save.nil? && !payment_method_save_present?)]
    ...
    @[JSON::Field(ignore: true)]
    property? payment_method_save_present : Bool = false
    ...
    def_equals_and_hash(@allow_redisplay_filters, @allow_redisplay_filters_present, @payment_method_remove, @payment_method_remove_present, @payment_method_save, @payment_method_save_present)
  end
end
