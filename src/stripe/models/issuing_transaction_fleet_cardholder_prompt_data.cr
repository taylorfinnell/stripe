...
module Stripe
  ...
  class IssuingTransactionFleetCardholderPromptData
    ...
    def_equals_and_hash(@driver_id, @driver_id_present, @odometer, @odometer_present, @unspecified_id, @unspecified_id_present, @user_id, @user_id_present, @vehicle_number, @vehicle_number_present)
  end
end
