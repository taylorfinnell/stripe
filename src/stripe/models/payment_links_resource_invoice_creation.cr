...
module Stripe
  ...
  class PaymentLinksResourceInvoiceCreation
    ...
    @[JSON::Field(key: "invoice_data", type: Stripe::PaymentLinksResourceInvoiceSettings?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: invoice_data.nil? && !invoice_data_present?)]
    getter invoice_data : Stripe::PaymentLinksResourceInvoiceSettings? = nil

    @[JSON::Field(ignore: true)]
    property? invoice_data_present : Bool = false
    ...
    def_equals_and_hash(@enabled, @invoice_data, @invoice_data_present)
  end
end
