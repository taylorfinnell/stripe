...
module Stripe
  ...
  class PaymentLinksResourceConsentCollection
    ...
    @[JSON::Field(key: "payment_method_reuse_agreement", type: Stripe::PaymentLinksResourcePaymentMethodReuseAgreement?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: payment_method_reuse_agreement.nil? && !payment_method_reuse_agreement_present?)]
