...
module Stripe
  ...
  class SetupAttemptPaymentMethodDetailsCard
    ...
    @[JSON::Field(key: "checks", type: Stripe::SetupAttemptPaymentMethodDetailsCardChecks?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: checks.nil? && !checks_present?)]
    ...
    @[JSON::Field(key: "three_d_secure", type: Stripe::ThreeDSecureDetails?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: three_d_secure.nil? && !three_d_secure_present?)]
    ...
    @[JSON::Field(key: "wallet", type: Stripe::SetupAttemptPaymentMethodDetailsCardWallet?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: wallet.nil? && !wallet_present?)]
    ...
    def_equals_and_hash(@brand, @brand_present, @checks, @checks_present, @country, @country_present, @exp_month, @exp_month_present, @exp_year, @exp_year_present, @fingerprint, @fingerprint_present, @funding, @funding_present, @last4, @last4_present, @network, @network_present, @three_d_secure, @three_d_secure_present, @wallet, @wallet_present)
  end
end
