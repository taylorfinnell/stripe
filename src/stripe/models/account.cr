...
module Stripe
  ...
  class Account
    ...
    @[JSON::Field(key: "created", type: Int32?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "groups", type: Stripe::AccountGroupMembership?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: groups.nil? && !groups_present?)]
    getter groups : Stripe::AccountGroupMembership? = nil

    @[JSON::Field(ignore: true)]
    property? groups_present : Bool = false
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_charges_enabled = @charges_enabled).nil?
      end
      ...
      unless (_details_submitted = @details_submitted).nil?
      end
      ...
      unless (_payouts_enabled = @payouts_enabled).nil?
      end
    ...
    def groups=(new_value : Stripe::AccountGroupMembership?)
