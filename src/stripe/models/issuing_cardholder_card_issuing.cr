...
module Stripe
  ...
  class IssuingCardholderCardIssuing
    ...
    @[JSON::Field(key: "user_terms_acceptance", type: Stripe::IssuingCardholderUserTermsAcceptance?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: user_terms_acceptance.nil? && !user_terms_acceptance_present?)]
    getter user_terms_acceptance : Stripe::IssuingCardholderUserTermsAcceptance? = nil

    @[JSON::Field(ignore: true)]
    property? user_terms_acceptance_present : Bool = false
    ...
    def_equals_and_hash(@user_terms_acceptance, @user_terms_acceptance_present)
  end
end
