...
module Stripe
  ...
  class ApplicationFee
    ...
    @[JSON::Field(key: "fee_source", type: Stripe::PlatformEarningFeeSource?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: fee_source.nil? && !fee_source_present?)]
    getter fee_source : Stripe::PlatformEarningFeeSource? = nil

    @[JSON::Field(ignore: true)]
    property? fee_source_present : Bool = false
    ...
    def_equals_and_hash(@account, @amount, @amount_refunded, @application, @charge, @created, @currency, @id, @livemode, @object, @refunded, @refunds, @balance_transaction, @balance_transaction_present, @fee_source, @fee_source_present, @originating_transaction, @originating_transaction_present)
  end
end
