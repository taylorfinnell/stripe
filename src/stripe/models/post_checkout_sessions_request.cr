...
require "./adaptive_pricing_params" 
...
module Stripe
  class PostCheckoutSessionsRequest
    ...
    @[JSON::Field(key: "adaptive_pricing", type: Stripe::AdaptivePricingParams?, default: nil, required: false, nullable: false, emit_null: false)]
    getter adaptive_pricing : Stripe::AdaptivePricingParams? = nil
    ...
    @[JSON::Field(key: "optional_items", type: Array(Stripe::OptionalItemParams)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter optional_items : Array(Stripe::OptionalItemParams)? = nil
    ...
    @[JSON::Field(key: "permissions", type: Stripe::PermissionsParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter permissions : Stripe::PermissionsParam? = nil
    ...
    @[JSON::Field(key: "wallet_options", type: Stripe::WalletOptionsParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter wallet_options : Stripe::WalletOptionsParam? = nil
    ...
    def adaptive_pricing=(new_value : Stripe::AdaptivePricingParams?)
    ...
    def optional_items=(new_value : Array(Stripe::OptionalItemParams)?)
    ...
    def permissions=(new_value : Stripe::PermissionsParam?)
    ...
    def wallet_options=(new_value : Stripe::WalletOptionsParam?)
    ...
    def_equals_and_hash(@adaptive_pricing, @after_expiration, @allow_promotion_codes, @automatic_tax, @billing_address_collection, @cancel_url, @client_reference_id, @consent_collection, @currency, @custom_fields, @custom_text, @customer, @customer_creation, @customer_email, @customer_update, @discounts, @expand, @expires_at, @invoice_creation, @line_items, @locale, @metadata, @mode, @optional_items, @payment_intent_data, @payment_method_collection, @payment_method_configuration, @payment_method_data, @payment_method_options, @payment_method_types, @permissions, @phone_number_collection, @redirect_on_completion, @return_url, @saved_payment_method_options, @setup_intent_data, @shipping_address_collection, @shipping_options, @submit_type, @subscription_data, @success_url, @tax_id_collection, @ui_mode, @wallet_options)
  end
end
