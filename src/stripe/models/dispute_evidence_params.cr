...
require "./dispute_evidence_params_enhanced_evidence" 
...
module Stripe
  class DisputeEvidenceParams
    ...
    @[JSON::Field(key: "enhanced_evidence", type: Stripe::DisputeEvidenceParamsEnhancedEvidence?, default: nil, required: false, nullable: false, emit_null: false)]
    getter enhanced_evidence : Stripe::DisputeEvidenceParamsEnhancedEvidence? = nil
    ...
    def initialize(
      *,
      ...
      @enhanced_evidence : Stripe::DisputeEvidenceParamsEnhancedEvidence? = nil,
    ...
    def enhanced_evidence=(new_value : Stripe::DisputeEvidenceParamsEnhancedEvidence?)
