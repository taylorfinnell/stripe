...
module Stripe
  ...
  class PortalFlowsSubscriptionUpdateConfirmDiscount
    ...
    @[JSON::Field(key: "coupon", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: coupon.nil? && !coupon_present?)]
    ...
    @[JSON::Field(key: "promotion_code", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: promotion_code.nil? && !promotion_code_present?)]
