...
module Stripe
  ...
  class PaymentLink
    ...
    @[JSON::Field(key: "consent_collection", type: Stripe::PaymentLinksResourceConsentCollection?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: consent_collection.nil? && !consent_collection_present?)]
    ...
    @[JSON::Field(key: "invoice_creation", type: Stripe::PaymentLinksResourceInvoiceCreation?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: invoice_creation.nil? && !invoice_creation_present?)]
    ...
    getter optional_items : Array(Stripe::PaymentLinksResourceOptionalItem)? = nil

    @[JSON::Field(ignore: true)]
    property? optional_items_present : Bool = false


    @[JSON::Field(key: "payment_intent_data", type: Stripe::PaymentLinksResourcePaymentIntentData?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: payment_intent_data.nil? && !payment_intent_data_present?)]
    ...
    @[JSON::Field(key: "restrictions", type: Stripe::PaymentLinksResourceRestrictions?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: restrictions.nil? && !restrictions_present?)]
    ...
    @[JSON::Field(key: "shipping_address_collection", type: Stripe::PaymentLinksResourceShippingAddressCollection?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: shipping_address_collection.nil? && !shipping_address_collection_present?)]
    ...
    @[JSON::Field(key: "subscription_data", type: Stripe::PaymentLinksResourceSubscriptionData?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: subscription_data.nil? && !subscription_data_present?)]
    ...
    @[JSON::Field(key: "transfer_data", type: Stripe::PaymentLinksResourceTransferData?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: transfer_data.nil? && !transfer_data_present?)]
    ...
    def optional_items=(new_value : Array(Stripe::PaymentLinksResourceOptionalItem)?)
    ...
    def_equals_and_hash(@active, @after_completion, @allow_promotion_codes, @automatic_tax, @billing_address_collection, @currency, @custom_fields, @custom_text, @customer_creation, @id, @livemode, @metadata, @object, @payment_method_collection, @phone_number_collection, @shipping_options, @submit_type, @tax_id_collection, @url, @application, @application_present, @application_fee_amount, @application_fee_amount_present, @application_fee_percent, @application_fee_percent_present, @consent_collection, @consent_collection_present, @inactive_message, @inactive_message_present, @invoice_creation, @invoice_creation_present, @line_items, @on_behalf_of, @on_behalf_of_present, @optional_items, @optional_items_present, @payment_intent_data, @payment_intent_data_present, @payment_method_types, @payment_method_types_present, @restrictions, @restrictions_present, @shipping_address_collection, @shipping_address_collection_present, @subscription_data, @subscription_data_present, @transfer_data, @transfer_data_present)
  end
end
