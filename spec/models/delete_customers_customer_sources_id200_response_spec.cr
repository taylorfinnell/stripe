...
describe Stripe::DeleteCustomersCustomerSourcesId200Response do
  ...
  describe "test attribute 'allow_redisplay'" do
    it "should work" do
      # instance = Stripe::DeleteCustomersCustomerSourcesId200Response.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::DeleteCustomersCustomerSourcesId200Response::ENUM_VALIDATOR_FOR_ALLOW_REDISPLAY
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'regulated_status'" do
    it "should work" do
      # instance = Stripe::DeleteCustomersCustomerSourcesId200Response.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::DeleteCustomersCustomerSourcesId200Response::ENUM_VALIDATOR_FOR_REGULATED_STATUS
      # validator.allowable_values.each do |value|
