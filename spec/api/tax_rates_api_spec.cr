...
describe "TaxRatesApi" do
  ...
  # @option opts [String] :state [ISO 3166-2 subdivision code](https://en.wikipedia.org/wiki/ISO_3166-2), without country prefix. For example, \\\&quot;NY\\\&quot; for New York, United States.
