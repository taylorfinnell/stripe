...
describe "InvoiceitemsApi" do
  ...
  # @option opts [PricingParam] :pricing
  ...
  # @option opts [BigDecimal] :unit_amount_decimal The decimal unit amount in cents (or local equivalent) of the charge to be applied to the upcoming invoice. This &#x60;unit_amount_decimal&#x60; will be multiplied by the quantity to get the full amount. Passing in a negative &#x60;unit_amount_decimal&#x60; will reduce the &#x60;amount_due&#x60; on the invoice. Accepts at most 12 decimal places.
  # @return [Invoiceitem]
