...
describe "PaymentMethodsApi" do
  ...
  # @option opts [JSON::Any] :alma If this is a Alma PaymentMethod, this hash contains details about the Alma payment method.
  ...
  # @option opts [JSON::Any] :billie If this is a &#x60;billie&#x60; PaymentMethod, this hash contains details about the Billie payment method.
  ...
  # @option opts [JSON::Any] :crypto If this is a Crypto PaymentMethod, this hash contains details about the Crypto payment method.
  ...
  # @option opts [JSON::Any] :kakao_pay If this is a &#x60;kakao_pay&#x60; PaymentMethod, this hash contains details about the Kakao Pay payment method.
  ...
  # @option opts [JSON::Any] :kr_card If this is a &#x60;kr_card&#x60; PaymentMethod, this hash contains details about the Korean Card payment method.
  ...
  # @option opts [Param7] :naver_pay
  # @option opts [Param8] :nz_bank_account
  # @option opts [JSON::Any] :oxxo If this is an &#x60;oxxo&#x60; PaymentMethod, this hash contains details about the OXXO payment method.
  # @option opts [Param9] :p24
  # @option opts [JSON::Any] :pay_by_bank If this is a &#x60;pay_by_bank&#x60; PaymentMethod, this hash contains details about the PayByBank payment method.
  # @option opts [JSON::Any] :payco If this is a &#x60;payco&#x60; PaymentMethod, this hash contains details about the PAYCO payment method.
  ...
  # @option opts [JSON::Any] :revolut_pay If this is a &#x60;revolut_pay&#x60; PaymentMethod, this hash contains details about the Revolut Pay payment method.
  # @option opts [JSON::Any] :samsung_pay If this is a &#x60;samsung_pay&#x60; PaymentMethod, this hash contains details about the SamsungPay payment method.
  # @option opts [JSON::Any] :satispay If this is a &#x60;satispay&#x60; PaymentMethod, this hash contains details about the Satispay payment method.
  # @option opts [Param10] :sepa_debit
  # @option opts [Param11] :sofort
