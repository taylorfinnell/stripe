...
describe "CheckoutApi" do
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AdaptivePricingParams] :adaptive_pricing
  ...
  # @option opts [String] :cancel_url If set, Checkout displays a back button and customers will be directed to this URL if they decide to cancel payment and return to your website. This parameter is not allowed if ui_mode is &#x60;embedded&#x60; or &#x60;custom&#x60;.
  ...
  # @option opts [PermissionsParam] :permissions
  ...
  # @option opts [String] :return_url The URL to redirect your customer back to after they authenticate or cancel their payment on the payment method&#39;s app or site. This parameter is required if &#x60;ui_mode&#x60; is &#x60;embedded&#x60; or &#x60;custom&#x60; and redirect-based payment methods are enabled on the session.
  ...
  # @option opts [String] :submit_type Describes the type of transaction being performed by Checkout in order to customize relevant text on the page, such as the submit button.  &#x60;submit_type&#x60; can only be specified on Checkout Sessions in &#x60;payment&#x60; or &#x60;subscription&#x60; mode. If blank or &#x60;auto&#x60;, &#x60;pay&#x60; is used.
  # @option opts [SubscriptionDataParams] :subscription_data
  # @option opts [String] :success_url The URL to which Stripe should send customers when payment or setup is complete. This parameter is not allowed if ui_mode is &#x60;embedded&#x60; or &#x60;custom&#x60;. If you&#39;d like to use information from the successful Checkout Session on your page, read the guide on [customizing your success page](https://stripe.com/docs/payments/checkout/custom-success-page).
  ...
  # @option opts [WalletOptionsParam] :wallet_options
  # @return [CheckoutSession]
  ...
  # @param session
  # @param [Hash] opts the optional parameters
  # @option opts [CollectedInformationParams] :collected_information
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [PostAccountsRequestMetadata] :metadata
  # @option opts [PostCheckoutSessionsSessionRequestShippingOptions] :shipping_options
  # @return [CheckoutSession]
