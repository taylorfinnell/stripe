...
describe "TreasuryApi" do
  ...
  # @option opts [String] :status Only return FinancialAccounts that have the given status: &#x60;open&#x60; or &#x60;closed&#x60;
  ...
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [FeatureAccess] :features
  # @option opts [ForwardingSettings] :forwarding_settings
  # @option opts [Hash(String, String)] :metadata
  # @option opts [String] :nickname
  # @option opts [PlatformRestrictions] :platform_restrictions
  # @return [TreasuryFinancialAccount]
