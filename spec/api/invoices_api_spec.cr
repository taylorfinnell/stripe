...
describe "InvoicesApi" do
  ...
  # @option opts [Int32] :automatically_finalizes_at The time when this invoice should be scheduled to finalize. The invoice will be finalized at this time if it is still in draft state.
  ...
  # @option opts [AutomaticTaxParam] :automatic_tax
  # @option opts [Int32] :automatically_finalizes_at The time when this invoice should be scheduled to finalize. The invoice will be finalized at this time if it is still in draft state. To turn off automatic finalization, set &#x60;auto_advance&#x60; to false.
